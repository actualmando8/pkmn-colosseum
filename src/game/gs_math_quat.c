 ...
 *
 * XD source unit: game/pxdvs/GSAPI/GSmath/GSquat.cpp
 * Address range: 0x800E06B8 - 0x800E0790 (5 functions)
 *
 * 5 small fns (0x20-0x34) sandwiched exactly between GSmtx44.cpp and init.cpp - identical to XD's GSmath link order (mtx44 -> GSquat -> init). XD's GSquat.cpp shrank to just __sinit (0x20, methods inlined) but retains .ctors/.bss proving a real class TU; Colosseum kept the methods out-of-line. Zero anchors -> trivial pass.
 *
