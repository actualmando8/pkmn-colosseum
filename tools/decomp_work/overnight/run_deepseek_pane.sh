...
export WSLENV='MODELS:AGENT_NAME:TIER_FILTER:MAX_FN_ASM_LINES:REPAIR_ROUNDS:PLATEAU_BREAK_AFTER:FILE_FILTER'
echo "[deepseek] starting (model=$MODELS tiers=$TIER_FILTER cap=$MAX_FN_ASM_LINES) ..."
while true; do
