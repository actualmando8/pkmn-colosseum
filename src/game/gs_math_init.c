 ...
 *
 * XD source unit: game/pxdvs/GSAPI/GSmath/init.cpp
 * Address range: 0x800E0790 - 0x800E07E4 (1 functions)
 *
 * GSmathInit is the sole content of XD init.cpp; single anchor, position matches XD GSmath order.
 *
