...
L_8001CDC8:
    ...
    r3 = r25;
    if ((s32)tmp <= 0xfa) goto L_8001CE20;
    r4 = 0x11a;
    goto L_8001CE24;
L_8001CE20:
    r4 = 0x122;
L_8001CE24:
    ...
    r3 = r28;
    if ((s32)tmp <= 0xfa) goto L_8001CE70;
    r4 = 0x11a;
    goto L_8001CE74;
L_8001CE70:
    r4 = 0x122;
...
L_8001D144:
    ...
    r3 = r24;
    if ((s32)tmp <= 0xfa) goto L_8001D19C;
    r4 = 0x116;
    goto L_8001D1A0;
L_8001D19C:
    r4 = 0x11e;
L_8001D1A0:
    ...
    r3 = r24;
    if ((s32)tmp <= 0xfa) goto L_8001D1E8;
    r4 = 0x116;
    goto L_8001D1EC;
L_8001D1E8:
    r4 = 0x11e;
...
void fn_8001DACC(void) {
    ...
    fn_800F92D4();
    r30 = r3;
    if (r31 == 0) goto L_8001DF58;
    if (r30 == 0) goto L_8001DF58;
    r3 = r31;
    fn_800EF4FC();
    tmp = *(s16*)((u8*)r29 + 0x5C);
    r3 = r3 & 0xFFFF;
...
void fn_8001E3E0(void) {
    ...
    *(u32*)(sp + 0x8) = tmp;
    ...
    r3 = 0x2;
    fn_80104704();
    if (r3 == 0) goto L_8001E494;
    if (r30 == 0) goto L_8001E47C;
    tmp = *(u32*)((u8*)r3 + 0x80);
    *(u32*)((u8*)r30 + 0x0) = tmp;
L_8001E47C:
    tmp = *(u8*)((u8*)r3 + 0x99);
    if (tmp != 0) goto L_8001E48C;
    r31 = 0x1;
L_8001E48C:
    r3 = 0x2;
    fn_80102510();
...
L_8001ECF4:
    ...
    *(u16*)((u8*)r25 + 0x2) = tmp;
    r25 = r25 + 0x8;
    if ((s32)r21 < 0x20) goto L_8001ECF4;
    r3 = 0x1;
    fn_800D88DC();
    r3 = 0x6;
    fn_800D888C();
...
L_8001EE64:
    ...
    r21 = r21 + 0x8;
    r24 = r24 + 0x1;
    if ((s32)r24 < 0x20) goto L_8001EE64;
    r4 = r27 + 0x128;
    r3 = *(s16*)((u8*)r27 + 0x128);
    r4 = *(s16*)((u8*)r4 + 0x2);
    fn_800D61E4();
...
L_8001EF18:
    ...
    r22 = r22 + 0x8;
    r24 = r24 + 0x1;
    if ((s32)r24 < 0x20) goto L_8001EF18;
    r3 = *(s16*)((u8*)r27 + 0x28);
    r4 = *(s16*)((u8*)r21 + 0x2);
    fn_800D61E4();
    r4 = *(u32*)((u8*)r23 + 0x4);
...
L_8001EFF8:
    ...
    if ((s32)tmp < 0x1e) goto L_8001F1D0;
    if ((s32)tmp == 0xc8) goto L_8001F1D0;
    f0 = *(f32*)lbl_8047A334;
    r3 = 0x46a;
    f0 = f0 + f3;
    *(f32*)lbl_8047A334 = f0;
    fn_801666BC();
    if ((s32)r3 != 0) goto L_8001F044;
    tmp = *(u32*)lbl_8047A31C;
    f0 = *(f32*)lbl_8047B814;
    *(f32*)lbl_8047A334 = f0;
    if ((s32)tmp == 0x3e8) goto L_8001F044;
    tmp = 0x28;
...
void fn_8001F1E8(void) {
    ...
    r31 = r3;
    tmp = *(u32*)lbl_8047A31C;
    if ((s32)tmp >= 4) goto L_8001F2AC;
    r3 = 0x0;
    fn_801337A8();
    if (r31 == 0) goto L_8001F2F0;
    r3 = *(u32*)((u8*)r31 + 0x4);
...
L_8001F410:
    tmp = r3 & 0xFF;
    if (tmp == 0) goto L_8001FD34;
    tmp = *(u32*)lbl_8047A31C;
    f2 = *(f32*)lbl_8047B838;
    f1 = *(f32*)lbl_8047A338;
    if ((s32)tmp != 0x1f) goto L_8001F438;
    f0 = *(f32*)lbl_8047B81C;
    goto L_8001F43C;
L_8001F438:
    f0 = *(f32*)lbl_8047B83C;
