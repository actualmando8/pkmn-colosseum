...
extern void fn_8004DFCC(void);
extern void fn_800473E0(void);
extern u8 fn_8004BDEC(void);
extern u8 fn_8004BDFC(void);
extern void fn_800492CC(void);
...
extern void fn_80102428(u32 a, u32 b);
...
u32 fn_80039498(u32 a) {
    ...
    idx = fn_801026A4(0x24, (u32)fn_801046B8(), (u32)buf, 0, 1, 0, 0);
    fn_80102510(0x24);
    fn_80102428(0x24, 1);
...
#else
void fn_8003956C(u32 unused, u8* p) { /* TODO */ }
#endif
...
void fn_8003A520(void) {
    ...
    for (;;) {
        ...
        if (r == 0) {
            ...
            fn_80102428(0x1b, 1);
            fn_8017B3E4(0x66f);
            while (fn_8017B2CC(0x66f) == 1) { fn_800F0308(); }
            fn_80018F54(4, 0, 0);
            fn_8017B1CC(0x66f);
            fn_800F915C(0x66f);
            fn_8010264C(0x1a, 0);
...
void fn_8003C24C(u8* ctx, u8* p) {
    s16 field6 = *(s16*)(p + 6);
    if (field6 >= 0x2e2 && field6 < 0x2e5 && field6 != 0x2e3) {
        ctx[0x8b] = (u8)(s32)(lbl_8047BAC0 * *(f32*)(lbl_803A6748 + 0x44));
    } else {
        fn_8003C2B8();
    }
...
s32 fn_8004BE90(u16* a, u16* b) {
    ...
    result = fn_800F9EE4(r29, fn_800FA280(fn_801D1ACC(r30)));
    if (result != 0) {
        return result;
    }
    return (s32)(fn_801D1E50(r30) - fn_801D1E50(r31));
}
#endif
...
s32 fn_8004BF20(u16* a, u16* b) {
    ...
    result = fn_800F9EE4(r29, fn_800FA280(fn_801D1A88(r30)));
    if (result != 0) {
        return result;
    }
    return (s32)(fn_801D1E50(r30) - fn_801D1E50(r31));
...
u32 fn_8004DDC0(u8* ctx) {
    ...
    if (*(u16*)(r30 + 4) & 2) {
        ...
        cur = (s8)(ctx[0x95] + 1);
        ctx[0x95] = (u8)cur;
        if ((s8)cur >= (s8)(limit + 1 - 1)) {
            ctx[0x95] = (u8)(s8)(limit + 1 - 1 - 1);
        }
    }
    if (*(u16*)(r30 + 4) & 1) {
        s8 cur;
    ...
    if ((u8)ctx[0x95] != (u8)lbl_8047A524) {
        if (fn_801D1650((u32)(u8)lbl_8047A524) != 0) {
            fn_801669E4(fn_801D1650((u32)(u8)lbl_8047A524), 0, 0);
        }
        lbl_8047A520 = 1;
    }
    return 0;
...
extern void fn_801FB1C0(u32 a, u32 b, u32 c, u32 d);
extern u8 fn_8001E224(s32* out, u32 a, u32 b, u32 c, u32 d);
...
void fn_80053064(u32 a, u32 b, u32 c, s32 max, s32 min) {
    ...
    u8 result;
    fn_801FB1C0(0, a, b, c);
    result = (u8)fn_8001E224(&val, 0, 0x32, 0x32, 0);
    if ((result & 0xFF) == 1) {
        if (val > max) {
            val = max;
        }
...
#else
u32 fn_80054B1C(u32 a, u32 b) {
    s32 result;
    u32 buf[2];

    buf[0] = b;
    buf[1] = a;
    result = fn_801026A4(0x9c, (u32)fn_801046B8(), (u32)buf, 0, 1, 1);
    fn_80102510(0x9c);
    fn_80102428(0x9c, 1);
    switch (result) {
    case 0:
...
#else
#pragma optimization_level 4
void fn_800570D0(u8* a, u8* b) {
    u32 c;
    c = *(u32*)(lbl_803A9768 + 0x278) + 1;
    fn_80056C54(a, b, c & 1);
}
#endif
...
#else
void fn_80057830(s32 a, s32 b, s32 c) { /* TODO */ }
#endif
...
#else
void fn_80057A64(s32 a, s32 b) { /* TODO */ }
#endif
...
#else
#pragma optimization_level 4
void fn_80058754(u32 unused, u8* p) {
...
#if 0
asm void fn_80058804(u8* a, u8 b) {
#include "src/game/scene_init_fn_80058804.inc"
}
#else
#pragma optimization_level 4
void fn_80058804(u8* a, u8 b) {
    if (a == 0) {
        *(u16*)lbl_803A9A18 = 0;
    } else {
