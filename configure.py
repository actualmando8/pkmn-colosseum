    ...
    GameLib(
        ...
        [
            ...
            *[
            ...
            Object(
                CodeCandidate,
                "game/fight_encount_candidate_8020DF10.c",
                mw_version="GC/1.3",
                extra_cflags=["-O4,s", "-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            ...
            Object(
                CodeCandidate,
                "game/fight_encount_candidate_8020E020.c",
                mw_version="GC/1.3",
                extra_cflags=["-O4,s", "-use_lmw_stmw on", "-sdata 8", "-sdata2 8"],
                progress_category="game",
            ),
            ...
            *[
                ...
                for status, path in [
                    ...
                    (CodeCandidate, "game/gs_material_candidate_800DF21C.c"),
            ...
            *[
                ...
                for status, path in [
                    ...
                    (CodeCandidate, "game/camera_candidate_801766A8.c"),
                    (Matching, "game/camera_exact_801768F0.c"),
                    (CodeCandidate, "game/camera_candidate_80176948.c"),
