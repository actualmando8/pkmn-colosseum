...
L_800C1578:
    ...
    *(u32*)((u8*)r31 + 0x0) = r6;
    ...
    tmp = tmp | 0x400;
    *(u32*)((u8*)r3 + 0x1F8) = tmp;
    if ((s32)r4 == 0) goto L_800C15D4;
    if ((s32)r4 != 0x10) goto L_800C15E8;
L_800C15D4:
    r3 = (u32)&lbl_80313834;
    r4 = (u32)&lbl_80313834;
    r3 = *(u32*)((u8*)r4 + 0x8);
...
L_800C1630:
    ...
    *(u32*)((u8*)r31 + 0x0) = tmp;
    ...
    tmp = tmp | 0x400;
    *(u32*)((u8*)r3 + 0x1F8) = tmp;
    if ((s32)r4 == 0) goto L_800C1688;
    if ((s32)r4 != 0x10) goto L_800C1694;
L_800C1688:
    r3 = *(u32*)((u8*)r31 + 0x8);
    *(u32*)((u8*)r31 + 0x8) = tmp;
L_800C1694:
...
L_800C1DC8:
    ...
    *(u32*)((u8*)r25 + 0x0) = tmp;
L_800C1DDC:
    if (r27 > r23) goto L_800C1DEC;
    if ((s32)r3 == 0) goto L_800C1C70;
L_800C1DEC:
    tmp = *(u8*)((u8*)r31 + 0xD);
    if (tmp == 0) goto L_800C1E04;
    tmp = 0x0;
    r3 = 0x702;
    *(u32*)((u8*)r25 + 0x0) = tmp;
L_800C1E04:
...
L_800C1EE8:
    r3 = r7 + 0x1ec;
    if (r4 > r3) goto L_800C1F14;
    r3 = r7 + 0x1e8;
    r6 = r4 + r6;
    if (r6 < r3) goto L_800C1F14;
...
L_800C1F14:
    ...
    r3 = (u32)gTRKCPUState;
    r6 = r3 + 0x278;
    if (r4 > r6) goto L_800C1F4C;
    r3 = tmp << 2;
    r3 = r4 + r3;
    if (r3 < r6) goto L_800C1F4C;
    r3 = (u32)gTRKRestoreFlags;
    r6 = 0x1;
    r3 = (u32)gTRKRestoreFlags;
    *(u8*)((u8*)r3 + 0x1) = r6;
...
L_800C2048:
    ...
    tmp = *(u32*)((u8*)r12 + 0x24);
    *(u32*)(sp + 0xBC) = tmp;
    if (r21 >= 0x20) goto L_800C20F8;
    tmp = r26 | (0xc803 << 16);
    if ((s32)r31 == 0) goto L_800C20C0;
    tmp = r26 | (0xd803 << 16);
L_800C20C0:
    r3 = 0x4E800000;
    *(u32*)(sp + 0x98) = tmp;
    ...
    *(u32*)(sp + 0xBC) = tmp;
    ...
    goto L_800C2234;
L_800C20F8:
    if ((s32)r31 != 0) goto L_800C213C;
    if ((s32)r31 == 0) goto L_800C2110;
    r3 = r1 + 0x8;
    fn_800C11F4();
    goto L_800C2118;
L_800C2110:
...
L_800C2118:
    ...
    *(u32*)(sp + 0x8) = tmp;
    goto L_800C2234;
L_800C213C:
    if (r21 != 0x21) goto L_800C2234;
    if ((s32)r31 != 0) goto L_800C2154;
    *(u32*)(sp + 0x8) = tmp;
L_800C2154:
    r3 = (u32)lbl_8026FAF8;
...
L_800C2248:
    ...
    tmp = *(u32*)((u8*)r12 + 0x24);
    *(u32*)(sp + 0x94) = tmp;
    if (r21 >= 0x20) goto L_800C2304;
    tmp = r26 | (0xc803 << 16);
    if ((s32)r31 == 0) goto L_800C22C8;
    tmp = r26 | (0xd803 << 16);
L_800C22C8:
    r3 = 0x4E800000;
    *(u32*)(sp + 0x70) = tmp;
    ...
    *(u32*)(sp + 0x94) = tmp;
    ...
    goto L_800C2440;
L_800C2304:
    if ((s32)r31 != 0) goto L_800C2348;
    if ((s32)r31 == 0) goto L_800C231C;
    r3 = r1 + 0x8;
    fn_800C11F4();
    goto L_800C2324;
L_800C231C:
...
L_800C2324:
    ...
    *(u32*)(sp + 0x8) = tmp;
    goto L_800C2440;
L_800C2348:
    if (r21 != 0x21) goto L_800C2440;
    if ((s32)r31 != 0) goto L_800C2360;
    *(u32*)(sp + 0x8) = tmp;
L_800C2360:
    r3 = (u32)lbl_8026FAF8;
    r12 = (u32)lbl_8026FAF8;
...
L_800C2444:
    ...
    *(u32*)((u8*)r30 + 0x0) = tmp;
L_800C2458:
    if (r21 > r28) goto L_800C2468;
    if ((s32)r3 == 0) goto L_800C2048;
L_800C2468:
    tmp = *(u8*)((u8*)r27 + 0xD);
    if (tmp == 0) goto L_800C2480;
    tmp = 0x0;
    r3 = 0x702;
    *(u32*)((u8*)r30 + 0x0) = tmp;
L_800C2480:
...
L_800C26B8:
    ...
    r3 = r25;
    ((void(*)(void))fn_800C0D70)();
    if (r27 == r25) goto L_800C26F0;
    r4 = *(u32*)((u8*)r28 + 0x0);
    r3 = r27;
    ((void(*)(void))fn_800C0D70)();
L_800C26F0:
    tmp = *(u8*)((u8*)r31 + 0xD);
    if (tmp == 0) goto L_800C2708;
    tmp = 0x0;
    r30 = 0x702;
    *(u32*)((u8*)r28 + 0x0) = tmp;
L_800C2708:
...
L_800C2778:
    ...
    tmp = *(u32*)((u8*)r31 + 0x4);
    if (r3 > tmp) goto L_800C29D4;
    tmp = *(u32*)((u8*)r31 + 0x0);
    if (r27 < tmp) goto L_800C29D4;
    if ((s32)r26 != 0) goto L_800C27B8;
    tmp = r6 << 4;
    r4 = r31 + tmp;
    tmp = *(u32*)((u8*)r4 + 0x8);
    if ((s32)tmp == 0) goto L_800C27DC;
L_800C27B8:
    if ((s32)r26 != 1) goto L_800C27E4;
    r4 = (u32)lbl_8026FAE8;
    tmp = r6 << 4;
    r4 = (u32)lbl_8026FAE8;
    r4 = r4 + tmp;
    tmp = *(u32*)((u8*)r4 + 0xC);
    if ((s32)tmp != 0) goto L_800C27E4;
L_800C27DC:
    r5 = 0x700;
    goto L_800C29D4;
L_800C27E4:
    ...
    r5 = 0x0;
    tmp = *(u32*)(r4 + r29);
    if (r3 >= tmp) goto L_800C28E0;
    tmp = tmp - r3;
    r6 = 0x700;
    r30 = tmp + r3;
    if (r30 >= r3) goto L_800C281C;
    goto L_800C28DC;
L_800C281C:
    tmp = *(u32*)((u8*)r31 + 0x4);
    r5 = 0x0;
    if (r3 > tmp) goto L_800C28DC;
    tmp = *(u32*)((u8*)r31 + 0x0);
    if (r30 < tmp) goto L_800C28DC;
    if ((s32)r26 != 0) goto L_800C2854;
    tmp = r5 << 4;
    r4 = r4 + tmp;
    tmp = *(u32*)((u8*)r4 + 0x8);
    if ((s32)tmp == 0) goto L_800C2878;
L_800C2854:
    if ((s32)r26 != 1) goto L_800C2880;
    r4 = (u32)lbl_8026FAE8;
    tmp = r5 << 4;
    r4 = (u32)lbl_8026FAE8;
    r4 = r4 + tmp;
    tmp = *(u32*)((u8*)r4 + 0xC);
    if ((s32)tmp != 0) goto L_800C2880;
L_800C2878:
    r6 = 0x700;
    goto L_800C28DC;
L_800C2880:
    ...
    r6 = 0x0;
    tmp = *(u32*)(r4 + r28);
    if (r3 >= tmp) goto L_800C28AC;
    r5 = r26;
    r4 = tmp - r3;
    fn_800C2748();
    r6 = r3;
L_800C28AC:
    if ((s32)r6 != 0) goto L_800C28DC;
    r3 = (u32)lbl_8026FAE8;
    tmp = (u32)lbl_8026FAE8;
    r3 = tmp + r28;
    r3 = *(u32*)((u8*)r3 + 0x4);
    if (r30 <= r3) goto L_800C28DC;
    r5 = r26;
    r4 = r30 - r3;
    fn_800C2748();
    r6 = r3;
L_800C28DC:
    r5 = r6;
L_800C28E0:
    if ((s32)r5 != 0) goto L_800C29D4;
    r3 = (u32)lbl_8026FAE8;
    r4 = (u32)lbl_8026FAE8;
    r28 = r4 + 0x4;
    r3 = *(u32*)(r28 + r29);
    if (r27 <= r3) goto L_800C29D4;
    tmp = r27 - r3;
    r6 = 0x700;
    r30 = tmp + r3;
    if (r30 >= r3) goto L_800C291C;
    goto L_800C29D0;
L_800C291C:
    tmp = *(u32*)((u8*)r31 + 0x4);
    r5 = 0x0;
    if (r3 > tmp) goto L_800C29D0;
    tmp = *(u32*)((u8*)r31 + 0x0);
    if (r30 < tmp) goto L_800C29D0;
    if ((s32)r26 != 0) goto L_800C2954;
    tmp = r5 << 4;
    r4 = r4 + tmp;
    tmp = *(u32*)((u8*)r4 + 0x8);
    if ((s32)tmp == 0) goto L_800C2978;
L_800C2954:
    if ((s32)r26 != 1) goto L_800C2980;
    r4 = (u32)lbl_8026FAE8;
    tmp = r5 << 4;
    r4 = (u32)lbl_8026FAE8;
    r4 = r4 + tmp;
    tmp = *(u32*)((u8*)r4 + 0xC);
    if ((s32)tmp != 0) goto L_800C2980;
L_800C2978:
    r6 = 0x700;
    goto L_800C29D0;
L_800C2980:
    ...
    r6 = 0x0;
    tmp = *(u32*)(r4 + r27);
    if (r3 >= tmp) goto L_800C29AC;
    r5 = r26;
    r4 = tmp - r3;
    fn_800C2748();
    r6 = r3;
L_800C29AC:
    if ((s32)r6 != 0) goto L_800C29D0;
    r3 = *(u32*)(r28 + r27);
    if (r30 <= r3) goto L_800C29D0;
    r5 = r26;
    r4 = r30 - r3;
    fn_800C2748();
    r6 = r3;
