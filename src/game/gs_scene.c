...
L_80178CAC:
    tmp = *(u32*)((u8*)r4 + 0x4);
if ((u32)sceneObj != tmp) goto L_80178CC4;
    tmp = r5 * 0x28;
    sceneObj = r6 + tmp;
    goto L_80178CD4;
L_80178CC4:
...
L_80178DD4:
    tmp = *(u32*)((u8*)r4 + 0x4);
if ((u32)sceneObj != tmp) goto L_80178DEC;
    tmp = r5 * 0x28;
    sceneObj = r6 + tmp;
    goto L_80178DFC;
L_80178DEC:
...
L_80178E3C:
    tmp = *(u32*)((u8*)r4 + 0x4);
if ((u32)sceneObj != tmp) goto L_80178E54;
    tmp = r5 * 0x28;
    sceneObj = r6 + tmp;
    goto L_80178E64;
L_80178E54:
...
L_80178EF0:
    tmp = *(u32*)((u8*)r4 + 0x4);
if ((u32)sceneObj != tmp) goto L_80178F08;
    tmp = r5 * 0x28;
    sceneObj = r6 + tmp;
    goto L_80178F18;
L_80178F08:
...
L_801792F4:
    tmp = *(u32*)((u8*)r4 + 0x4);
if ((u32)camera != tmp) goto L_8017930C;
    tmp = r5 * 0x28;
    camera = r6 + tmp;
    goto L_8017931C;
L_8017930C:
