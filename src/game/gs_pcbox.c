...
extern u32 fn_8012AC08();
extern u32 fn_801F986C();
extern u32 fn_8012640C();
extern u32 fn_80123FBC();
...
s32 fn_80018594(u32 boxIndex, u32 speciesId, u32 slotIndex, u16* outSpecies) {
    ...
    *outSpecies = 0;
    if ((s32)lbl_8047A2E0 == 0 && (u16)speciesId == 0x21E) {
        ...
        *outSpecies = (u16)selectedSpecies;
        ...
        if (speciesCallback((u16)selectedSpecies, &callbackValue) == 2) {
            if (callbackValue > 0) {
                ((void (*)())fn_801299C8)(lbl_8047A2F8, selectedSpecies, (u16)callbackValue, -1);
            }
            return 4;
        }
        return 1;
    ...
    choice = fn_801026A4(0x5A, fn_801046B8(), 0, 0, 1, 1, &menuArg);
    fn_80102510(0x5A);
    ...
    case 0:
        if (callbackValue > 0) {
            ...
            if (*(s32*)(summaryEntry + 4) == -1) {
                ...
                ((void (*)())fn_801299C8)(lbl_8047A2F8, speciesId, (u16)callbackValue, (s16)slotIndex);
            }
        }
...
u16 fn_80018A68(void) {
    ...
    while (done == 0) {
        ...
        for (i = 0; i < 6; i++, summaryEntry += 0x4C) {
            encoded = (u16)(fn_80103E68((u16)*(u32*)(summaryEntry + 0x1C)) >> 16);
            ...
            fieldCount = 0;
            if (fieldId >= 0) {
                fieldData = ((u8* (*)())fn_80129BC8)((void*)lbl_8047A2F8, (u8)fieldId, &fieldCount, 0, 0, 0);
            } else {
                fieldData = ((u8* (*)())fn_801297D8)((void*)lbl_8047A2F8, &fieldCount, 0, 0, 0);
            }
            ...
            fn_80103EAC((u16)*(u32*)(summaryEntry + 0x1C), &adjusted);
        }

        lbl_8047A2D8 = -1;
        selection = fn_801026A4(0x59, fn_801046B8(), filterPtr, 0, 1, 0);
...
void fn_80019F6C(u8* ctx, u8* pane) {
    ...
    *(u32*)(pane + 0x64) = msg;
                ...
                case 1:
                    if ((u32)count < 6) {
                        ...
                        if (mon != NULL) {
                            ...
                            if (mon != NULL) {
                                mon = (u8*)fn_8012640C(mon, 0, 0xCC, 0);
                            }
                        }
                    }
                    break;
    ...
    case 0x3CB:
        if (*(u16*)(entry + 0x24) != 0) {
            fn_80104160(0, 0, *(s16*)(pane + 0x54), *(s16*)(pane + 0x56), *(u16*)(entry + 0x24), color, ctx, 0, 0);
        }
        break;
    case 0x3BB:
    case 0x3C9:
        fn_80109220(pane, *(u16*)(entry + 0x2A) != 0);
        break;
    case 0x3BF:
    ...
    case 0x12A2:
        ...
        if ((u16)grade != 0) {
            fn_80104160(0, 0, (s16)((x * *(s16*)(pane + 0x54) + y - 1) / y), *(s16*)(pane + 0x56), grade, color, ctx, 0, 0);
        }
        break;
    case 0x543:
    case 0x12A4:
        if ((s8)lbl_803A1D40[7] >= 0 && (s8)lbl_803A1D40[7] < 6) {
            ...
            fn_80109220(pane, *(s16*)base == *(s32*)(ctx + 4));
        } else {
            fn_80109220(pane, 0);
        }
        break;
    ...
    for (index = 0; index < 6; index++) {
        ...
        case 0:
            if ((u32)(u16)index < 6) {
                ...
                if (mon != NULL) {
                    mon = (u8*)fn_8012AC08(mon, (u16)index);
                }
            }
            break;
        case 1:
...
s32 fn_8001B1EC() {
    ...
    for (i = 0; (u32)(u16)i < 6; i++) {
        ...
        if (mon == NULL) {
            *(u16*)(entries + i * 0x30) = 0;
            ...
            fn_8011FDC8(mon, entries + i * 0x30);
            if ((u8)fn_8012640C(mon, 0, 0x7B, 0) == 1) {
    ...
    *(u16*)lbl_8047A30A = 0;
    ...
    while (1) {
        ...
        selection = (s8)fn_801026A4(0x63, 0, &menuArg, 0, 1, 1, entries);
        if (ctx[1] == 0) {
            selection = -2;
        }
        ctx[6] = selection;
        ...
        if (fn_801022B8(0x63) == 0x3B6 || (s8)selection == -1) {
            ctx[6] = (u8)-1;
            break;
        }
        ...
        case 2:
            ...
            while (1) {
                if (ctx[0x15] != 0) {
                    action = fn_8010264C(0x6D, 1);
                    fn_80102510(0x6D);
                } else {
                    action = fn_8010264C(0x108, 1);
                    fn_80102510(0x108);
                }
                ...
                if (action == 1) {
                    ...
                    case 0:
                        if ((u32)(u16)(s8)selection < 6) {
                            ...
                            if (mon != NULL) {
                                mon = (u8*)fn_8012AC08(mon, (s8)selection);
                            }
                        }
                        break;
                    case 1:
                    ...
                    fn_801C41C8(3, lbl_8047B7C0);
                    fn_801C40F0(1);
                    fn_80097E58(*(u32*)(ctx + 0xC), mon, entries + (s32)(s8)selection * 0x30, 0);
                    menuArg = (s32)(s8)ctx[6];
                    fn_801026A4(0x63, 0, &menuArg, 0, 0, 1, entries + (s32)(s8)selection * 0x30);
                    mon = (u8*)fn_80104704(0x63);
                    if (mon != NULL) {
                        mon[0x98] = 1;
                    }
                    fn_801C41C8(2, lbl_8047B7C0);
                    fn_801C40F0(1);
                    selection = (s8)ctx[6];
                    continue;
                }
        ...
        case 7:
            ...
            shadowGauge = fn_8011FC14(mon);
            if (*(f32*)&lbl_8047B7C4 != shadowGauge) {
                fn_80106D3C(2, 0x44DE, 1, 0);
                fn_801069FC(1);
                continue;
            }
            result = -1;
