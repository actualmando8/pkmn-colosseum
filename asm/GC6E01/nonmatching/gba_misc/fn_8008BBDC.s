...
lwz r5, 0x0(r31)
rlwinm r9, r0, 0, 16, 23
rlwinm r8, r4, 0, 16, 23
rlwinm r26, r25, 0, 8, 15
rlwinm r29, r0, 0, 8, 15
...
cmplwi r0, 0xf
bgt @8008BF14
lis r3, jumptable_802EEC30@ha
slwi r0, r0, 2
addi r3, r3, jumptable_802EEC30@l
lwzx r0, r3, r0
mtctr r0
bctr
li r25, 0x8
...
cmplwi r0, 0x7
bgt @8008BF84
lis r3, jumptable_802EEC10@ha
slwi r0, r0, 2
addi r3, r3, jumptable_802EEC10@l
lwzx r0, r3, r0
mtctr r0
bctr
li r26, 0x1
