...
void fn_80191688(void) {
    ...
    r31 = r4;
    /* mr. r30, r3 */;
    if ((s32)tmp == 0) goto L_8019176C;
    if (r31 != 0) goto L_801916B8;
    goto L_8019176C;
L_801916B8:
    tmp = *(u32*)((u8*)r30 + 0x8);
    tmp = tmp & 0x1;
    if (r31 == 0) goto L_80191754;
    tmp = *(u32*)((u8*)r30 + 0x18);
    ...
    r3 = *(u32*)((u8*)r30 + 0x18);
    r29 = *(u32*)((u8*)r3 + 0x18);
    if (r29 == 0) goto L_80191738;
    if (r29 != 0) goto L_80191708;
    r3 = (u32)lbl_8047D8D8;
    r4 = 0x25d;
    r5 = (u32)lbl_8047D8E0;
    fn_80196E10();
L_80191708:
    ...
    r3 = 0x0;
    tmp = tmp & 0x00800000;
    if (r29 != 0) goto L_80191728;
    tmp = *(u32*)((u8*)r29 + 0x14);
    tmp = tmp & 0x00000040;
    if (r29 == 0) goto L_80191728;
    r3 = 0x1;
L_80191728:
    if ((s32)r3 == 0) goto L_80191738;
    r3 = r29;
    fn_8019D9DC();
L_80191738:
    r3 = r29 + 0x44;
...
void fn_8019189C(void) {
    ...
    r31 = r4;
    /* mr. r30, r3 */;
    if ((s32)tmp == 0) goto L_80191934;
    if (r31 != 0) goto L_801918C8;
    goto L_80191934;
L_801918C8:
    if (r30 == 0) goto L_80191908;
    /* addic. tmp, r31, 0x4 */;
    if (r30 == 0) goto L_80191908;
    r3 = *(u32*)((u8*)r31 + 0x4);
    tmp = *(u32*)((u8*)r31 + 0x8);
...
L_80191B78:
    f31 = *(f32*)((u8*)r29 + 0x0);
    if (r31 == 0) goto L_80191DA8;
    tmp = *(u32*)((u8*)r31 + 0x8);
    tmp = tmp & 0x1;
    if (r31 == 0) goto L_80191C20;
    tmp = *(u32*)((u8*)r31 + 0x18);
    ...
    r3 = *(u32*)((u8*)r31 + 0x18);
    r30 = *(u32*)((u8*)r3 + 0x18);
    if (r30 == 0) goto L_80191C04;
    if (r30 != 0) goto L_80191BD4;
    r3 = (u32)lbl_8047D8D8;
    r4 = 0x25d;
    r5 = (u32)lbl_8047D8E0;
    fn_80196E10();
L_80191BD4:
    ...
    r3 = 0x0;
    tmp = tmp & 0x00800000;
    if (r30 != 0) goto L_80191BF4;
    tmp = *(u32*)((u8*)r30 + 0x14);
    tmp = tmp & 0x00000040;
    if (r30 == 0) goto L_80191BF4;
    r3 = 0x1;
L_80191BF4:
    if ((s32)r3 == 0) goto L_80191C04;
    r3 = r30;
    fn_8019D9DC();
L_80191C04:
    r3 = r30 + 0x44;
...
L_80191C34:
    ...
    r3 = *(u32*)((u8*)r31 + 0x18);
    r30 = *(u32*)((u8*)r3 + 0x18);
    if (r30 == 0) goto L_80191CC0;
    if (r30 != 0) goto L_80191C90;
    r3 = (u32)lbl_8047D8D8;
    r4 = 0x25d;
    r5 = (u32)lbl_8047D8E0;
    fn_80196E10();
L_80191C90:
    ...
    r3 = 0x0;
    tmp = tmp & 0x00800000;
    if (r30 != 0) goto L_80191CB0;
    tmp = *(u32*)((u8*)r30 + 0x14);
    tmp = tmp & 0x00000040;
    if (r30 == 0) goto L_80191CB0;
    r3 = 0x1;
L_80191CB0:
    if ((s32)r3 == 0) goto L_80191CC0;
    r3 = r30;
    fn_8019D9DC();
L_80191CC0:
    r3 = r30 + 0x44;
...
L_80191CF0:
    ...
    r3 = *(u32*)((u8*)r31 + 0x18);
    r30 = *(u32*)((u8*)r3 + 0x18);
    if (r30 == 0) goto L_80191D7C;
    if (r30 != 0) goto L_80191D4C;
    r3 = (u32)lbl_8047D8D8;
    r4 = 0x25d;
    r5 = (u32)lbl_8047D8E0;
    fn_80196E10();
L_80191D4C:
    ...
    r3 = 0x0;
    tmp = tmp & 0x00800000;
    if (r30 != 0) goto L_80191D6C;
    tmp = *(u32*)((u8*)r30 + 0x14);
    tmp = tmp & 0x00000040;
    if (r30 == 0) goto L_80191D6C;
    r3 = 0x1;
L_80191D6C:
    if ((s32)r3 == 0) goto L_80191D7C;
    r3 = r30;
    fn_8019D9DC();
L_80191D7C:
    r3 = r30 + 0x44;
...
L_801921EC:
    ...
    r22 = r22 + 0x1;
L_801921F4:
    if (r3 == 0) goto L_80192204;
    if (r22 < r29) goto L_801921EC;
L_80192204:
...
L_801934A0:
    ...
    tmp = 0x0;
    r23 = r3;
    if ((s32)r22 == 0) goto L_801934CC;
    if ((s32)r30 == 0) goto L_801934CC;
    tmp = 0x1;
L_801934CC:
    *(u32*)((u8*)r23 + 0x4) = tmp;
    goto L_8019211C;
L_801934D4:
    if (r23 != 0) goto L_801934EC;
    r3 = r31 + 0x0;
    r4 = 0x295;
    r5 = (u32)lbl_8047D910;
    fn_80196E10();
...
L_80193598:
    if ((s32)r22 == 0) goto L_801935AC;
    if ((s32)r30 != 0) goto L_801935AC;
L_801935A8:
    tmp = 0x1;
L_801935AC:
    *(u32*)((u8*)r23 + 0x4) = tmp;
