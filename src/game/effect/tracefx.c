...
void fn_80137114(void) {
    ...
    *(f64*)(sp + 0x40) = f30;
    ...
    r0 = *(u32*)((u8*)r28 + 0x4);
    if ((s32)r0 == (s32)0x2) goto L_801371FC;
    if ((s32)r0 >= (s32)0x2) goto L_8013716C;
    if ((s32)r0 >= (s32)0x1) goto L_80137284;
    goto L_80137334;
L_8013716C: ;
    if ((s32)r0 >= (s32)0x4) goto L_80137334;
    r0 = *(u32*)((u8*)r28 + 0x8);
    r30 = r28 + 0xc;
...
void fn_8013735C(void) {
    ...
    memset((void*)r3, (int)r4, (u32)r5);
    r0 = *(u32*)((u8*)r31 + 0x3C);
    if ((s32)r0 == (s32)0x2) goto L_801373B8;
    if ((s32)r0 >= (s32)0x2) goto L_801373B8;
    if ((s32)r0 >= (s32)0x1) goto L_801373A8;
    goto L_801373B8;
L_801373A8: ;
    r0 = 0x0;
    r30 = -0x4;
...
L_801373C0: ;
    ...
    *(u16*)((u8*)r28 + 0x72) = r0;
    ...
    r0 = r0 ^ r3;
    /* subf. r0, r3, r0 */;
    if ((s32)r0 != (s32)0x1) goto L_8013749C;
    r0 = r4 + 0x1;
    *(u16*)((u8*)r28 + 0x70) = r0;
L_8013749C: ;
    r4 = *(u16*)((u8*)r28 + 0x72);
    ...
    r0 = r0 ^ r3;
    /* subf. r0, r3, r0 */;
    if ((s32)r0 != (s32)0x1) goto L_801374BC;
    r0 = r4 + 0x1;
    *(u16*)((u8*)r28 + 0x72) = r0;
L_801374BC: ;
    f0 = *(f32*)((u8*)r31 + 0x24);
    ...
    *(u32*)((u8*)r28 + 0x78) = r3;
    ...
    r3 = 0x4e20;
    ((void(*)(void))fn_800F9318)();
    if ((u32)r3 == (u32)0x0) goto L_80137554;
    r4 = 0x0;
...
void fn_8013757C(void) {
    ...
    *(u16*)((u8*)r29 + 0xE) = r0;
    ...
    r0 = r3 & 0xFFFF;
    r28 = r3;
    if ((s32)r0 == (s32)0) goto L_80137720;
    fn_800E27B0();
    r5 = *(u32*)((u8*)r31 + 0x4C);
    r27 = r3;
    r4 = r30;
...
L_80137728: ;
    ...
    /* clrrwi r0, r0, 5 */;
    r30 = r30 + r0;
    if ((u32)r3 == (u32)0x0) goto L_80137750;
    r4 = 0x2;
    r5 = 0x2;
    fn_800EF590();
L_80137750: ;
...
void fn_80137780(void) {
    ...
    *(u8*)((u8*)r27 + 0x4C) = r0;
    r0 = *(u32*)((u8*)r30 + 0x8);
    if ((s32)r0 == (s32)0x3) goto L_801377DC;
    if ((s32)r0 >= (s32)0x3) goto L_801377DC;
    if ((s32)r0 >= (s32)0x1) goto L_801377D4;
    goto L_801377DC;
L_801377D4: ;
    r3 = -0x4;
    goto L_80137804;
L_801377DC: ;
    r3 = *(u32*)((u8*)r30 + 0xC);
    r0 = r3 & 0x00000004;
    if ((s32)r0 != (s32)0x4) goto L_801377F0;
    r28 = 0x0;
L_801377F0: ;
    r0 = r3 & 0x1;
    if ((s32)r0 != (s32)0x1) goto L_80137800;
    r26 = 0x1;
L_80137800: ;
    r3 = 0x0;
L_80137804: ;
    r0 = *(u32*)((u8*)r30 + 0x0);
    if ((s32)r0 != (s32)0x0) goto L_80137818;
    r28 = 0x1;
    r26 = 0x1;
L_80137818: ;
    r30 = r3 + r30;
    *(u8*)((u8*)r27 + 0x4E) = r26;
    ...
    goto L_8013794C;
L_80137838: ;
    if ((u32)r31 == (u32)0x0) goto L_80137874;
    r4 = *(u32*)((u8*)r28 + 0x0);
    /* extrwi r3, r4, 8, 8 */;
    /* extrwi r0, r4, 8, 16 */;
    *(u8*)(sp + 0xE) = r3;
...
L_80137874: ;
    ...
    *(u8*)(sp + 0x8) = r0;
L_80137890: ;
    if ((u32)r26 == (u32)0x0) goto L_801378B4;
    r0 = *(u32*)((u8*)r28 + 0x0);
    r0 = (u32)r0 >> 24;
    *(u8*)(sp + 0xF) = r0;
    r0 = *(u32*)((u8*)r28 + 0x4);
...
L_801378C0: ;
    r0 = *(u32*)((u8*)r28 + 0x8);
    if ((s32)r0 >= (s32)0x0) goto L_801378E4;
    r3 = r27;
    r4 = r1 + 0xc;
    r5 = r1 + 0x8;
    r6 = -0x1;
...
void fn_80137AA4(void) {
    ...
    /* stmw r27, 0x1c(r1) */;
    /* mr. r29, r3 */;
    if ((s32)r0 == (s32)0) goto L_80137CEC;
    r28 = *(u16*)((u8*)r29 + 0x20);
    r27 = *(u16*)((u8*)r29 + 0x22);
    r3 = *(u16*)((u8*)r29 + 0x24);
    r4 = *(u16*)((u8*)r29 + 0x26);
    ...
    r0 = *(u32*)((u8*)r29 + 0x14);
    r30 = r3;
    if ((u32)r0 != (u32)0x0) goto L_80137AE8;
    r3 = 0x0;
    goto L_80137D00;
L_80137AE8: ;
    if ((u32)r27 == (u32)0x0) goto L_80137AF8;
    if ((u32)r28 != (u32)0x0) goto L_80137B00;
L_80137AF8: ;
    r3 = 0x0;
    goto L_80137D00;
L_80137B00: ;
    if ((u32)r30 != (u32)0x0) goto L_80137B10;
    r3 = 0x0;
    goto L_80137D00;
L_80137B10: ;
    r4 = *(u16*)((u8*)r29 + 0x28);
    ((void(*)(void))fn_800EE150)();
    if ((u32)r3 != (u32)0x0) goto L_80137B28;
    r3 = 0x0;
    goto L_80137D00;
L_80137B28: ;
    ...
    r3 = r30;
    ((void(*)(void))fn_800EE150)();
    if ((u32)r3 != (u32)0x0) goto L_80137B48;
    r3 = 0x0;
    goto L_80137D00;
L_80137B48: ;
    ((void(*)(void))fn_800EE828)();
    /* extrwi r0, r28, 15, 16 */;
    if ((s32)r27 <= (s32)r0) goto L_80137B60;
    *(u16*)((u8*)r29 + 0x22) = r0;
    r27 = r0;
L_80137B60: ;
    /* clrlslwi r28, r27, 16, 5 */;
    r30 = r27 & 0xFFFF;
    r3 = r28;
    fn_800E3534();
    r0 = r3 & 0xFFFF;
    if ((s32)r27 != (s32)r0) goto L_80137B80;
    r3 = 0x0;
    goto L_80137D00;
L_80137B80: ;
    *(u16*)((u8*)r29 + 0xC) = r3;
...
L_80137BB8: ;
    r3 = r7 & 0xFFFF;
    if ((s32)r27 != (s32)r0) goto L_80137BD0;
    /* clrlslwi r3, r7, 16, 5 */;
    r3 = r3 + 0x1c;
    *(u32*)(r31 + r3) = r5;
    goto L_80137BE8;
...
L_80137C20: ;
    r3 = r7 & 0xFFFF;
    if ((u32)r3 < (u32)r0) goto L_80137BB8;
    r3 = r30 << 4;
    fn_800E3534();
    r0 = r3 & 0xFFFF;
    if ((u32)r3 != (u32)r0) goto L_80137C54;
    r3 = *(u16*)((u8*)r29 + 0xC);
    fn_800E24B0();
    r3 = *(u16*)((u8*)r29 + 0xC);
    fn_800E209C();
...
L_80137CD8: ;
    r0 = r5 & 0xFFFF;
    if ((u32)r0 < (u32)r4) goto L_80137CA8;
    r3 = 0x1;
    goto L_80137D00;
L_80137CEC: ;
    r3 = (u32)&lbl_80272B08;
...
void fn_80137D14(void) {
    ...
    *(f64*)(sp + 0x50) = f30;
    ...
    r3 = *(u16*)((u8*)r3 + 0x1C);
    r0 = *(u16*)((u8*)r30 + 0x20);
    if ((u32)r3 >= (u32)r0) goto L_80137F24;
    r3 = *(u16*)((u8*)r30 + 0x24);
    r4 = *(u16*)((u8*)r30 + 0x26);
    ((void(*)(void))fn_800F9318)();
    /* mr. r29, r3 */;
    if ((u32)r3 != (u32)r0) goto L_80137D74;
    r3 = 0x0;
    goto L_80137F28;
L_80137D74: ;
    r0 = *(u32*)((u8*)r30 + 0x14);
    if ((u32)r0 != (u32)0x0) goto L_80137D88;
    r3 = 0x0;
    goto L_80137F28;
L_80137D88: ;
    r4 = *(u16*)((u8*)r30 + 0x28);
    ((void(*)(void))fn_800EE150)();
    /* mr. r28, r3 */;
    if ((u32)r0 != (u32)0x0) goto L_80137DA0;
    r3 = 0x0;
    goto L_80137F28;
L_80137DA0: ;
    r4 = r1 + 0x2c;
    ...
    ((void(*)(void))fn_800EE150)();
    /* mr. r29, r3 */;
    if ((u32)r0 != (u32)0x0) goto L_80137DD4;
    r3 = 0x0;
    goto L_80137F28;
L_80137DD4: ;
    r4 = r1 + 0x20;
    ...
    r0 = *(u16*)((u8*)r30 + 0x1C);
    r29 = *(u32*)((u8*)r30 + 0x0);
    if ((u32)r0 == (u32)0x0) goto L_80137E34;
    r4 = r29;
    r3 = r1 + 0x14;
    ((void(*)(void))fn_800E01D0)();
    r3 = r1 + 0x8;
...
L_80137E3C: ;
    r0 = *(u16*)((u8*)r30 + 0x1C);
    r29 = *(u32*)((u8*)r29 + 0x18);
    if ((u32)r0 == (u32)0x0) goto L_80137E98;
    r3 = r28 + 0x1;
    r0 = (0x4330 << 16);
    r3 = r29;
    f1 = *(f64*)&lbl_8047D140;
...
L_80137EB0: ;
    r28 = r28 + 0x1;
L_80137EB4: ;
    if ((u32)r28 < (u32)r31) goto L_80137E3C;
    *(u32*)((u8*)r30 + 0x0) = r29;
    r0 = *(u16*)((u8*)r30 + 0x1C);
    r0 = r0 + r31;
    *(u16*)((u8*)r30 + 0x1C) = r0;
    ...
    *(u16*)((u8*)r30 + 0x1E) = r0;
    r0 = *(u16*)((u8*)r30 + 0x1C);
    r3 = *(u16*)((u8*)r30 + 0x20);
    if ((u32)r0 <= (u32)r3) goto L_80137EEC;
    *(u16*)((u8*)r30 + 0x1C) = r3;
L_80137EEC: ;
    r0 = *(u16*)((u8*)r30 + 0x1E);
    r3 = *(u16*)((u8*)r30 + 0x22);
    if ((u32)r0 <= (u32)r3) goto L_80137F00;
    *(u16*)((u8*)r30 + 0x1E) = r3;
L_80137F00: ;
    r3 = *(u16*)((u8*)r30 + 0x1C);
    r0 = *(u16*)((u8*)r30 + 0x20);
    r4 = *(u16*)((u8*)r30 + 0x1E);
    r0 = r0 - r3;
    if ((s32)r4 <= (s32)r0) goto L_80137F1C;
    *(u16*)((u8*)r30 + 0x1E) = r0;
L_80137F1C: ;
    r3 = 0x1;
    goto L_80137F28;
...
void fn_80137F58(void) {
    ...
    r3 = *(u16*)((u8*)r3 + 0x1C);
    r31 = *(u16*)((u8*)r27 + 0x1E);
    if ((u32)r0 != (u32)0x0) goto L_80137F88;
    r3 = 0x0;
    goto L_801380C0;
L_80137F88: ;
    if ((u32)r3 <= (u32)0x1) goto L_801380BC;
    if ((u32)r31 <= (u32)0x1) goto L_801380BC;
    fn_800D2248();
    r3 = 0x1;
    r4 = 0x6;
    r5 = 0x7;
...
L_801380A4: ;
    r0 = r28 & 0xFFFF;
    if ((u32)r0 < (u32)r31) goto L_80138028;
    fn_800D6728();
    r3 = 0x1;
    goto L_801380C0;
L_801380BC: ;
