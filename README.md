...
|---|---|
| Fuzzy match | 32.63% |
| Function match | 45.91% (3,950 / 8,603 functions) |
| Code match | 16.76% (418,060 / 2,495,108 matched code bytes) |
| Data match | 93.80% (2,060,017 / 2,196,124 matched data bytes) |
