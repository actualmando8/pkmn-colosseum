...
L_80130F9C:
    r12 = *(u32*)((u8*)r30 + 0x18);
    if (r12 == 0) goto L_80130FE8;
    tmp = *(u32*)((u8*)r30 + 0x4);
    if ((s32)tmp != 2) goto L_80130FE8;
    r4 = r29;
    r3 = *(u32*)((u8*)r30 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
    if (r3 != 0) goto L_80130FE8;
    *(u32*)((u8*)r30 + 0x4) = r31;
    r12 = *(u32*)((u8*)r30 + 0x14);
    if (r12 == 0) goto L_80130FE8;
    r3 = *(u32*)((u8*)r30 + 0x24);
...
L_80131058:
    r3 = 0x0;
L_8013105C:
    if (r3 == 0) goto L_80131098;
    tmp = *(u32*)((u8*)r3 + 0x4);
    r12 = *(u32*)((u8*)r3 + 0x14);
    if ((s32)tmp == 0) goto L_80131098;
    if ((s32)tmp == 1) goto L_80131098;
    tmp = 0x1;
    *(u32*)((u8*)r3 + 0x4) = tmp;
    if (r12 == 0) goto L_80131098;
    r3 = *(u32*)((u8*)r3 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_80131098:
...
L_80131168:
    r31 = 0x0;
L_8013116C:
    if (r31 == 0) goto L_801311E8;
    tmp = *(u32*)((u8*)r31 + 0x4);
    if ((s32)tmp == 0) goto L_801311D8;
    r12 = *(u32*)((u8*)r31 + 0x10);
    tmp = 0x2;
    *(u32*)((u8*)r31 + 0x4) = tmp;
    if (r12 == 0) goto L_801311E8;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
    if (r3 != 0) goto L_801311D0;
    r12 = *(u32*)((u8*)r31 + 0x14);
    tmp = 0x1;
    *(u32*)((u8*)r31 + 0x4) = tmp;
    if (r12 == 0) goto L_801311C8;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_801311C8:
...
L_801312BC:
    r31 = 0x0;
L_801312C0:
    if (r31 == 0) goto L_80131380;
    tmp = *(u32*)((u8*)r31 + 0x4);
    r30 = *(u32*)((u8*)r31 + 0x30);
    r29 = *(u32*)((u8*)r31 + 0x2C);
    if ((s32)tmp == 0) goto L_8013131C;
    if ((s32)tmp == 1) goto L_801312FC;
    r12 = *(u32*)((u8*)r31 + 0x14);
    if (r12 == 0) goto L_801312FC;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_801312FC:
    r12 = *(u32*)((u8*)r31 + 0xC);
    if (r12 == 0) goto L_80131314;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_80131314:
...
L_801313E8:
    r31 = 0x0;
L_801313EC:
    if (r31 == 0) goto L_80131414;
    r12 = *(u32*)((u8*)r31 + 0x8);
    if (r12 == 0) goto L_8013140C;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_8013140C:
