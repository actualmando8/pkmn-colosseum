 ...
 *
 *   itemParamConvertOrigFormat (peopleFieldRelease)   -- 0x2B4 bytes
 *     Release an NPC slot back to the free pool.
 *
 *   itemParamGetRecoverType (peopleFieldInit)      -- 0x4F0 bytes
...
/* hpRecover__FP20ITEMUSE2POKEMON_LOG1PsP7PokemonUcbUsP12FightPokemon: peopleFieldFinalizeModel (0x1A8 bytes) */
...
#include "src/game/people/people_data_itemGetStatus.inc"
}
#else
...
#if 1
asm void itemParamConvertOrigFormat(void) {
#include "src/game/people/people_data_itemParamConvertOrigFormat.inc"
}
#else
void itemParamConvertOrigFormat(void) { /* TODO */ }
#endif
#if 1
asm void itemParamGetRecoverType(void) {
#include "src/game/people/people_data_itemParamGetRecoverType.inc"
}
#else
void itemParamGetRecoverType(void) { /* TODO */ }
#endif
#if 0
