...
void fn_800C4928(void) {
    ...
    /* clrrwi. r9, r3, 31 */;
    if ((s32)tmp == 0) goto L_800C493C;
    r4 = 0x0 - r4;
    /* subfze r3, r3 */;
L_800C493C:
    /* clrrwi. r10, r5, 31 */;
    if ((s32)tmp == 0) goto L_800C4950;
    r6 = 0x0 - r6;
    /* subfze r5, r5 */;
L_800C4950:
    tmp = __cntlzw(r3);
    r9 = __cntlzw(r4);
    if ((s32)r3 != 0) goto L_800C4968;
    tmp = r9 + 0x20;
L_800C4968:
    r9 = __cntlzw(r5);
    r10 = __cntlzw(r6);
    if ((s32)r5 != 0) goto L_800C497C;
    r9 = r10 + 0x20;
L_800C497C:
    r10 = 0x40 - tmp;
    if ((s32)tmp > (s32)r9) goto L_800C4A50;
    r9 = r9 + 0x1;
    r9 = 0x40 - r9;
    tmp = tmp + r9;
    r9 = r10 - r9;
    ctr_fn = (void(*)(void))r9;
    if ((s32)r9 < 0x20) goto L_800C49B4;
    r8 = (u32)r3 >> r7;
    r7 = 0x0;
    goto L_800C49C8;
L_800C49B4:
    ...
    r7 = (u32)r3 >> r9;
L_800C49C8:
    if ((s32)tmp < 0x20) goto L_800C49E0;
    r3 = r4 << r9;
    r4 = 0x0;
    goto L_800C49F4;
L_800C49E0:
...
L_800C49FC:
    ...
    tmp = r8 - r6;
    /* subfe. r9, r5, r7 */;
    if ((s32)tmp < 0x20) goto L_800C4A24;
    r8 = tmp;
    r7 = r9;
    tmp = r10 + 0x1;
L_800C4A24:
    ...
    r3 = r3 + r3; /* +carry */;
    /* xor. r7, r9, r10 */;
    if ((s32)tmp == 0x20) goto L_800C4A58;
    r4 = 0x0 - r4;
    /* subfze r3, r3 */;
    goto L_800C4A58;
L_800C4A50:
...
void fn_800C4B44(void) {
    ...
    if ((s32)r3 >= 0) goto L_800C4B54;
    r4 = 0x0 - r4;
    /* subfze r3, r3 */;
L_800C4B54:
    if ((s32)r5 >= 0) goto L_800C4B64;
    r6 = 0x0 - r6;
    /* subfze r5, r5 */;
L_800C4B64:
    tmp = __cntlzw(r3);
    r9 = __cntlzw(r4);
    if ((s32)r3 != 0) goto L_800C4B78;
    tmp = r9 + 0x20;
L_800C4B78:
    r9 = __cntlzw(r5);
    r10 = __cntlzw(r6);
    if ((s32)r5 != 0) goto L_800C4B8C;
    r9 = r10 + 0x20;
L_800C4B8C:
    r10 = 0x40 - tmp;
    if ((s32)tmp > (s32)r9) goto L_800C4C40;
    r9 = r9 + 0x1;
    r9 = 0x40 - r9;
    tmp = tmp + r9;
    r9 = r10 - r9;
    ctr_fn = (void(*)(void))r9;
    if ((s32)r9 < 0x20) goto L_800C4BC4;
    r8 = (u32)r3 >> r7;
    r7 = 0x0;
    goto L_800C4BD8;
L_800C4BC4:
    ...
    r7 = (u32)r3 >> r9;
L_800C4BD8:
    if ((s32)tmp < 0x20) goto L_800C4BF0;
    r3 = r4 << r9;
    r4 = 0x0;
    goto L_800C4C04;
L_800C4BF0:
...
L_800C4C0C:
    ...
    tmp = r8 - r6;
    /* subfe. r9, r5, r7 */;
    if ((s32)tmp < 0x20) goto L_800C4C34;
    r8 = tmp;
    r7 = r9;
    tmp = r10 + 0x1;
L_800C4C34:
...
void fn_800C4D8C(void) {
    ...
    if ((s32)tmp != (s32)-0x1) goto L_800C4E1C;
    r3 = (u32)lbl_8026FE70;
    r3 = (u32)lbl_8026FE70;
    OSReport();
    r3 = (u32)lbl_8026FEA8;
