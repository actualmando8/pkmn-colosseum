...
void fn_801990B8(void) {
    ...
    fn_801A8470();
    r0 = r30 & 0x04000000;
    if ((s32)r0 != (s32)0) goto L_80199104;
    r5 = *(u32*)((u8*)r27 + 0x8);
    r4 = r30;
    r3 = *(u32*)((u8*)r27 + 0x8);
    r5 = *(u32*)((u8*)r5 + 0x0);
...
L_8019910C: ;
    ...
    r31 = *(u32*)((u8*)r31 + 0x4);
L_80199130: ;
    if ((u32)r31 != (u32)0x0) goto L_8019910C;
    r0 = r30 & 0x04000000;
    if ((u32)r31 != (u32)0x0) goto L_8019915C;
    r5 = *(u32*)((u8*)r27 + 0x8);
    r4 = r30;
    r3 = *(u32*)((u8*)r27 + 0x8);
    r5 = *(u32*)((u8*)r5 + 0x0);
...
void fn_801992D8(void) {
    ...
    /* mr. r30, r3 */;
    if ((s32)r0 != (s32)0) goto L_801992FC;
    r3 = 0x0;
    goto L_8019938C;
L_801992FC: ;
    r0 = *(u32*)((u8*)r30 + 0x0);
    if ((u32)r0 == (u32)0x0) goto L_80199318;
    r3 = *(u32*)((u8*)r30 + 0x0);
    fn_80193748();
    if ((u32)r3 != (u32)0x0) goto L_80199354;
L_80199318: ;
    r0 = *(u32*)lbl_8047B260;
    if ((u32)r0 == (u32)0x0) goto L_8019932C;
    r3 = *(u32*)lbl_8047B260;
    goto L_80199334;
L_8019932C: ;
    r3 = (u32)lbl_8036C7A0;
...
L_80199334: ;
    fn_80193828();
    /* mr. r31, r3 */;
    if ((u32)r0 != (u32)0x0) goto L_80199370;
    r3 = (u32)lbl_8047DA18;
    r4 = 0x214;
    r5 = (u32)lbl_8047DA20;
    fn_80196E10();
...
void fn_801993A4(void) {
    ...
    r30 = r3;
    r29 = *(u32*)((u8*)r4 + 0x4);
    if ((u32)r29 != (u32)0x0) goto L_801993DC;
    r28 = 0x0;
    goto L_80199468;
L_801993DC: ;
    r0 = *(u32*)((u8*)r29 + 0x0);
    if ((u32)r0 == (u32)0x0) goto L_801993F8;
    r3 = *(u32*)((u8*)r29 + 0x0);
    fn_80193748();
    if ((u32)r3 != (u32)0x0) goto L_80199434;
L_801993F8: ;
    r0 = *(u32*)lbl_8047B260;
    if ((u32)r0 == (u32)0x0) goto L_8019940C;
    r3 = *(u32*)lbl_8047B260;
    goto L_80199414;
L_8019940C: ;
    r3 = (u32)lbl_8036C7A0;
...
L_80199414: ;
    fn_80193828();
    /* mr. r28, r3 */;
    if ((u32)r0 != (u32)0x0) goto L_80199450;
    r3 = (u32)lbl_8047DA18;
    r4 = 0x214;
    r5 = (u32)lbl_8047DA20;
    fn_80196E10();
...
L_80199468: ;
    ...
    *(u32*)((u8*)r30 + 0xC) = r3;
    r0 = *(u32*)((u8*)r30 + 0x8);
    if ((u32)r0 == (u32)0x0) goto L_80199544;
    r3 = *(u32*)((u8*)r30 + 0x8);
    r0 = (0x4000 << 16);
    r3 = *(u32*)((u8*)r3 + 0x4);
    r3 = r3 & 0x60000000;
    if ((s32)r3 == (s32)r0) goto L_801994E4;
    if ((s32)r3 >= (s32)r0) goto L_801994B8;
    if ((s32)r3 == (s32)0x0) goto L_801994C8;
    goto L_8019951C;
L_801994B8: ;
    r0 = (0x6000 << 16);
    if ((s32)r3 == (s32)r0) goto L_80199500;
    goto L_8019951C;
L_801994C8: ;
    if ((u32)r30 == (u32)0x0) goto L_80199544;
    r0 = *(u32*)((u8*)r30 + 0x14);
    r0 = r0 & 0xFFFFFFF1;
    r0 = r0 | 0x2;
    *(u32*)((u8*)r30 + 0x14) = r0;
...
void fn_80199654(void) {
    ...
    if ((u32)r3 == (u32)0x0) goto L_801996E8;
    r31 = r3;
    r30 = r4;
    r29 = r5;
    goto L_801996E0;
L_80199684: ;
    if ((u32)r31 == (u32)0x0) goto L_801996B4;
    r3 = *(u32*)((u8*)r31 + 0xC);
    if ((u32)r29 == (u32)0x0) goto L_801996A0;
    r4 = *(u32*)((u8*)r29 + 0x4);
    goto L_801996A4;
L_801996A0: ;
    r4 = 0x0;
...
L_801996B4: ;
    r31 = *(u32*)((u8*)r31 + 0x4);
    if ((u32)r30 == (u32)0x0) goto L_801996C8;
    r30 = *(u32*)((u8*)r30 + 0x0);
    goto L_801996CC;
L_801996C8: ;
    r30 = 0x0;
L_801996CC: ;
    if ((u32)r29 == (u32)0x0) goto L_801996DC;
    r29 = *(u32*)((u8*)r29 + 0x0);
    goto L_801996E0;
L_801996DC: ;
    r29 = 0x0;
L_801996E0: ;
    if ((u32)r31 != (u32)0x0) goto L_80199684;
L_801996E8: ;
    r31 = *(u32*)(sp + 0x1C);
    r30 = *(u32*)(sp + 0x18);
    r29 = *(u32*)(sp + 0x14);
...
void fn_80199794(void) {
    ...
    /* stmw r22, 0x18(r1) */;
    /* mr. r25, r3 */;
    if ((s32)r0 == (s32)0) goto L_80199A6C;
    r3 = (u32)lbl_80465378;
    r3 = (u32)lbl_80465378;
    fn_801AA4CC();
    /* mr. r22, r3 */;
    if ((s32)r0 != (s32)0) goto L_801997D0;
    r3 = (u32)lbl_8047DA30;
    r4 = 0x2f3;
    r5 = (u32)lbl_8047DA38;
    fn_80196E10();
L_801997D0: ;
    ...
    r28 = *(u32*)((u8*)r25 + 0x0);
    r27 = r22;
    if ((u32)r28 == (u32)0x0) goto L_80199A18;
    r3 = (u32)lbl_80465378;
    r3 = (u32)lbl_80465378;
    fn_801AA4CC();
    /* mr. r31, r3 */;
    if ((u32)r28 != (u32)0x0) goto L_80199814;
    r3 = (u32)lbl_8047DA30;
    r4 = 0x2f3;
    r5 = (u32)lbl_8047DA38;
    fn_80196E10();
L_80199814: ;
    ...
    memset((void*)r3, (int)r4, (u32)r5);
    r30 = *(u32*)((u8*)r28 + 0x0);
    if ((u32)r30 == (u32)0x0) goto L_801999C8;
    r3 = (u32)lbl_80465378;
    r3 = (u32)lbl_80465378;
    fn_801AA4CC();
    /* mr. r26, r3 */;
    if ((u32)r30 != (u32)0x0) goto L_80199854;
    r3 = (u32)lbl_8047DA30;
    r4 = 0x2f3;
    r5 = (u32)lbl_8047DA38;
    fn_80196E10();
L_80199854: ;
    ...
    memset((void*)r3, (int)r4, (u32)r5);
    r29 = *(u32*)((u8*)r30 + 0x0);
    if ((u32)r29 == (u32)0x0) goto L_80199978;
    r3 = (u32)lbl_80465378;
    r3 = (u32)lbl_80465378;
    fn_801AA4CC();
    r5 = (u32)lbl_80465378;
    ...
    r3 = r0;
    fn_80199A84();
    if ((u32)r22 != (u32)0x0) goto L_801998B0;
    r3 = (u32)lbl_8047DA30;
    r4 = 0x2f3;
    r5 = (u32)lbl_8047DA38;
    fn_80196E10();
L_801998B0: ;
    ...
    memset((void*)r3, (int)r4, (u32)r5);
    r23 = *(u32*)((u8*)r29 + 0x0);
    if ((u32)r23 == (u32)0x0) goto L_80199928;
    fn_80199738();
    r24 = r3;
    r3 = *(u32*)((u8*)r23 + 0x0);
    fn_80199794();
