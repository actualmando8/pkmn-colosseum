...
void fn_800BE800(void) {
    extern u8 lbl_8026F640[];
    extern void fn_800C3588();
    u8 sp[0x10];
    u32 r0 = 0;
    u32 r1 = (u32)sp;
    u32 r3 = 0;
...
L_800BE874: ;
    r0 = *(u32*)((u8*)r27 + 0x0);
    if ((s32)r0 == (s32)0x0) goto L_800BE888;
    r25 = r31;
    goto L_800BE88C;
L_800BE888: ;
    r25 = r1 + 0x8;
L_800BE88C: ;
    ...
    r26 = 0x0;
    r0 = r0 - r3;
    if ((u32)r24 <= (u32)r0) goto L_800BE8B0;
    r26 = 0x302;
    r24 = r0;
L_800BE8B0: ;
    r4 = r3 + 0x10;
    ...
    *(u32*)((u8*)r28 + 0xC) = r0;
    r0 = *(u32*)((u8*)r27 + 0x0);
    if ((s32)r0 != (s32)0x0) goto L_800BE904;
    if ((s32)r26 != (s32)0x0) goto L_800BE904;
    r0 = *(u8*)((u8*)r25 + 0x3);
    *(u8*)((u8*)r31 + 0x0) = r0;
    r0 = *(u8*)((u8*)r25 + 0x2);
    *(u8*)((u8*)r31 + 0x1) = r0;
...
L_800BE904: ;
    ...
    r30 = r30 + 0x1;
L_800BE910: ;
    if ((s32)r3 != (s32)0x0) goto L_800BE920;
    if ((s32)r30 < (s32)r29) goto L_800BE874;
L_800BE920: ;
    /* lmw r24, 0x10(r1) */;
    return;
}
...
L_800BE95C: ;
    ...
    r31 = 0x0;
    r0 = r0 - r3;
    if ((u32)r30 <= (u32)r0) goto L_800BE980;
    r31 = 0x302;
    r30 = r0;
L_800BE980: ;
    r4 = r3 + 0x10;
    ...
    *(u32*)((u8*)r26 + 0xC) = r0;
L_800BE9A8: ;
    if ((s32)r3 != (s32)0x0) goto L_800BE9B8;
    if ((s32)r29 < (s32)r28) goto L_800BE95C;
L_800BE9B8: ;
    /* lmw r26, 0x8(r1) */;
    return;
}
...
void fn_800BE9CC(void) {
    ...
    r27 = r3;
    r30 = r4;
    r0 = *(u32*)gTRKBigEndian;
    if ((s32)r0 == (s32)0x0) goto L_800BE9FC;
    r31 = r30;
    goto L_800BEA00;
L_800BE9FC: ;
    r31 = r1 + 0x8;
L_800BEA00: ;
    ...
    r29 = 0x0;
    r0 = r0 - r3;
    if ((u32)r28 <= (u32)r0) goto L_800BEA24;
    r29 = 0x302;
    r28 = r0;
L_800BEA24: ;
    r4 = r3 + 0x10;
    ...
    *(u32*)((u8*)r27 + 0xC) = r0;
    r0 = *(u32*)gTRKBigEndian;
    if ((s32)r0 != (s32)0x0) goto L_800BEA9C;
    if ((s32)r29 != (s32)0x0) goto L_800BEA9C;
    r0 = *(u8*)((u8*)r31 + 0x7);
    *(u8*)((u8*)r30 + 0x0) = r0;
    r0 = *(u8*)((u8*)r31 + 0x6);
    *(u8*)((u8*)r30 + 0x1) = r0;
...
L_800BEAE4: ;
    r0 = *(u32*)((u8*)r31 + 0x0);
    r3 = *(u32*)((u8*)r30 + 0x0);
    if ((s32)r0 == (s32)0x0) goto L_800BEB00;
    r4 = r1 + 0x8;
    goto L_800BEB24;
L_800BEB00: ;
    r6 = *(u8*)(sp + 0xB);
...
L_800BEB24: ;
    ...
    r26 = 0x0;
    r0 = 0x880 - r5;
    if ((u32)r0 >= (u32)0x4) goto L_800BEB44;
    r26 = 0x301;
    r25 = r0;
L_800BEB44: ;
    if ((u32)r25 != (u32)0x1) goto L_800BEB5C;
    r3 = *(u8*)((u8*)r4 + 0x0);
    r0 = r5 + 0x10;
    *(u8*)(r27 + r0) = r3;
    goto L_800BEB6C;
...
L_800BEB6C: ;
    ...
    *(u32*)((u8*)r27 + 0x8) = r0;
L_800BEB8C: ;
    if ((s32)r3 != (s32)0x0) goto L_800BEB9C;
    if ((s32)r29 < (s32)r28) goto L_800BEAE4;
L_800BEB9C: ;
    /* lmw r25, 0x14(r1) */;
    return;
}
...
L_800BEBBC: ;
    r7 = *(u32*)((u8*)r3 + 0xC);
    r8 = *(u8*)((u8*)r4 + 0x0);
    if ((u32)r7 < (u32)0x880) goto L_800BEBD4;
    r7 = 0x301;
    goto L_800BEBF4;
L_800BEBD4: ;
    r6 = r7 + 0x1;
...
L_800BEBF4: ;
    ...
    r4 = r4 + 0x1;
L_800BEC00: ;
    if ((s32)r0 != (s32)0x0) goto L_800BEC10;
    if ((s32)r9 < (s32)r5) goto L_800BEBBC;
L_800BEC10: ;
    r3 = r0;
    return;
}
...
void fn_800BEC18(void) {
    ...
    r4 = (u32)gTRKBigEndian;
    r31 = r3;
    r0 = *(u32*)gTRKBigEndian;
    if ((s32)r0 == (s32)0x0) goto L_800BEC54;
    r4 = r1 + 0x8;
    goto L_800BEC98;
L_800BEC54: ;
    r10 = *(u8*)(sp + 0xF);
...
L_800BEC98: ;
    ...
    r30 = 0x0;
    r0 = 0x880 - r3;
    if ((u32)r0 >= (u32)0x8) goto L_800BECB8;
    r30 = 0x301;
    r29 = r0;
L_800BECB8: ;
    if ((u32)r29 != (u32)0x1) goto L_800BECD0;
    r0 = *(u8*)((u8*)r4 + 0x0);
    r3 = r31 + r3;
    *(u8*)((u8*)r3 + 0x10) = r0;
    goto L_800BECE0;
...
void fn_800BED14(void) {
    ...
    r29 = r3;
    r3 = r4;
    if ((s32)r0 != (s32)0) goto L_800BED48;
    r3 = 0x0;
    goto L_800BED84;
L_800BED48: ;
    r4 = *(u32*)((u8*)r29 + 0xC);
    r0 = *(u32*)((u8*)r29 + 0x8);
    r0 = r0 - r4;
    if ((u32)r30 <= (u32)r0) goto L_800BED64;
    r31 = 0x302;
    r30 = r0;
L_800BED64: ;
    r4 = r4 + 0x10;
...
void fn_800BEDA0(void) {
    ...
    /* mr. r30, r5 */;
    r29 = r3;
    if ((s32)r0 != (s32)0) goto L_800BEDD0;
    r3 = 0x0;
    goto L_800BEE28;
L_800BEDD0: ;
    r3 = *(u32*)((u8*)r29 + 0xC);
    r0 = 0x880 - r3;
    if ((u32)r0 >= (u32)r30) goto L_800BEDE8;
    r31 = 0x301;
    r30 = r0;
L_800BEDE8: ;
    if ((u32)r30 != (u32)0x1) goto L_800BEE00;
    r0 = *(u8*)((u8*)r4 + 0x0);
    r3 = r29 + r3;
    *(u8*)((u8*)r3 + 0x10) = r0;
    goto L_800BEE10;
...
void fn_800BEE74(void) {
    ...
    *(u32*)((u8*)r3 + 0x8) = r0;
    *(u32*)((u8*)r3 + 0xC) = r0;
    if ((s32)r4 != (s32)0x0) goto L_800BEEA4;
    r3 = r3 + 0x10;
    r4 = 0x0;
    r5 = 0x880;
    fn_80003458();
