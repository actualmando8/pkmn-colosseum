...
void fn_80191118(void) {
    ...
    r4 = r1 + 0x8;
    fn_800D2F34();
    if ((s32)r31 == (s32)0x0) goto L_8019120C;
    if ((s32)r3 != (s32)0x0) goto L_80191214;
L_8019120C: ;
    r3 = 0x2;
    goto L_80191344;
L_80191214: ;
    if ((s32)r31 != (s32)0x1) goto L_8019122C;
    if ((s32)r3 != (s32)0x1) goto L_8019122C;
    r3 = 0x0;
    goto L_80191344;
L_8019122C: ;
    f2 = *(f32*)(sp + 0x14);
    f1 = *(f32*)lbl_8047D8B8;
    if (f2 >= f1) goto L_80191250;
    f0 = *(f32*)(sp + 0x8);
    if (f0 >= f1) goto L_80191250;
    r3 = 0x0;
    goto L_80191344;
L_80191250: ;
    f1 = *(f32*)lbl_8047D8BC;
    if (f2 <= f1) goto L_80191270;
    f0 = *(f32*)(sp + 0x8);
    if (f0 <= f1) goto L_80191270;
    r3 = 0x0;
    goto L_80191344;
L_80191270: ;
    f3 = *(f32*)(sp + 0x18);
    f1 = *(f32*)lbl_8047D8B8;
    if (f3 >= f1) goto L_80191294;
    f0 = *(f32*)(sp + 0xC);
    if (f0 >= f1) goto L_80191294;
    r3 = 0x0;
    goto L_80191344;
L_80191294: ;
    f1 = *(f32*)lbl_8047D8C0;
    if (f3 <= f1) goto L_801912B4;
    f0 = *(f32*)(sp + 0xC);
    if (f0 <= f1) goto L_801912B4;
    r3 = 0x0;
    goto L_80191344;
L_801912B4: ;
    if ((s32)r31 == (s32)0x1) goto L_801912C4;
    if ((s32)r3 != (s32)0x1) goto L_801912CC;
L_801912C4: ;
    r3 = 0x1;
    goto L_80191344;
L_801912CC: ;
    f1 = *(f32*)lbl_8047D8B8;
    if (f2 < f1) goto L_801912E4;
    f4 = *(f32*)(sp + 0x8);
    if (f4 >= f1) goto L_801912EC;
L_801912E4: ;
    r3 = 0x1;
    goto L_80191344;
L_801912EC: ;
    f0 = *(f32*)lbl_8047D8BC;
    if (f2 > f0) goto L_80191300;
    if (f4 <= f0) goto L_80191308;
L_80191300: ;
    r3 = 0x1;
    goto L_80191344;
L_80191308: ;
    if (f3 < f1) goto L_8019131C;
    f2 = *(f32*)(sp + 0xC);
    if (f2 >= f1) goto L_80191324;
L_8019131C: ;
    r3 = 0x1;
    goto L_80191344;
L_80191324: ;
    f0 = *(f32*)lbl_8047D8C0;
    if (f3 > f0) goto L_80191338;
    if (f2 <= f0) goto L_80191340;
L_80191338: ;
    r3 = 0x1;
    goto L_80191344;
L_80191340: ;
...
void fn_80191358(void) {
    ...
    *(f64*)(sp + 0x10) = f29;
    /* psq_st f29, 0x18(r1), 0, qr0 */;
    r31 = r3;
    f29 = f1;
    r0 = *(u8*)((u8*)r3 + 0x1);
    f30 = f2;
    f31 = f3;
    if ((u32)r0 == (u32)0x0) goto L_801913C4;
    r0 = 0x0;
    r3 = r31 + 0x10;
    *(u8*)((u8*)r31 + 0x1) = r0;
    fn_800E01F4();
