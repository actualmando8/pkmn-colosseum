...
LAB_80024E94:
    ...
    *(s16*)(arg1 + 0x50) = (s32)(lbl_8047B8E0 + (f32)(s32)(s16)unaff_r28 + lbl_8047A374);
    *(s16*)(arg1 + 0x52) = (s32)(lbl_8047B8E0 + (f32)(s32)(s16)unaff_r31 + lbl_8047A374);
}
#endif
