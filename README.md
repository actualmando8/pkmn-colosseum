...
|---|---|
| Fuzzy match | 56.65% |
| Function match | 71.06% (6,113 / 8,603 functions) |
| Code match | 33.60% (838,448 / 2,495,108 matched code bytes) |
| Data match | 97.29% (2,136,505 / 2,196,124 matched data bytes) |
| Linked into DOL | 202 / 644 units (3.36% of code) |
