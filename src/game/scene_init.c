...
#else
#pragma optimization_level 4
void fn_8003956C(u32 unused, u8* p) {
    u16 total;
    u32 count;
    s16 i;
    total = (u16)fn_801347D0();
    count = 0;
    for (i = 0; i < (s16)total; i++) {
        if ((u8)fn_801429E8(fn_80134768(NULL, i)) != 0) {
            count++;
        }
    }
    fn_80109220((u32)p, (lbl_8047A4A8 + 8) < (count + 1) ? 1 : 0);
}
#endif
