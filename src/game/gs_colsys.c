...
void fn_8010D3C8(void) {
    ...
    r30 = *(u32*)((u8*)r29 + 0x0);
    r31 = 0x0;
    while (r31 < *(u32*)((u8*)r29 + 0x4)) {
    /* L_8010D474 */
    tmp = *(u16*)((u8*)r30 + 0x3C);
    tmp = tmp & 0x1;
    if ((s32)tmp != 0) { r31 = r31 + 0x1; r30 = r30 + 0x40; continue; }
    r4 = r31;
    r3 = (u32)sp + 0xb8;
    fn_8010CA30();
    r4 = r31;
...
void fn_8010D8D4(void) {
    ...
    r3 = r3 + tmp;
    r29 = r3 + 0x4;
    while (r31 < *(u32*)((u8*)r28 + 0x4)) {
    /* L_8010D964 */
    tmp = *(u16*)((u8*)r29 + 0x24);
    tmp = tmp & 0x1;
    if ((s32)tmp != 0) { r31 = r31 + 0x1; r30 = r30 + 0x40; r29 = r29 + 0x28; continue; }
    tmp = *(u16*)((u8*)r30 + 0x3C);
    tmp = tmp & 0x1;
    if ((s32)tmp == 0) { r31 = r31 + 0x1; r30 = r30 + 0x40; r29 = r29 + 0x28; continue; }
    r4 = r31;
...
void fn_8010DEF0(void) {
    ...
    f6 = *(f32*)((u8*)r4 + 0x0);
    if (f1 > f6) { r3 = 0x0; return; }
    f7 = *(f32*)((u8*)r4 + 0x8);
    if (f0 > f7) { r3 = 0x0; return; }
    if (f3 < f6) { r3 = 0x0; return; }
    if (f2 < f7) {
