...
s32 fn_80069C0C(void) {
    ...
    L_80069CAC: ;
    r0 = *(u32*)((u8*)r31 + 0x14);
    if ((s32)r0 == (s32)0x7 || (s32)r0 >= (s32)0x7) goto L_80069CD0;
    ...
    } else if ((u32)r0 < (u32)0x3c) {
    if ((u32)r0 >= (u32)0x3c) goto L_80069D30;
        r4 = 0x17;

    } else if ((u32)r0 < (u32)0x63) {
    ...
    *(u32*)&lbl_8047A5D8 = r0;
    ...
    r3 = *(u8*)(r27 + r0);
    /* subi r5, r3, 0x1 */;
    if ((s32)r4 == (s32)0x0 || (s32)r4 == (s32)0x1) goto L_8006A0A4;
    ...
    r3 = *(u8*)(r27 + r0);
    /* subi r5, r3, 0x1 */;
    if ((s32)r4 == (s32)0x0 || (s32)r4 == (s32)0x1) goto L_8006A120;
    ...
    *(u16*)((u8*)r4 + 0x0) = r0;
    ...
    r4 = *(u32*)((u8*)r31 + 0x14);
    r3 = *(u32*)((u8*)r31 + 0xC);
    if ((s32)r0 == (s32)0x0 || (s32)r0 == (s32)0x1) goto L_8006A2E4;
...
s32 fn_8006ACCC(void) {
    ...
    fn_80129280();
    r0 = *(u32*)((u8*)r3 + 0x4);
    if ((s32)r0 == (s32)0x2 || (s32)r0 >= (s32)0x2) goto L_8006AD40;
...
s32 fn_8006B9B8(void) {
    ...
    fn_80129280();
    r0 = *(u32*)((u8*)r3 + 0x4);
    if ((s32)r0 == (s32)0x2 || (s32)r0 >= (s32)0x2) goto L_8006B9FC;
...
s32 fn_8006E798(void) {
    ...
    fn_80129280();
    r0 = *(u32*)((u8*)r3 + 0x4);
    if ((s32)r0 == (s32)0x2 || (s32)r0 >= (s32)0x2) goto L_8006E888;
