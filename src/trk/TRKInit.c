...
void fn_800C2EAC(void) {
    ...
    *(u32*)((u8*)r12 + 0x4) = tmp;
    ...
    r30 = r3;
    r23 = r5;
    if (r31 < 0x4000) goto L_800C3080;
    r4 = *(u32*)((u8*)r23 + 0x0);
    tmp = 0x8000000;
    r3 = r31 + r4;
    if (r3 <= tmp) goto L_800C2EF4;
    goto L_800C3080;
L_800C2EF4:
    tmp = r31 & 0x1F;
    /* clrrwi r27, r31, 5 */;
...
void fn_800C3218(void) {
    ...
    r3 = (u32)&lbl_803FED58;
    r3 = *(u32*)((u8*)r3 + 0x0);
    if (r3 > 0x44) goto L_800C3264;
    tmp = r3 + 0x4000;
    if (tmp <= 0x44) goto L_800C3264;
    r3 = (u32)gTRKCPUState;
    r3 = (u32)gTRKCPUState;
    tmp = *(u32*)((u8*)r3 + 0x238);
    tmp = tmp & 0x3;
...
L_800C3284:
    ...
    r3 = (u32)&lbl_803FED58;
    r3 = *(u32*)((u8*)r3 + 0x0);
    if (r6 < r3) goto L_800C32D4;
    tmp = r3 + 0x4000;
    if (r6 >= tmp) goto L_800C32D4;
...
L_800C3320:
    r30 = r30 + 0x1;
    r31 = r31 + 0x4;
    if ((s32)r30 <= 0xe) goto L_800C3284;
    return;
}
