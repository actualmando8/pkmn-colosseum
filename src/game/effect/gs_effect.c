...
void fn_80130CE0(void) {
    ...
    r4 = (u32)&lbl_803635C0;
    *(u16*)((u8*)r4 + 0x4) = r3;
    if ((s32)r0 == (s32)0) goto L_80130E98;
    r3 = r0;
    fn_800E27B0();
    r4 = (u32)&lbl_803635C0;
    r24 = r3;
    ...
    *(u32*)((u8*)r24 + 0x2C) = r4;
    *(u16*)((u8*)r24 + 0x0) = r0;
    if ((s32)r3 <= (s32)0x1) goto L_80130E6C;
    /* subi r0, r3, 0x1 */;
    /* subi r23, r25, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80130E60;
    goto L_80130E30;
L_80130D84: ;
    /* subi r6, r4, 0x34 */;
    r0 = r7 + 0x1;
...
L_80130E30: ;
    r7 = r5 & 0xFFFF;
    if ((s32)r7 < (s32)r23) goto L_80130D84;
    goto L_80130E60;
L_80130E40: ;
    /* subi r6, r4, 0x34 */;
    r0 = r7 + 0x1;
...
L_80130F9C: ;
    r12 = *(u32*)((u8*)r30 + 0x18);
    if ((u32)r12 == (u32)0x0) goto L_80130FE8;
    r0 = *(u32*)((u8*)r30 + 0x4);
    if ((s32)r0 != (s32)0x2) goto L_80130FE8;
    r4 = r29;
    r3 = *(u32*)((u8*)r30 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
    if ((u32)r3 != (u32)0x0) goto L_80130FE8;
    *(u32*)((u8*)r30 + 0x4) = r31;
    r12 = *(u32*)((u8*)r30 + 0x14);
    if ((u32)r12 == (u32)0x0) goto L_80130FE8;
    r3 = *(u32*)((u8*)r30 + 0x24);
...
L_80130FE8: ;
    r30 = *(u32*)((u8*)r30 + 0x2C);
L_80130FEC: ;
    if ((u32)r30 != (u32)0x0) goto L_80130F9C;
    r31 = *(u32*)(sp + 0x1C);
    r30 = *(u32*)(sp + 0x18);
    r29 = *(u32*)(sp + 0x14);
    return;
...
void fn_80131010(void) {
    ...
    if ((u32)r3 == (u32)0x0) goto L_80131058;
    r4 = (u32)&lbl_803635C0;
    r4 = (u32)&lbl_803635C0;
    r0 = *(u32*)((u8*)r4 + 0x0);
    if ((u32)r3 > (u32)r0) goto L_80131058;
    /* subi r0, r3, 0x1 */;
    r3 = *(u32*)((u8*)r4 + 0xC);
    r0 = r0 * 0x34;
    r3 = r3 + r0;
    r0 = *(u32*)((u8*)r3 + 0x4);
    if ((s32)r0 == (s32)-0x1) goto L_80131058;
    goto L_8013105C;
L_80131058: ;
    r3 = 0x0;
L_8013105C: ;
    if ((u32)r3 == (u32)0x0) goto L_80131098;
    r0 = *(u32*)((u8*)r3 + 0x4);
    r12 = *(u32*)((u8*)r3 + 0x14);
    if ((s32)r0 == (s32)0x0) goto L_80131098;
    if ((s32)r0 == (s32)0x1) goto L_80131098;
    r0 = 0x1;
    *(u32*)((u8*)r3 + 0x4) = r0;
    if ((u32)r12 == (u32)0x0) goto L_80131098;
    r3 = *(u32*)((u8*)r3 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_80131098: ;
...
void fn_8013111C(void) {
    ...
    if ((u32)r3 == (u32)0x0) goto L_80131168;
    r4 = (u32)&lbl_803635C0;
    r4 = (u32)&lbl_803635C0;
    r0 = *(u32*)((u8*)r4 + 0x0);
    if ((u32)r3 > (u32)r0) goto L_80131168;
    /* subi r0, r3, 0x1 */;
    r3 = *(u32*)((u8*)r4 + 0xC);
    r0 = r0 * 0x34;
    r31 = r3 + r0;
    r0 = *(u32*)((u8*)r31 + 0x4);
    if ((s32)r0 == (s32)-0x1) goto L_80131168;
    goto L_8013116C;
L_80131168: ;
    r31 = 0x0;
L_8013116C: ;
    if ((u32)r31 == (u32)0x0) goto L_801311E8;
    r0 = *(u32*)((u8*)r31 + 0x4);
    if ((s32)r0 == (s32)0x0) goto L_801311D8;
    r12 = *(u32*)((u8*)r31 + 0x10);
    r0 = 0x2;
    *(u32*)((u8*)r31 + 0x4) = r0;
    if ((u32)r12 == (u32)0x0) goto L_801311E8;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
    if ((u32)r3 != (u32)0x0) goto L_801311D0;
    r12 = *(u32*)((u8*)r31 + 0x14);
    r0 = 0x1;
    *(u32*)((u8*)r31 + 0x4) = r0;
    if ((u32)r12 == (u32)0x0) goto L_801311C8;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_801311C8: ;
...
void fn_80131268(void) {
    ...
    if ((u32)r3 == (u32)0x0) goto L_801312BC;
    r4 = (u32)&lbl_803635C0;
    r4 = (u32)&lbl_803635C0;
    r0 = *(u32*)((u8*)r4 + 0x0);
    if ((u32)r3 > (u32)r0) goto L_801312BC;
    /* subi r0, r3, 0x1 */;
    r3 = *(u32*)((u8*)r4 + 0xC);
    r0 = r0 * 0x34;
    r31 = r3 + r0;
    r0 = *(u32*)((u8*)r31 + 0x4);
    if ((s32)r0 == (s32)-0x1) goto L_801312BC;
    goto L_801312C0;
L_801312BC: ;
    r31 = 0x0;
L_801312C0: ;
    if ((u32)r31 == (u32)0x0) goto L_80131380;
    r0 = *(u32*)((u8*)r31 + 0x4);
    r30 = *(u32*)((u8*)r31 + 0x30);
    r29 = *(u32*)((u8*)r31 + 0x2C);
    if ((s32)r0 == (s32)0x0) goto L_8013131C;
    if ((s32)r0 == (s32)0x1) goto L_801312FC;
    r12 = *(u32*)((u8*)r31 + 0x14);
    if ((u32)r12 == (u32)0x0) goto L_801312FC;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_801312FC: ;
    r12 = *(u32*)((u8*)r31 + 0xC);
    if ((u32)r12 == (u32)0x0) goto L_80131314;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_80131314: ;
    ...
    *(u32*)((u8*)r31 + 0x4) = r0;
L_8013131C: ;
    if ((u32)r30 == (u32)0x0) goto L_8013132C;
    *(u32*)((u8*)r30 + 0x2C) = r29;
    goto L_80131338;
L_8013132C: ;
    r3 = (u32)&lbl_803635C0;
    ...
    *(u32*)((u8*)r3 + 0x10) = r29;
L_80131338: ;
    if ((u32)r29 == (u32)0x0) goto L_80131344;
    *(u32*)((u8*)r29 + 0x30) = r30;
L_80131344: ;
    r0 = 0x0;
    r3 = (u32)&lbl_803635C0;
    ...
    *(u32*)((u8*)r31 + 0x2C) = r0;
    r4 = *(u32*)((u8*)r3 + 0x8);
    if ((u32)r4 == (u32)0x0) goto L_8013136C;
    *(u32*)((u8*)r4 + 0x30) = r31;
L_8013136C: ;
    *(u32*)((u8*)r3 + 0x8) = r31;
    r3 = *(u16*)((u8*)r31 + 0x28);
...
void fn_8013139C(void) {
    ...
    if ((u32)r3 == (u32)0x0) goto L_801313E8;
    r5 = (u32)&lbl_803635C0;
    r5 = (u32)&lbl_803635C0;
    r0 = *(u32*)((u8*)r5 + 0x0);
    if ((u32)r3 > (u32)r0) goto L_801313E8;
    /* subi r0, r3, 0x1 */;
    r3 = *(u32*)((u8*)r5 + 0xC);
    r0 = r0 * 0x34;
    r31 = r3 + r0;
    r0 = *(u32*)((u8*)r31 + 0x4);
    if ((s32)r0 == (s32)-0x1) goto L_801313E8;
    goto L_801313EC;
L_801313E8: ;
    r31 = 0x0;
L_801313EC: ;
    if ((u32)r31 == (u32)0x0) goto L_80131414;
    r12 = *(u32*)((u8*)r31 + 0x8);
    if ((u32)r12 == (u32)0x0) goto L_8013140C;
    r3 = *(u32*)((u8*)r31 + 0x24);
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
L_8013140C: ;
...
void fn_80131428(void) {
    ...
    r25 = r4;
    r28 = *(u32*)((u8*)r30 + 0x8);
    if ((u32)r28 == (u32)0x0) goto L_80131504;
    r29 = r25 & 0xFFFF;
    r27 = *(u16*)((u8*)r28 + 0x0);
    r3 = r29;
    fn_800E3534();
    r0 = r3 & 0xFFFF;
    r31 = r3;
    if ((u32)r28 != (u32)0x0) goto L_80131478;
    r3 = 0x0;
    goto L_80131508;
L_80131478: ;
    fn_800E27B0();
    ...
    r26 = r3;
    *(u32*)((u8*)r30 + 0x8) = r4;
    if ((u32)r4 == (u32)0x0) goto L_80131498;
    r0 = 0x0;
    *(u32*)((u8*)r4 + 0x30) = r0;
L_80131498: ;
    r3 = r28;
    ...
    *(u16*)((u8*)r28 + 0x0) = r27;
    r6 = (u32)&lbl_803635C0;
    r3 = *(u32*)((u8*)r6 + 0x10);
    if ((u32)r3 == (u32)0x0) goto L_801314C4;
    *(u32*)((u8*)r3 + 0x30) = r28;
L_801314C4: ;
    r5 = *(u32*)((u8*)r6 + 0x10);
    r0 = 0x0;
