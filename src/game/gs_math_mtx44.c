/**
 * @file gs_math_mtx44.c
 * @brief GS render engine segment -- split from gs_render.c.
 *
 * XD source unit: game/pxdvs/GSAPI/GSmath/GSmtx44.cpp
 * Address range: 0x800E0678 - 0x800E06B8 (2 functions)
 *
 * Both anchors monotonic, sizes 0x20/0x20 EXACT, segment size 0x40 = XD TU size exactly (whole TU = these 2 functions in both games).
 *
