...
L_80024720:
    r3 = *(u32*)lbl_80478DE4;
    r3 = *(u32*)(r3 + r27);
    if (r3 == 0) goto L_80024740;
    fn_801902E0();
    tmp = r3 & 0xFF;
    if (tmp == 0) goto L_800249EC;
L_80024740:
    tmp = *(u32*)lbl_8047A370;
    if ((s32)tmp == 1) goto L_80024750;
    goto L_800248F0;
L_80024750:
    f1 = *(f32*)lbl_80478898;
    f0 = *(f32*)lbl_8047B8D8;
...
L_80024994:
    *(u8*)((u8*)r30 + 0x67) = tmp;
    r3 = *(u32*)lbl_80478DD8;
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (r29 >= tmp) goto L_80024A04;
    if (r29 <= 9) goto L_800249B4;
    r29 = 0x0;
L_800249B4:
    r3 = (u32)lbl_802E4F58;
    r5 = *(u32*)lbl_80478DE4;
...
L_80024AD8:
    r3 = *(u32*)lbl_80478DD8;
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (r30 < tmp) goto L_80024AB4;
    r30 = 0x0;
L_80024AEC:
    tmp = *(u32*)lbl_8047A370;
    if ((s32)tmp == 1) goto L_80024AFC;
    goto L_80024B24;
L_80024AFC:
    f1 = *(f32*)lbl_80478898;
    f0 = *(f32*)lbl_8047B8A8;
...
L_80024B2C:
    r3 = *(u32*)lbl_80478DD8;
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (r30 >= tmp) goto L_80024B84;
    tmp = *(u32*)lbl_80478DDC;
    r28 = r30 << 4;
    r3 = tmp + r28;
    tmp = *(u32*)((u8*)r3 + 0x4);
    if (tmp != 0x66) goto L_80024B74;
    r3 = 0x45d;
    fn_801902E0();
    tmp = r3 & 0xFF;
    if (tmp == 0) goto L_80024B74;
    r3 = 0xC5F0000;
    tmp = r3 + 0x1200;
    goto L_80024B80;
L_80024B74:
...
L_80024C50:
    r3 = *(u32*)lbl_80478DD8;
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (r30 < tmp) goto L_80024C2C;
    r30 = 0x0;
L_80024C64:
    r3 = *(u32*)lbl_80478DD8;
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (r30 >= tmp) goto L_80024CBC;
    tmp = *(u32*)lbl_80478DDC;
    r28 = r30 << 4;
    r3 = tmp + r28;
    tmp = *(u32*)((u8*)r3 + 0x4);
...
L_80024D24:
    ...
    *(u32*)(sp + 0x14) = tmp;
    ...
    f0 = f3 * f2 + f0;
    f0 = (f64)(s32)f0;
    if ((s32)r31 >= 0x40) goto L_80024D88;
    f0 = -f3;
    r31 = 0x40;
    *(f32*)lbl_8047A37C = f0;
    goto L_80024D9C;
...
L_800256AC:
    ...
    fn_80102620();
    tmp = r3 & 0xFF;
    if (tmp != 1) goto L_800256C8;
    r3 = 0xc3;
    fn_80102510();
L_800256C8:
    tmp = *(u32*)lbl_8047A384;
    if (tmp == 0) goto L_800256F4;
    r3 = *(u32*)lbl_8047A388;
    if (r3 == 0) goto L_800256E4;
    fn_800EF5A4();
L_800256E4:
    r3 = *(u32*)lbl_8047A38C;
    if (r3 == 0) goto L_800256F4;
    fn_800EF5A4();
L_800256F4:
    return;
}
...
L_800257A4:
    ...
    r30 = 0x1;
    r3 = *(u32*)(r3 + r31);
    if (r3 == 0) goto L_800257CC;
    fn_801902E0();
    tmp = r3 & 0xFF;
    if (tmp != 0) goto L_800257CC;
    r30 = 0x0;
L_800257CC:
    r3 = *(u32*)lbl_80478DDC;
    tmp = r31 + 0x8;
...
L_80025840:
    ...
    r4 = r6;
    ctr_fn = (void(*)(void))r5;
    if (r5 <= 0) goto L_80025878;
L_80025860:
    tmp = *(u32*)((u8*)r4 + 0x8);
    if (r3 == tmp) goto L_80025878;
    r4 = r4 + 0x10;
    r7 = r7 + 0x1;
    if (--ctr != 0) goto L_80025860;
L_80025878:
    if (r7 < r5) goto L_80025884;
    r7 = 0x0;
L_80025884:
    r31 = r7 << 4;
    r3 = r6 + r31;
...
L_80026198:
    ...
    *(u32*)lbl_8047A38C = r3;
    ...
    r30 = 0x1;
    fn_800D37CC();
    if ((s32)r3 != 0x32) goto L_8002620C;
    f1 = *(f32*)lbl_8047B914;
    fn_800C46B0();
    r30 = r3;
    if (r30 >= 1) goto L_8002620C;
    r30 = 0x1;
L_8002620C:
    r28 = 0x0;
    goto L_80026220;
...
L_80026220:
    ...
    r29 = 0xae;
    fn_800D37CC();
    if ((s32)r3 != 0x32) goto L_80026268;
    f1 = *(f32*)lbl_8047B918;
    fn_800C46B0();
    r29 = r3;
    if (r29 >= 1) goto L_80026268;
    r29 = 0x1;
L_80026268:
    r28 = 0x0;
    goto L_8002627C;
...
L_8002627C:
    ...
    *(u32*)(sp + 0x10) = tmp;
    ...
    fn_800C46B0();
    r29 = 0x78 - r3;
    if (r29 == 0) goto L_80026334;
    fn_800D37CC();
    if ((s32)r3 != 0x32) goto L_80026334;
    tmp = 0x43300000;
    f2 = *(f64*)lbl_8047B8D0;
    *(u32*)(sp + 0x10) = tmp;
    f0 = *(f32*)lbl_8047B900;
