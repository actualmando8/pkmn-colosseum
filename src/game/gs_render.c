    ...
    if ((s32)r0 != (s32)0x1) {
        ...
        *(u32*)((u8*)r3 + 0x414) = r0;
        while ((s32)r21 < (s32)r19) {
            ...
            r4 = 0x0;
            r6 = r3 + r6;
            if (((u32)r0 != (u32)0x0) && ((s32)r20 > (s32)0x0)) {
...
void GSmaterial_Create(void* params) {
    ...
    *(f64*)(sp + 0x50) = f31;
    ...
    do {
        ...
        *(u8*)((u8*)r23 + 0x0) = r0;
        ...
        while (1) {
            r4 = *(u8*)((u8*)r3 + 0x0);
            r0 = (s8)r4;
            if ((s32)r0 == (s32)0x39) break;
            r0 = (s8)r4;
            if ((s32)r0 < (s32)0x30 || (s32)r0 > (s32)0x39) break;
    ...
    L_800DEE58: ;
        ...
        r18 = r3;
        if ((s32)r3 <= (s32)0x0 || (s32)r19 <= (s32)r3) break;
...
do {
        ...
        if ((u32)r8 != (u32)r6) {
            ...
            do {
                ...
                r5 = *(u32*)((u8*)r11 + 0x8);
                r7 = *(u32*)((u8*)r28 + 0x8);
                if ((u32)r5 > (u32)r7) break;
                r0 = *(u32*)((u8*)r11 + 0x4);
                if ((u32)r0 <= (u32)r28) break;
                r0 = *(u16*)((u8*)r11 + 0xC);
                if ((u32)r0 != (u32)0x0) break;
                do {
                if ((s32)r29 >= (s32)0x4) break;

                r0 = r10 + r5;
                if ((u32)r0 > (u32)r7) break;
            ...
            if ((s32)r29 > (s32)0x0) {
                ...
                do {
                    ...
                    *(u32*)((u8*)r10 + 0x4) = r3;
                    ...
                    r3 = r3 + r10;
                    r0 = r0 - r10;
                    while ((u32)r12 != (u32)0x0 && (u32)r12 < (u32)r9) {
...
void fn_800D76A8(void) {
    ...
    do {
        r0 = *(u8*)((u8*)r25 + 0x8);
        if (((u32)r0 != (u32)0x0) && ((s32)r26 != (s32)0x0)) {
...
do {
    ...
    if ((u32)r0 != (u32)0x0) {
        ...
        switch ((s32)r0) {
            case 0:
                r0 = *(u32*)((u8*)r29 + 0x18);
                r30 = ((s32)r0 == (s32)0x2) ? 0x1 : 0x0;
                break;
            case 1:
                r0 = *(u32*)((u8*)r29 + 0x18);
                r30 = ((s32)r0 == (s32)0x2) ? 0x3 : 0x2;
                break;
            case 2:
                r0 = *(u32*)((u8*)r29 + 0x18);
                r30 = ((s32)r0 == (s32)0x2) ? 0x5 : 0x4;
                break;
            default:
                break;
        }
...
void fn_800D923C(void) {
    ...
    if ((s32)r23 != (s32)r0) {
        ...
        do {
            ...
            fn_800BC4C0();
            r0 = *(u8*)((u8*)r24 + 0x0);
            if ((u32)r0 != (u32)0x0 && (u32)r23 != (u32)0x0) {
...
void fn_800DA3B0(void) {
    ...
    if (*(s32*)state == 1) {
        fn_800D4F98(0x2D, 2, r3, (u32)(r4 & 0xFF));
        return;
    }
    if ((s32)r3 == 1) {
        state[0x418] = 1;
    ...
    fn_800BD008(*(u8*)((u8*)*(u32*)lbl_8047AA80 + 0x418));
}
...
void fn_800DA578(void) {
    ...
    while ((u32)r8 < (u32)r30) {
        ...
        r8 = r8 + 0x2;
        switch ((s32)r0) {
            case 0xb8: r31 = 0x0; break;
            case 0xa8: r31 = 0x1; break;
            case 0xb0: r31 = 0x2; break;
            case 0x90: r31 = 0x3; break;
            case 0x98: r31 = 0x4; break;
            case 0xa0: r31 = 0x5; break;
            case 0x80: r31 = 0x6; break;
            default:   r31 = 0x0; break;
        }
        r5 = r8;
        r3 = r31;
        r4 = r27;
...
void fn_800DA6F0(void) {
    ...
    do {
        r0 = *(u32*)((u8*)r6 + 0x0);
        if ((s32)r0 == (s32)0xff) break;
        if ((u32)r0 > (u32)0x19) break;
...
void fn_800DA880(void) {
    ...
    do {
        if ((s32)r10 == (s32)0xb || (s32)r10 == (s32)0xc) {
        ...
        if ((s32)r10 < (s32)0xd) {
            if ((s32)r10 != (s32)0xa) {
                if ((s32)r10 >= (s32)0xa) break;
                if ((s32)r10 < (s32)0x9) {
                    break;
                }
                if ((s32)r10 != (s32)0x19) {
                    if ((s32)r10 >= (s32)0x19 || (s32)r10 >= (s32)0x15) break;
        ...
        r4 = *(u32*)((u8*)r3 + 0x8);
        r7 = 0x8;
        if ((s32)r4 != (s32)0x1) break;
        r9 = (0x4000 << 16);
        break;
    L_800DAAA4: ;
    do {
        if ((u32)r9 > (u32)0x7) break;
        ...
        do {
            ...
            if ((s32)r9 != (s32)r3) {
                if ((s32)r9 < (s32)r3) {
                    r3 = (0x1000 << 16);
                    if ((s32)r9 == (s32)r3 || (s32)r9 >= (s32)r3) break;

                    r3 = (0x8000 << 16);
                    r3 = r3 + 0x1;
                    if ((s32)r9 >= (s32)r3) break;
                    goto L_800DAC4C;
                }
                r3 = (0x4000 << 16);
                if ((s32)r9 != (s32)r3) {
...
void fn_800DB890(void) {
    ...
    count = r3;
    *(u32*)lbl_8047AAD8 = count;
    fn_800E3534(count * 0x18);
    handle = (u16)r3;
    *(u16*)lbl_8047AAD0 = handle;
    if ((handle & 0xFFFF) == 0) {
        return;
    }
    fn_800E27B0(handle & 0xFFFF);
    *(u32*)lbl_8047AAD4 = r3;
    for (i = 0; i < *(u32*)lbl_8047AAD8; i++) {
        buf = (u8*)*(u32*)lbl_8047AAD4;
        *(u8*)(buf + i * 0x18) = 0;
    }
}
...
void fn_800DB9F0(void) {
    ...
    if (*(s32*)*(u32*)lbl_8047AA80 == 1) {
        fn_800D4F98(0x59, 3, r3, r4, r5);
        return;
    }
    buf = lbl_80400B28 + (r3 << 2) + 845;
    *(u8*)(buf + 0) = r4;
    *(u8*)(buf + 1) = r5;
}
...
void fn_800DC390(void) {
    ...
    fn_800EF4DC();
    do {
    if ((s32)r3 == (s32)0x90) break;

    if ((s32)r3 >= (s32)0x90) { r3 = 0x0; return; }
    if ((s32)r3 >= (s32)0x46) { r3 = 0x0; return; }
    if ((s32)r3 >= (s32)0x40) break;
...
void fn_800DC560(void) {
    ...
    r0 = (u32)lbl_80400EE0;
    r31 = r0;
    for (r30 = 0x0; (u32)r30 < (u32)0x4; r30 = r30 + 0x1, r31 = r31 + 0x14) {
        r0 = *(u8*)((u8*)r31 + 0x0);
        if ((u32)r0 == (u32)0x1) {
            r3 = *(u32*)((u8*)r31 + 0x4);
            r4 = 0x0;
            ...
            if ((u32)r12 != (u32)0x0) {
                ...
                if ((u32)r12 == (u32)0x0) {
                    ...
                    r0 = *(u8*)((u8*)r29 + 0x0);
                    if ((u32)r0 == (u32)0x1 && (u32)*(u32*)((u8*)r29 + 0x4) == (u32)r4) {
                        /* found in slot 0 */
                    } else if ((u32)*(u8*)((u8*)r29 + 0x14) == (u32)0x1 && (u32)*(u32*)((u8*)r29 + 0x4) == (u32)r4) {
                        /* found in slot 1 */
                    } else if ((u32)*(u8*)((u8*)r29 + 0x14) == (u32)0x1 && (u32)*(u32*)((u8*)r29 + 0x4) == (u32)r4) {
                        /* found in slot 2 */
                    } else if ((u32)*(u8*)((u8*)r29 + 0x14) == (u32)0x1 && (u32)*(u32*)((u8*)r29 + 0x4) == (u32)r4) {
...
void fn_800DC6D8(void) {
    ...
    r28 = r3;
    for (r30 = 0x0, r31 = 0x0; (u32)r30 < (u32)*(u32*)lbl_8047AAF0; r30 = r30 + 0x1, r31 = r31 + 0x74) {
        r0 = *(u32*)lbl_8047AAEC;
        r29 = r0 + r31;
        r0 = *(u8*)((u8*)r29 + 0x0);
...
void fn_800DF248(void) {
    ...
    if ((s32)r0 != (s32)0) {
        ...
        r3 = *(u32*)((u8*)r29 + 0x24);
        do {
        if ((u32)r4 == (u32)0x0 || (u32)r28 == (u32)0x0) break;
...
void fn_800DFABC(void) {
    ...
    L_800DFB44: ;
        ...
        *(u32*)((u8*)r29 + 0x8) = r3;
        r0 = *(u32*)((u8*)r29 + 0x8);
        do {
        if ((s32)r0 == (s32)0xe) break;

        if ((s32)r0 < (s32)0xe && (s32)r0 < (s32)0x7) {
        ...
        if ((s32)r0 != (s32)0x0) {
            ...
            r3 = *(u32*)((u8*)r28 + 0x24);
            do {
            if ((u32)r4 == (u32)0x0 || (u32)r30 == (u32)0x0) break;
