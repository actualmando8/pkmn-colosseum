...
void fn_800C4FA4(void) {
    ...
    if (r4 == 0) goto L_800C4FEC;
    r5 = *(u32*)((u8*)r4 + (-4));
    tmp = r5 & 0x1;
    if (r4 != 0) goto L_800C4FCC;
    r5 = *(u32*)((u8*)r5 + 0x8);
    goto L_800C4FD8;
L_800C4FCC:
    tmp = *(u32*)((u8*)r4 + (-8));
...
L_800C5020:
    ...
    r5 = r3 + r5;
    tmp = *(u32*)((u8*)r4 + 0xC);
    if (tmp != 0) goto L_800C50BC;
    r6 = *(u32*)((u8*)r5 + 0x4);
    if (r6 == r4) goto L_800C50BC;
    tmp = *(u32*)((u8*)r5 + 0x0);
    if (tmp != r4) goto L_800C507C;
    tmp = *(u32*)((u8*)r6 + 0x0);
    *(u32*)((u8*)r5 + 0x4) = tmp;
    r6 = *(u32*)((u8*)r5 + 0x0);
    tmp = *(u32*)((u8*)r6 + 0x0);
...
L_800C50BC:
    ...
    *(u32*)((u8*)r4 + 0xC) = r8;
    ...
    /* subic. tmp, r6, 0x1 */;
    *(u32*)((u8*)r4 + 0x10) = tmp;
    if (tmp != r4) goto L_800C5144;
    tmp = *(u32*)((u8*)r5 + 0x4);
    if (tmp != r4) goto L_800C50EC;
    tmp = *(u32*)((u8*)r4 + 0x4);
    *(u32*)((u8*)r5 + 0x4) = tmp;
L_800C50EC:
    tmp = *(u32*)((u8*)r5 + 0x0);
    if (tmp != r4) goto L_800C5100;
    tmp = *(u32*)((u8*)r4 + 0x0);
    *(u32*)((u8*)r5 + 0x0) = tmp;
L_800C5100:
    tmp = *(u32*)((u8*)r4 + 0x4);
    ...
    *(u32*)((u8*)r6 + 0x0) = tmp;
    tmp = *(u32*)((u8*)r5 + 0x4);
    if (tmp != r4) goto L_800C512C;
    tmp = 0x0;
    *(u32*)((u8*)r5 + 0x4) = tmp;
L_800C512C:
    tmp = *(u32*)((u8*)r5 + 0x0);
    if (tmp != r4) goto L_800C5140;
    tmp = 0x0;
    *(u32*)((u8*)r5 + 0x0) = tmp;
L_800C5140:
    fn_800C5154();
...
void fn_800C5154(void) {
    ...
    *(u32*)(r4 + tmp) = r8;
    ...
    r5 = *(u32*)((u8*)r9 + 0x0);
    r5 = r5 & 0x00000004;
    if (r5 != 0) goto L_800C526C;
    r8 = *(u32*)((u8*)r9 + (-4));
    r5 = r8 & 0x00000002;
    if (r5 == 0) goto L_800C51F0;
    r7 = r9;
    goto L_800C5270;
L_800C51F0:
    r7 = r9 - r8;
...
L_800C5270:
    ...
    *(u32*)((u8*)r9 + 0x0) = r5;
    r5 = *(u32*)((u8*)r9 + 0x0);
    r5 = r5 & 0x00000002;
    if (r5 != r9) goto L_800C52C4;
    *(u32*)(r9 + r5) = r7;
L_800C52C4:
    r5 = *(u32*)((u8*)r9 + 0x0);
    r5 = r5 & 0x00000002;
    if (r5 != r9) goto L_800C52E0;
    r5 = *(u32*)(r9 + r7);
    r5 = r5 & 0xFFFFFFFB;
    *(u32*)(r9 + r7) = r5;
    goto L_800C52EC;
...
L_800C52EC:
    r5 = *(u32*)(r4 + tmp);
    if (r5 != r8) goto L_800C5300;
    r5 = *(u32*)((u8*)r5 + 0xC);
    *(u32*)(r4 + tmp) = r5;
L_800C5300:
    r5 = *(u32*)(r4 + tmp);
    if (r5 != r8) goto L_800C5314;
    r5 = 0x0;
    *(u32*)(r4 + tmp) = r5;
L_800C5314:
    r6 = *(u32*)((u8*)r8 + 0x8);
...
L_800C533C:
    ...
    tmp = *(u32*)((u8*)r5 + 0x0);
    /* clrrwi tmp, tmp, 3 */;
    if (r6 >= tmp) goto L_800C5358;
    *(u32*)((u8*)r4 + 0x8) = tmp;
L_800C5358:
    r5 = *(u32*)((u8*)r4 + 0x10);
    r7 = 0x0;
    tmp = r5 & 0x00000002;
    if (r6 != tmp) goto L_800C5384;
    tmp = *(u32*)((u8*)r4 + 0xC);
    /* clrrwi r6, r5, 3 */;
    /* clrrwi r5, tmp, 3 */;
    if (r6 != tmp) goto L_800C5384;
    r7 = 0x1;
L_800C5384:
    if ((s32)r7 == 0) goto L_800C53D8;
    r5 = *(u32*)((u8*)r4 + 0x4);
    if (r5 != r4) goto L_800C539C;
    r5 = 0x0;
L_800C539C:
    tmp = *(u32*)((u8*)r3 + 0x0);
    if (tmp != r4) goto L_800C53AC;
    *(u32*)((u8*)r3 + 0x0) = r5;
L_800C53AC:
    if (r5 == 0) goto L_800C53C4;
    tmp = *(u32*)((u8*)r4 + 0x0);
    *(u32*)((u8*)r5 + 0x0) = tmp;
    r3 = *(u32*)((u8*)r5 + 0x0);
    *(u32*)((u8*)r3 + 0x4) = r5;
...
L_800C5410:
    tmp = *(u16*)((u8*)r30 + 0x4);
    /* extrwi. tmp, tmp, 3, 23 */;
    if ((s32)tmp == 0) goto L_800C5430;
    r3 = r30;
    fn_800C7904();
    if ((s32)r3 == 0) goto L_800C5430;
    r31 = -0x1;
L_800C5430:
    r30 = *(u32*)((u8*)r30 + 0x4C);
L_800C5434:
    if (r30 != 0) goto L_800C5410;
    r3 = r31;
    return;
}
