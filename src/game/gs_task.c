...
void fn_80008868(void) {
    ...
    *(u32*)(sp + 0x8) = r0;
    r26 = r4;
    if ((s32)r4 <= (s32)r24) goto L_800088B0;
    r26 = r24;
L_800088B0: ;
    r27 = r26 * 0xd;
    r4 = *(u32*)(sp + 0x8);
    ...
    r4 = 0x28;
    fn_8001EA98();
    /* lha r0, lbl_80478838@sda21(r0) */;
    if ((s32)r0 <= (s32)0x0) goto L_80008904;
    r3 = *(u32*)(sp + 0x8);
    r4 = 0x21;
    r6 = 0x21;
    r8 = 0x17;
...
L_80008904: ;
    r3 = *(u32*)lbl_80478F98;
    /* lha r4, lbl_80478838@sda21(r0) */;
    r0 = *(u32*)((u8*)r3 + 0x0);
    r0 = r0 - r4;
    if ((s32)r0 <= (s32)r24) goto L_80008948;
    r3 = *(u32*)(sp + 0x8);
    r4 = r27 + 0x2f;
    r6 = r4;
    r8 = r27 + 0x39;
...
L_80008968: ;
    r0 = *(s16*)((u8*)r28 + 0x2);
    if ((s32)r0 != (s32)r27) goto L_80008980;
    r3 = (0xff00 << 16);
    r24 = r3 + 0xff;
    goto L_80008984;
L_80008980: ;
...
L_80008984: ;
    /* lha r0, lbl_80478838@sda21(r0) */;
    r5 = r27 + r0;
    if ((s32)r5 >= (s32)0x0) goto L_8000899C;
    r0 = 0x0;
    goto L_80008AA8;
L_8000899C: ;
    r3 = *(u32*)lbl_80478F98;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r5 < (u32)r0) goto L_800089B4;
    r0 = 0x0;
    goto L_80008AA8;
L_800089B4: ;
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == (s32)0x0) goto L_80008AA4;
    /* subi r0, r5, 0x1 */;
    r3 = 0x0;
    if ((s32)r0 <= (s32)0x0) goto L_80008A90;
    /* subi r6, r5, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80008A60;
    r4 = *(u32*)lbl_80478F9C;
    r0 = r6 + 0x7;
    r0 = (u32)r0 >> 3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r6 <= (s32)0x0) goto L_80008A60;
L_800089F4: ;
    r0 = (s16)r7;
    r3 = r3 + 0x8;
    r6 = r0 << 3;
    ...
    r0 = r6 + 0x6;
    r7 = *(s16*)(r4 + r0);
    if (--ctr != 0) goto L_800089F4;
L_80008A60: ;
    r6 = *(u32*)lbl_80478F9C;
    /* subi r4, r5, 0x1 */;
    r0 = r4 - r3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r3 >= (s32)r4) goto L_80008A90;
L_80008A78: ;
    r0 = (s16)r7;
    r3 = r3 + 0x1;
    r4 = r0 << 3;
...
L_80008AA8: ;
    ...
    /* lha r0, lbl_80478838@sda21(r0) */;
    r4 = r27 + r0;
    if ((s32)r4 >= (s32)0x0) goto L_80008AEC;
    r0 = 0x0;
    goto L_80008BF8;
L_80008AEC: ;
    r3 = *(u32*)lbl_80478F98;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r4 < (u32)r0) goto L_80008B04;
    r0 = 0x0;
    goto L_80008BF8;
L_80008B04: ;
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r4 == (s32)0x0) goto L_80008BF4;
    /* subi r0, r4, 0x1 */;
    r3 = 0x0;
    if ((s32)r0 <= (s32)0x0) goto L_80008BE0;
    /* subi r6, r4, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80008BB0;
    r5 = *(u32*)lbl_80478F9C;
    r0 = r6 + 0x7;
    r0 = (u32)r0 >> 3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r6 <= (s32)0x0) goto L_80008BB0;
L_80008B44: ;
    r0 = (s16)r7;
    r3 = r3 + 0x8;
    r6 = r0 << 3;
    ...
    r0 = r6 + 0x6;
    r7 = *(s16*)(r5 + r0);
    if (--ctr != 0) goto L_80008B44;
L_80008BB0: ;
    r5 = *(u32*)lbl_80478F9C;
    /* subi r4, r4, 0x1 */;
    r0 = r4 - r3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r3 >= (s32)r4) goto L_80008BE0;
L_80008BC8: ;
    r0 = (s16)r7;
    r3 = r3 + 0x1;
    r4 = r0 << 3;
...
void fn_80008C40(void) {
    ...
    r29 = r3 & 0xFF;
    r0 = (s16)r29;
    if ((s32)r30 >= (s32)r0) goto L_80008C8C;
    r29 = r30;
L_80008C8C: ;
    r4 = r27 & 0xFFFF;
    r3 = *(u32*)lbl_80478838;
    r0 = r4 & 0x1;
    if ((s32)r0 == (s32)0x0) goto L_80008CB4;
    r3 = *(s16*)((u8*)r1 + 0xA);
    /* subi r0, r3, 0x1 */;
    *(u16*)(sp + 0xA) = r0;
    goto L_80008CCC;
L_80008CB4: ;
    r0 = r4 & 0x00000002;
    if ((s32)r0 == (s32)0x0) goto L_80008CCC;
    r3 = *(s16*)((u8*)r1 + 0xA);
    r0 = r3 + 0x1;
    *(u16*)(sp + 0xA) = r0;
L_80008CCC: ;
    r0 = r4 & 0x00000004;
    if ((s32)r0 == (s32)0x0) goto L_80008CFC;
    r3 = *(u32*)((u8*)r28 + 0x4);
    fn_8005D9E4();
    r3 = r3 & 0xFF;
    r0 = *(s16*)((u8*)r1 + 0xA);
...
L_80008CFC: ;
    r0 = r4 & 0x00000008;
    if ((s32)r0 == (s32)0x0) goto L_80008D28;
    r3 = *(u32*)((u8*)r28 + 0x4);
    fn_8005D9E4();
    r0 = *(s16*)((u8*)r1 + 0xA);
    r3 = r3 & 0xFF;
...
L_80008D28: ;
    r4 = *(s16*)((u8*)r1 + 0xA);
    if ((s32)r4 >= (s32)0x0) goto L_80008D74;
    r3 = *(s16*)((u8*)r1 + 0x8);
    r0 = 0x0;
    *(u16*)(sp + 0xA) = r0;
    r3 = r3 + r4;
    r0 = (s16)r3;
    *(u16*)(sp + 0x8) = r3;
    if ((s32)r0 >= (s32)0x0) goto L_80008DB8;
    r4 = (s16)r29;
    /* subi r3, r4, 0x1 */;
    r0 = r30 - r4;
    r3 = (s16)r3;
...
L_80008D74: ;
    ...
    *(u16*)(sp + 0xA) = r0;
    r0 = r3 + r0;
    *(u16*)(sp + 0x8) = r3;
    if ((s32)r0 < (s32)r30) goto L_80008DB8;
    r0 = 0x0;
    *(u16*)(sp + 0x8) = r0;
    *(u16*)(sp + 0xA) = r0;
L_80008DB8: ;
    r3 = r31 & 0xFFFF;
    r0 = r3 & 0x00000080;
    if ((s32)r0 == (s32)0x0) goto L_80008EF8;
    r3 = *(s16*)((u8*)r1 + 0x8);
    r0 = *(s16*)((u8*)r1 + 0xA);
    r5 = r3 + r0;
    if ((s32)r5 >= (s32)0x0) goto L_80008DE4;
    r0 = 0x0;
    goto L_80008EEC;
L_80008DE4: ;
    r3 = *(u32*)lbl_80478F98;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r5 < (u32)r0) goto L_80008DFC;
    r0 = 0x0;
    goto L_80008EEC;
L_80008DFC: ;
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == (s32)0x0) goto L_80008EE8;
    /* subi r0, r5, 0x1 */;
    r4 = 0x0;
    if ((s32)r0 <= (s32)0x0) goto L_80008ED4;
    /* subi r3, r5, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80008EA8;
    r6 = *(u32*)lbl_80478F9C;
    r0 = r3 + 0x7;
    r0 = (u32)r0 >> 3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r3 <= (s32)0x0) goto L_80008EA8;
L_80008E3C: ;
    r0 = (s16)r7;
    r4 = r4 + 0x8;
    r3 = r0 << 3;
    ...
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_80008E3C;
L_80008EA8: ;
    r6 = *(u32*)lbl_80478F9C;
    /* subi r3, r5, 0x1 */;
    r0 = r3 - r4;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r4 >= (s32)r3) goto L_80008ED4;
L_80008EC0: ;
    r0 = (s16)r7;
    r3 = r0 << 3;
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_80008EC0;
L_80008ED4: ;
    r0 = (s16)r7;
    r3 = *(u32*)lbl_80478F9C;
    r0 = r0 << 3;
...
L_80008EF8: ;
    r0 = r3 & 0x00000040;
    if ((s32)r0 == (s32)0x0) goto L_80009030;
    r3 = *(s16*)((u8*)r1 + 0x8);
    r0 = *(s16*)((u8*)r1 + 0xA);
    r5 = r3 + r0;
    if ((s32)r5 >= (s32)0x0) goto L_80008F20;
    r0 = 0x0;
    goto L_80009028;
L_80008F20: ;
    r3 = *(u32*)lbl_80478F98;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r5 < (u32)r0) goto L_80008F38;
    r0 = 0x0;
    goto L_80009028;
L_80008F38: ;
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == (s32)0x0) goto L_80009024;
    /* subi r0, r5, 0x1 */;
    r4 = 0x0;
    if ((s32)r0 <= (s32)0x0) goto L_80009010;
    /* subi r3, r5, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80008FE4;
    r6 = *(u32*)lbl_80478F9C;
    r0 = r3 + 0x7;
    r0 = (u32)r0 >> 3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r3 <= (s32)0x0) goto L_80008FE4;
L_80008F78: ;
    r0 = (s16)r7;
    r4 = r4 + 0x8;
    r3 = r0 << 3;
    ...
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_80008F78;
L_80008FE4: ;
    r6 = *(u32*)lbl_80478F9C;
    /* subi r3, r5, 0x1 */;
    r0 = r3 - r4;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r4 >= (s32)r3) goto L_80009010;
L_80008FFC: ;
    r0 = (s16)r7;
    r3 = r0 << 3;
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_80008FFC;
L_80009010: ;
    r0 = (s16)r7;
    r3 = *(u32*)lbl_80478F9C;
    r0 = r0 << 3;
...
L_80009030: ;
    ...
    r5 = r3 + r0;
    *(u32*)lbl_80478838 = r4;
    if ((s32)r5 >= (s32)0x0) goto L_80009054;
    r0 = 0x0;
    goto L_8000915C;
L_80009054: ;
    r3 = *(u32*)lbl_80478F98;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r5 < (u32)r0) goto L_8000906C;
    r0 = 0x0;
    goto L_8000915C;
L_8000906C: ;
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == (s32)0x0) goto L_80009158;
    /* subi r0, r5, 0x1 */;
    r4 = 0x0;
    if ((s32)r0 <= (s32)0x0) goto L_80009144;
    /* subi r3, r5, 0x9 */;
    if ((s32)r0 <= (s32)0x8) goto L_80009118;
    r6 = *(u32*)lbl_80478F9C;
    r0 = r3 + 0x7;
    r0 = (u32)r0 >> 3;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r3 <= (s32)0x0) goto L_80009118;
L_800090AC: ;
    r0 = (s16)r7;
    r4 = r4 + 0x8;
    r3 = r0 << 3;
    ...
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_800090AC;
L_80009118: ;
    r6 = *(u32*)lbl_80478F9C;
    /* subi r3, r5, 0x1 */;
    r0 = r3 - r4;
    ctr_fn = (void(*)(void))r0;
    if ((s32)r4 >= (s32)r3) goto L_80009144;
L_80009130: ;
    r0 = (s16)r7;
    r3 = r0 << 3;
    r0 = r3 + 0x6;
    r7 = *(s16*)(r6 + r0);
    if (--ctr != 0) goto L_80009130;
L_80009144: ;
    r0 = (s16)r7;
    r3 = *(u32*)lbl_80478F9C;
    r0 = r0 << 3;
