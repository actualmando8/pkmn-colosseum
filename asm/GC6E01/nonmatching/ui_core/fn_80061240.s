...
slwi r6, r6, 2
lfs f0, lbl_8047BFA8@sda21(r0)
addi r0, r4, lbl_803A9A60@l
lbz r26, 0x8b(r3)
add r3, r0, r5
addi r0, r3, 0x58
add r3, r0, r6
...
stw r3, 0x8(r1)
subf r4, r5, r4
lfd f2, lbl_8047BF80@sda21(r0)
xoris r4, r4, 0x8000
stw r0, 0x14(r1)
lfs f3, lbl_8047891C@sda21(r0)
stw r4, 0xc(r1)
lha r4, lbl_8047891A@sda21(r0)
stw r3, 0x10(r1)
lfd f1, 0x8(r1)
