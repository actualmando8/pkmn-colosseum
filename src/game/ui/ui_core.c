    ...
    *(f64*)(sp + 0x1F0) = f29;
    ...
    while (1) {
        ...
        *(u32*)(sp + 0x28) = r0;
        ...
        ((void(*)(void))fn_80071344)();
        do {
            if ((s32)r3 == (s32)0x1 || (s32)r3 >= (s32)0x1) break;
        ...
        *(u32*)(sp + 0x48) = r0;
        ...
        r26 = 0xd1;
        do {
            if ((s32)r3 == (s32)0x3 || (s32)r3 >= (s32)0x3 || (s32)r3 == (s32)-0x1) break;
        ...
        r0 = *(u32*)((u8*)r3 + 0x0);
        do {
            if ((s32)r0 == (s32)0x1 || (s32)r0 >= (s32)0x1) break;
...
void fn_80065A48(void) {
    ...
    fn_8025DA88();
    do {
        if ((s32)r3 == (s32)0x2 || (s32)r3 >= (s32)0x2) break;
...
#if 1
asm void fn_80069048(void) {
#include "src/game/ui/ui_core_fn_80069048.inc"
}
#else
void fn_80069048(void) {
}
