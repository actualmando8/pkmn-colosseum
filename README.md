...
|---|---|
| Fuzzy match | 32.85% |
| Function match | 46.10% (3,966 / 8,603 functions) |
| Code match | 17.05% (425,376 / 2,495,108 matched code bytes) |
| Data match | 97.27% (2,136,269 / 2,196,124 matched data bytes) |
| Linked into DOL | 92 / 627 units (0.53% of code) |
