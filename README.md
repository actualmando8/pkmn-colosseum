...
|---|---|
| Fuzzy match | 57.47% |
| Function match | 72.94% (6,275 / 8,603 functions) |
| Code match | 35.65% (889,532 / 2,495,108 matched code bytes) |
| Data match | 97.29% (2,136,497 / 2,196,100 matched data bytes) |
| Linked into DOL | 698 / 1,301 units (22.99% of code) |
