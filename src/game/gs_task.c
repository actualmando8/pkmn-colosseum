...
L_80008904:
    ...
    tmp = *(u32*)((u8*)r3 + 0x0);
    tmp = tmp - r4;
    if ((s32)tmp <= (s32)r24) goto L_80008948;
    r4 = r27 + 0x2f;
    r6 = r4;
    r8 = r27 + 0x39;
    tmp = (u32)r3 >> 31;
...
L_80008968:
    tmp = *(s16*)((u8*)r28 + 0x2);
    if ((s32)tmp != (s32)r27) goto L_80008980;
    r3 = 0xFF000000;
    r24 = r3 + 0xff;
    goto L_80008984;
L_80008980:
...
L_800089B4:
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == 0) goto L_80008AA4;
    r3 = 0x0;
    if ((s32)tmp <= 0) goto L_80008A90;
    if ((s32)tmp <= 8) goto L_80008A60;
    r4 = *(u32*)lbl_80478F9C;
    tmp = r6 + 0x7;
    tmp = (u32)tmp >> 3;
    ctr_fn = (void(*)(void))tmp;
    if ((s32)r6 <= 0) goto L_80008A60;
L_800089F4:
    tmp = (s16)r7;
    r3 = r3 + 0x8;
    r6 = tmp << 3;
...
L_80008B04:
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r4 == 0) goto L_80008BF4;
    r3 = 0x0;
    if ((s32)tmp <= 0) goto L_80008BE0;
    if ((s32)tmp <= 8) goto L_80008BB0;
    r5 = *(u32*)lbl_80478F9C;
    tmp = r6 + 0x7;
    tmp = (u32)tmp >> 3;
    ctr_fn = (void(*)(void))tmp;
    if ((s32)r6 <= 0) goto L_80008BB0;
L_80008B44:
    tmp = (s16)r7;
    r3 = r3 + 0x8;
    r6 = tmp << 3;
...
void fn_80008C40(void) {
    ...
    r29 = r3 & 0xFF;
    tmp = (s16)r29;
    if ((s32)r30 >= (s32)tmp) goto L_80008C8C;
    r29 = r30;
L_80008C8C:
    r4 = r27 & 0xFFFF;
    r3 = *(u32*)lbl_80478838;
...
L_80008DFC:
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == 0) goto L_80008EE8;
    r4 = 0x0;
    if ((s32)tmp <= 0) goto L_80008ED4;
    if ((s32)tmp <= 8) goto L_80008EA8;
    r6 = *(u32*)lbl_80478F9C;
    tmp = r3 + 0x7;
    tmp = (u32)tmp >> 3;
    ctr_fn = (void(*)(void))tmp;
    if ((s32)r3 <= 0) goto L_80008EA8;
L_80008E3C:
    tmp = (s16)r7;
    r4 = r4 + 0x8;
    r3 = tmp << 3;
...
L_80008F38:
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == 0) goto L_80009024;
    r4 = 0x0;
    if ((s32)tmp <= 0) goto L_80009010;
    if ((s32)tmp <= 8) goto L_80008FE4;
    r6 = *(u32*)lbl_80478F9C;
    tmp = r3 + 0x7;
    tmp = (u32)tmp >> 3;
    ctr_fn = (void(*)(void))tmp;
    if ((s32)r3 <= 0) goto L_80008FE4;
L_80008F78:
    tmp = (s16)r7;
    r4 = r4 + 0x8;
    r3 = tmp << 3;
...
L_8000906C:
    r7 = *(s16*)((u8*)r3 + 0x4);
    if ((s32)r5 == 0) goto L_80009158;
    r4 = 0x0;
    if ((s32)tmp <= 0) goto L_80009144;
    if ((s32)tmp <= 8) goto L_80009118;
    r6 = *(u32*)lbl_80478F9C;
    tmp = r3 + 0x7;
    tmp = (u32)tmp >> 3;
    ctr_fn = (void(*)(void))tmp;
    if ((s32)r3 <= 0) goto L_80009118;
L_800090AC:
    tmp = (s16)r7;
    r4 = r4 + 0x8;
    r3 = tmp << 3;
