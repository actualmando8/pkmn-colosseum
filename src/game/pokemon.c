...
void fn_801F02AC(void) {
    ...
    while (1) {
        ...
        *(u32*)(r26 + r28) = r3;
        r0 = r22 & 0xFFFF;
        if (((u32)r30 == (u32)0x4) && ((u32)r0 == (u32)0x0)) {
...
void fn_801F11CC(void) {
    ...
    fn_8020D814();
    r0 = r27 & 0xFFFF;
    if ((u32)r28 != (u32)r0 || (s32)r25 != (s32)r3) {
...
void fn_801F1700(void) {
    ...
    r31 = r3 & 0xFF;
    fn_80077B84();
    if (((u32)r31 == (u32)0x1) && ((s32)r3 > (s32)0x0)) {
...
void fn_801F1888(void) {
    ...
    fn_801F54A4();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0xa) { r3 = 0x1; return; }
    if ((u32)r0 == (u32)0x11) { r3 = 0x1; return; }
    if ((u32)r0 != (u32)0xb) { r3 = 0x0; return; }
...
void fn_801F1DBC(void) {
    ...
    r24 = r3;
    if ((u32)r0 != (u32)0x2) {
        if ((u32)r0 != (u32)0x3) { r3 = 0x0; return; }
    }
    r3 = r24;
    r4 = 0x0;
    r5 = 0x14;
...
L_801F2738:
    ...
    if ((s32)r0 != (s32)0x1 && (s32)r0 != (s32)0x2 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0) goto L_801F2768;
    ...
    L_801F2768: ;
    if ((s32)r0 == (s32)0x0) {
        if ((u32)r30 == (u32)0x0 || (u32)r30 != (u32)r31) goto L_801F27B0;
...
void fn_801F32EC(void) {
    ...
    *(u16*)(sp + 0x8) = r0;
    ...
    while (1) {
        ...
        fn_802062FC();
        r0 = r3 & 0xFF;
        if ((u32)r3 != (u32)0x0 || (u32)r28 == (u32)0x0) break;
...
L_801F356C:
    ...
    if ((s32)r0 != (s32)0x1 && (s32)r0 != (s32)0x2 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0) goto L_801F359C;
    ...
    L_801F359C: ;
    if ((s32)r0 == (s32)0x0) {
        if ((u32)r30 == (u32)0x0 || (u32)r30 != (u32)r31) goto L_801F35E4;
...
L_801F36F8:
    ...
    if ((s32)r0 != (s32)0x1 && (s32)r0 != (s32)0x2 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0 || (u32)r29 != (u32)0x0) goto L_801F3728;
    ...
    L_801F3728: ;
    if ((s32)r0 == (s32)0x0) {
        if ((u32)r30 == (u32)0x0 || (u32)r30 != (u32)r31) goto L_801F3770;
...
void fn_801F3984(void) {
    ...
    if ((u32)r0 == (u32)0x0 || (u32)r0 == (u32)0x1) {
    ...
    if ((u32)r3 == (u32)0x0) {
        if ((u32)r4 == (u32)0x3) { r3 = 0x0; return; }
        if ((u32)r4 == (u32)0x5) {
    ...
    if ((u32)r4 == (u32)0x7) { r3 = 0x0; return; }
    if ((u32)r4 == (u32)0x6) {

        r3 = 0x0;
        return;
    }
    if (((u32)r4 == (u32)0x3) && ((u32)r0 == (u32)0x2)) {
    ...
    while (1) {
        ...
        if ((s32)r3 != (s32)0x1) {
            ...
            if ((s32)r3 != (s32)0x1) {
                ...
                r5 = 0x45;
                fn_801FB1C0();
                if ((u32)r3 != (u32)0x0 && (u32)r23 == (u32)r3) {
    ...
    while (1) {
        ...
        if ((s32)r0 != (s32)0) {
            ...
            if ((s32)r0 != (s32)0) {
                ...
                r5 = 0x45;
                fn_801FB1C0();
                if ((u32)r3 != (u32)0x0 && (u32)r31 == (u32)r3) {
            ...
            while (1) {
                ...
                if ((s32)r0 != (s32)0) {
                    ...
                    while (1) {
                        ...
                        r5 = 0x45;
                        fn_801FB1C0();
                        if (((u32)r3 != (u32)0x0) && ((u32)r26 == (u32)r3)) {
...
void fn_801F4C14(void) {
    ...
    if ((u32)r0 >= (u32)0x5f || (u32)r29 != (u32)0x0) goto L_801F4CAC;
    ...
    L_801F4CAC: ;
    r0 = r26 & 0xFFFF;
    if ((u32)r0 > (u32)0x5e) { r3 = r31 & 0xFF; return; }
    ...
    r0 = r3 & 0xFF;
    r31 = r3;
    if ((u32)r0 != (u32)0x2) { r3 = r31 & 0xFF; return; }
    r3 = r30 & 0xFFFF;
    fn_80119ED0();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 != (u32)0x9) { r3 = r31 & 0xFF; return; }
    r3 = r29;
    r4 = r30 & 0xFFFF;
    r5 = r27 & 0xFFFF;
    fn_8011B2C0();
...
void fn_801F61EC(void) {
    ...
    while (1) {
        ...
        do {
        if ((u32)r25 == (u32)0x0) break;
        r0 = r30 & 0xFF;
        if ((u32)r0 == (u32)0x1) {
            if ((u32)r24 != (u32)r25) break;
            goto L_801F631C;
        }
...
void fn_801F7954(void) {
    ...
    while (1) {
        ...
        while (1) {
            ...
            r6 = 0x0;
            fn_8012640C();
            if ((u32)r3 == (u32)0x0 || (u32)r27 != (u32)r3) goto L_801F7AB4;
