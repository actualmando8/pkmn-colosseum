/**
 * @file table_res_bios.c
 * @brief game/pxdvs/app/tableRes/tableResBios.cpp -- split from colosseum_battle.c (the
 *        Colosseum battle-flow/AI bucket, 0x802405C0-0x80265EC4),
 *        address range 0x8025DBD4-0x8025DC2C, 1 fns.
 *
 * XD source unit: game/pxdvs/app/tableRes/tableResBios.cpp
