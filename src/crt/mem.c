...
void fn_800C8174(void) {
    ...
    tmp = r31 << tmp;
    r7 = (u32)tmp >> 31;
    if (r5 < 0x20) goto L_800C81DC;
    tmp = r6 & 0x3;
    if (r5 == 0x20) goto L_800C81C0;
    if ((s32)r7 != 0) goto L_800C81B8;
    fn_800C82EC();
    goto L_800C81D4;
L_800C81B8:
    fn_800C8240();
...
void fn_800C8240(void) {
    ...
    r10 = r4 + r5;
    r3 = r11 & 0x3;
    if ((s32)tmp == 0) goto L_800C8264;
    r5 = r5 - r3;
L_800C8254:
    tmp = *(u8*)((u8*)r10 + (-1));
    /* subic. r3, r3, 0x1 */;
    r11 += -1; *(u8*)r11 = tmp;
    if ((s32)tmp != 0) goto L_800C8254;
L_800C8264:
    r7 = r10 & 0x3;
    r9 = 0x20 - r8;
    r6 = (u32)r5 >> 3;
...
L_800C8280:
    ...
    *(u32*)((u8*)r11 + (-4)) = r3;
    ...
    tmp = r3 | tmp;
    r11 += -8; *(u32*)r11 = tmp;
    if ((s32)tmp != 0) goto L_800C8280;
    tmp = r5 & 0x00000004;
    if ((s32)tmp == 0) goto L_800C82CC;
    r3 = *(u32*)((u8*)r10 + (-4));
    tmp = (u32)r4 >> r9;
    r3 = r3 << r8;
    tmp = r3 | tmp;
...
void fn_800C82EC(void) {
    ...
    tmp = -r3;
    r6 = tmp & 0x3;
    if ((s32)tmp == 0) goto L_800C8314;
    r5 = r5 - r6;
L_800C8304:
    tmp = *(u8*)((u8*)r8 + 0x1);
    /* subic. r6, r6, 0x1 */;
    r3 += 1; *(u8*)r3 = tmp;
    if ((s32)tmp != 0) goto L_800C8304;
L_800C8314:
    tmp = r8 + 0x1;
    r9 = tmp & 0x3;
    r7 = (u32)r5 >> 3;
...
L_800C8334:
    ...
    *(u32*)((u8*)r6 + 0x4) = tmp;
    ...
    tmp = r3 | tmp;
    r6 += 8; *(u32*)r6 = tmp;
    if ((s32)tmp != 0) goto L_800C8334;
    tmp = r5 & 0x00000004;
    if ((s32)tmp == 0) goto L_800C8380;
    tmp = *(u32*)((u8*)r8 + 0x4);
    r3 = r4 << r10;
    tmp = (u32)tmp >> r11;
    tmp = r3 | tmp;
...
void fn_800C83AC(void) {
    ...
    r6 = r4 + r5;
    r3 = r7 & 0x3;
    if ((s32)tmp == 0) goto L_800C83D0;
    r5 = r5 - r3;
L_800C83C0:
    tmp = *(u8*)((u8*)r6 + (-1));
    /* subic. r3, r3, 0x1 */;
    r7 += -1; *(u8*)r7 = tmp;
    if ((s32)tmp != 0) goto L_800C83C0;
L_800C83D0:
    /* srwi. r4, r5, 5 */;
    if ((s32)tmp == 0) goto L_800C8420;
L_800C83D8:
    r3 = *(u32*)((u8*)r6 + (-4));
    /* subic. r4, r4, 0x1 */;
    tmp = *(u32*)((u8*)r6 + (-8));
    ...
    *(u32*)((u8*)r7 + (-28)) = r3;
    r7 += -32; *(u32*)r7 = tmp;
    if ((s32)tmp != 0) goto L_800C83D8;
L_800C8420:
    /* extrwi. r3, r5, 3, 27 */;
    if ((s32)tmp == 0) goto L_800C8438;
L_800C8428:
    tmp = *(u32*)((u8*)r6 + (-4));
    /* subic. r3, r3, 0x1 */;
    r7 += -4; *(u32*)r7 = tmp;
    if ((s32)tmp != 0) goto L_800C8428;
L_800C8438:
    r5 = r5 & 0x3;
    if ((s32)tmp == (s32)0) return;
L_800C8440:
...
void fn_800C8454(void) {
    ...
    tmp = -r3;
    r6 = tmp & 0x3;
    if ((s32)tmp == 0) goto L_800C847C;
    r5 = r5 - r6;
L_800C846C:
    tmp = *(u8*)((u8*)r4 + 0x1);
    /* subic. r6, r6, 0x1 */;
    r3 += 1; *(u8*)r3 = tmp;
    if ((s32)tmp != 0) goto L_800C846C;
L_800C847C:
    /* srwi. r6, r5, 5 */;
    if ((s32)tmp == 0) goto L_800C84D4;
L_800C848C:
    r3 = *(u32*)((u8*)r7 + 0x4);
    /* subic. r6, r6, 0x1 */;
    tmp = *(u32*)((u8*)r7 + 0x8);
    ...
    *(u32*)((u8*)r4 + 0x1C) = r3;
    r4 += 32; *(u32*)r4 = tmp;
    if ((s32)tmp != 0) goto L_800C848C;
L_800C84D4:
    /* extrwi. r3, r5, 3, 27 */;
    if ((s32)tmp == 0) goto L_800C84EC;
L_800C84DC:
    tmp = *(u32*)((u8*)r7 + 0x4);
    /* subic. r3, r3, 0x1 */;
    r4 += 4; *(u32*)r4 = tmp;
    if ((s32)tmp != 0) goto L_800C84DC;
L_800C84EC:
    r5 = r5 & 0x3;
    r6 = r7 + 0x3;
    r3 = r4 + 0x3;
