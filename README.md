...
| Metric | Value |
|---|---|
| Function match | ~60.8% (4,087 / 6,725 functions) |
| Code match | ~38.0% (510,116 / 1,343,512 matched code bytes) |

Last measured 2026-06-20 with `python tools/gen_decomp_report.py -o report.json`
