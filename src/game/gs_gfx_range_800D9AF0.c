 ...
 * Address range: 0x800D9AF0 - 0x800DA578 (18 functions)
 *
 * Zero anchors. 18 small/medium fns (0x34-0x144) totaling 0xA88 between the layerState-shaped block and dl.cpp; 0x144 fn ~ XD GSgfxTokenIfClearedReset 0x140. Insufficient to name; honest range file.
 *
