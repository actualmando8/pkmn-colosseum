...
L_801EF164:
    ...
    *(u8*)((u8*)r27 + 0xE) = r28;
    r28 = r28 + 0x1;
    if ((s32)r28 < 0x61) goto L_801EF164;
    return;
}
...
L_801EF664:
    tmp = (s8)r29;
    if ((s32)tmp < 0) goto L_801EF688;
    r3 = (u32)lbl_803752A0;
    tmp = (u32)lbl_803752A0;
    r3 = tmp + r4;
    tmp = *(u16*)((u8*)r3 + 0x2);
    if ((s32)r31 != (s32)tmp) goto L_801EF6D4;
L_801EF688:
    r4 = (u32)lbl_803752A0;
    r3 = (u32)lbl_803727C8;
    r4 = (u32)lbl_803752A0;
...
L_801EF6D4:
    r30 = r30 + 0x2;
L_801EF6D8:
    tmp = *(u16*)lbl_80478D10;
    r3 = r30 & 0xFFFF;
    if (r3 < tmp) goto L_801EF664;
    return;
}
...
L_801EF840:
    ...
    fn_801F7258();
    /* mr. r25, r3 */;
    if ((s32)tmp == 0) goto L_801EF8C0;
    r4 = 0x0;
    r5 = 0x4c;
    r6 = 0x0;
    fn_801FB1C0();
    if (r3 == 0) goto L_801EF8C0;
    r4 = r24;
    fn_801DA4E8();
    r29 = 0x0;
    goto L_801EF8B4;
...
L_801EF8B4:
    tmp = r29 & 0xFFFF;
    if (tmp < r26) goto L_801EF87C;
L_801EF8C0:
    r30 = r30 + 0x1;
L_801EF8C4:
    tmp = r30 & 0xFFFF;
    if (tmp < r27) goto L_801EF840;
L_801EF8D0:
    r28 = r28 + 0x1;
L_801EF8D4:
    tmp = r28 & 0xFFFF;
    if (tmp < 2) goto L_801EF824;
    return;
}
...
L_801EF9CC:
    tmp = r31 & 0xFF;
    if (tmp < 4) goto L_801EF9A4;
L_801EF9D8:
    tmp = r31 & 0xFF;
    if (tmp >= 4) goto L_801EF9EC;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EF9EC:
    r3 = r30;
...
L_801EFAFC:
    tmp = r29 & 0xFF;
    if (tmp < 4) goto L_801EFAD4;
L_801EFB08:
    tmp = r29 & 0xFF;
    if (tmp >= 4) goto L_801EFB1C;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EFB1C:
    r3 = r28;
    ...
    fn_801EF634();
    tmp = r3 & 0xFFFF;
    if (tmp != 4) goto L_801EFE5C;
    ((void(*)(void))fn_801C2D54)();
    ((void(*)(void))fn_801C2D68)();
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if (r3 == 0) goto L_801EFB54;
    r4 = 0x7B0000;
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFB54:
...
L_801EFCA0:
    tmp = r26 & 0xFF;
    if (tmp < 4) goto L_801EFC78;
L_801EFCAC:
    tmp = r26 & 0xFF;
    if (tmp >= 4) goto L_801EFCC0;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EFCC0:
    r3 = r27;
    ...
    fn_801EF634();
    tmp = r3 & 0xFFFF;
    if (tmp != 4) goto L_801EFE58;
    r3 = 0x0;
    ((void(*)(void))fn_801F1758)();
    tmp = r3 & 0xFF;
    if (tmp != 1) goto L_801EFD5C;
    fn_80265B3C();
    tmp = r3 & 0xFF;
    if (tmp != 1) goto L_801EFD5C;
    ((void(*)(void))fn_801C2D54)();
...
L_801EFD44:
    ...
    r26 = r26 + r3;
L_801EFD50:
    if (r26 < r28) goto L_801EFD44;
    goto L_801EFE58;
L_801EFD5C:
    r3 = 0x0;
    fn_801F1700();
    tmp = r3 & 0xFF;
    if (tmp != 1) goto L_801EFD78;
    fn_80265A6C();
    fn_802659F8();
L_801EFD78:
    ((void(*)(void))fn_801C2D54)();
...
L_801EFD9C:
    ...
    fn_801F1700();
    tmp = r3 & 0xFF;
    if (tmp != 1) goto L_801EFDF0;
    fn_802659A4();
    fn_802658C8();
L_801EFDF0:
    fn_801EF634();
    tmp = r3 & 0xFFFF;
    if (tmp != 1) goto L_801EFE58;
    r3 = r28;
    r8 = r29;
    r4 = 0x0;
    r5 = 0x0;
