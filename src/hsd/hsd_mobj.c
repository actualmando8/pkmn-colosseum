    ...
    if (r30 != 0) {
        ...
        if ((s32)r30 == 2) {
            ...
            *(u32*)(sp + 0x8) = tmp;
            ...
            /* mode 1/3+: diffuse color from material */
            r3 = *(u32*)((u8*)r24 + 0xC);
            r6 = r26;
            r4 = 0x1;
            r5 = 0x0;
...
void fn_801A7B24(void) {
    ...
    if (tmp == 0 || r3 == 0) {
        /* No existing class info - use default or fallback */
