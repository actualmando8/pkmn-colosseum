...
L_800DEDAC: ;
    r0 = (s8)r4;
    if ((s32)r0 < (s32)0x30 || (s32)r0 > (s32)0x39) goto L_800DEDE4;
...
L_800DEEAC: ;
    r0 = (s8)r5;
    if ((s32)r0 < (s32)0x30 || (s32)r0 > (s32)0x39) goto L_800DEEE4;
...
void fn_800D923C(void) {
    ...
    L_800D93D0: ;
        ...
        fn_800BC4C0();
        r0 = *(u8*)((u8*)r24 + 0x0);
        if ((u32)r0 == (u32)0x0 || (u32)r23 == (u32)0x0) goto L_800D9580;
...
L_800DA934: ;
    ...
    if ((s32)r10 != (s32)0xb && (s32)r10 != (s32)0xc) goto L_800DA9C4;
...
L_800DE534: ;
    r0 = (s8)r4;
    if ((s32)r0 < (s32)0x30 || (s32)r0 > (s32)0x39) goto L_800DE56C;
...
void fn_800DFABC(void) {
    ...
    L_800DFB44: ;
        ...
        *(u32*)((u8*)r29 + 0x8) = r3;
        ...
        if ((s32)r0 >= (s32)0xe || (s32)r0 >= (s32)0x7) goto L_800DFBC4;
