...
void fn_800FF0A0(void) {
    ...
    if (tmp == 0) goto L_800FF0E8;
L_800FF0C4:
    tmp = *(u32*)((u8*)r31 + 0x8);
    if ((s32)tmp != 3) goto L_800FF0E0;
    tmp = *(u32*)((u8*)r31 + 0x18);
    if (tmp != r3) goto L_800FF0E0;
    goto L_800FF0EC;
L_800FF0E0:
    r31 = r31 + 0x24;
...
L_800FF0E8:
    r31 = 0x0;
L_800FF0EC:
    if (r31 == 0) goto L_800FF164;
    tmp = *(u32*)((u8*)r31 + 0xC);
    if ((s32)tmp != 1) goto L_800FF114;
    tmp = *(u32*)((u8*)r31 + 0x1C);
    if (tmp == 0) goto L_800FF114;
    r3 = *(u16*)((u8*)r31 + 0x20);
    fn_800F7274();
L_800FF114:
    tmp = 0x0;
    *(u32*)((u8*)r31 + 0x8) = tmp;
    r3 = *(u32*)((u8*)r31 + 0x0);
    if (r3 == 0) goto L_800FF130;
    tmp = *(u32*)((u8*)r31 + 0x4);
    *(u32*)((u8*)r3 + 0x4) = tmp;
L_800FF130:
    r3 = *(u32*)((u8*)r31 + 0x4);
    if (r3 == 0) goto L_800FF144;
    tmp = *(u32*)((u8*)r31 + 0x0);
    *(u32*)((u8*)r3 + 0x0) = tmp;
L_800FF144:
    tmp = *(u32*)lbl_8047ACCC;
    if (tmp != r31) goto L_800FF158;
    tmp = *(u32*)((u8*)r31 + 0x4);
...
void fn_800FF178(void) {
    ...
    r7 = r7 + tmp;
    ctr_fn = (void(*)(void))r6;
    if (r6 == 0) goto L_800FF1B8;
L_800FF1A0:
    tmp = *(u32*)((u8*)r7 + 0x8);
    if ((s32)tmp != 0) goto L_800FF1B0;
    goto L_800FF1BC;
L_800FF1B0:
    r7 = r7 + 0x24;
...
L_800FF224:
    r5 = *(u32*)((u8*)r4 + 0x4);
    if (r5 == 0) goto L_800FF240;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 < tmp) goto L_800FF220;
L_800FF240:
    if (r5 != 0) goto L_800FF26C;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 >= tmp) goto L_800FF26C;
    *(u32*)((u8*)r7 + 0x0) = r4;
    tmp = 0x0;
    *(u32*)((u8*)r7 + 0x4) = tmp;
    *(u32*)((u8*)r4 + 0x4) = r7;
...
void fn_800FF2A0(void) {
    ...
    r7 = r6 + tmp;
    ctr_fn = (void(*)(void))r8;
    if (r8 == 0) goto L_800FF2D8;
L_800FF2C0:
    tmp = *(u32*)((u8*)r7 + 0x8);
    if ((s32)tmp != 0) goto L_800FF2D0;
    goto L_800FF2DC;
L_800FF2D0:
    r7 = r7 + 0x24;
...
L_800FF344:
    r5 = *(u32*)((u8*)r4 + 0x4);
    if (r5 == 0) goto L_800FF360;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 < tmp) goto L_800FF340;
L_800FF360:
    if (r5 != 0) goto L_800FF38C;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 >= tmp) goto L_800FF38C;
    *(u32*)((u8*)r7 + 0x0) = r4;
    tmp = 0x0;
    *(u32*)((u8*)r7 + 0x4) = tmp;
    *(u32*)((u8*)r4 + 0x4) = r7;
...
void fn_800FF3C0(void) {
    ...
    r7 = *(u32*)lbl_8047ACB0;
    ctr_fn = (void(*)(void))tmp;
    if (tmp == 0) goto L_800FF3EC;
L_800FF3D4:
    tmp = *(u32*)((u8*)r7 + 0x8);
    if ((s32)tmp != 0) goto L_800FF3E4;
    goto L_800FF3F0;
L_800FF3E4:
    r7 = r7 + 0x24;
...
L_800FF458:
    r5 = *(u32*)((u8*)r4 + 0x4);
    if (r5 == 0) goto L_800FF474;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 < tmp) goto L_800FF454;
L_800FF474:
    if (r5 != 0) goto L_800FF4A0;
    r3 = *(u8*)((u8*)r4 + 0x14);
    tmp = *(u8*)((u8*)r7 + 0x14);
    if (r3 >= tmp) goto L_800FF4A0;
    *(u32*)((u8*)r7 + 0x0) = r4;
    tmp = 0x0;
    *(u32*)((u8*)r7 + 0x4) = tmp;
    *(u32*)((u8*)r4 + 0x4) = r7;
...
L_800FF5E4:
    tmp = *(u32*)((u8*)r30 + 0x8);
    if ((s32)tmp == 0) goto L_800FF614;
    tmp = *(u32*)((u8*)r30 + 0xC);
    if ((s32)tmp != 1) goto L_800FF614;
    r3 = *(u32*)((u8*)r30 + 0x10);
    tmp = *(u32*)((u8*)r31 + 0x4);
    if (r3 != tmp) goto L_800FF614;
    r3 = *(u16*)((u8*)r30 + 0x20);
    fn_800F7274();
L_800FF614:
    r30 = r30 + 0x24;
L_800FF618:
    if (r29 != 0) goto L_800FF5E4;
    r3 = 0x5;
    tmp = -0x1;
    *(u32*)((u8*)r31 + 0x10) = r3;
...
void fn_800FF660(void) {
    ...
    r4 = r4 + 0x8;
    fn_8011288C();
    tmp = *(u32*)&lbl_8047ACC4;
    if (tmp == 0) goto L_800FF714;
    tmp = *(u32*)lbl_8047ACD8;
    r31 = *(u32*)&lbl_8047ACC8;
    if ((s32)tmp != 2) goto L_800FF70C;
    tmp = *(u32*)lbl_8047ACB4;
    r3 = *(u32*)lbl_8047ACB0;
    tmp = tmp * 0x24;
    r29 = *(u32*)lbl_8047ACB8;
...
L_800FF6BC:
    tmp = *(u32*)((u8*)r30 + 0x8);
    if ((s32)tmp == 0) goto L_800FF6EC;
    tmp = *(u32*)((u8*)r30 + 0xC);
    if ((s32)tmp != 1) goto L_800FF6EC;
    r3 = *(u32*)((u8*)r30 + 0x10);
    tmp = *(u32*)((u8*)r31 + 0x4);
    if (r3 != tmp) goto L_800FF6EC;
    r3 = *(u16*)((u8*)r30 + 0x20);
    fn_800F7274();
L_800FF6EC:
    r30 = r30 + 0x24;
L_800FF6F0:
    if (r29 != 0) goto L_800FF6BC;
    r3 = 0x5;
    tmp = -0x1;
    *(u32*)((u8*)r31 + 0x10) = r3;
    *(u32*)lbl_80478B18 = tmp;
