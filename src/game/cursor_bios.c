/**
 * @file cursor_bios.c
 * @brief cursorBios -- per-window cursor position save/restore table
 *        (Colosseum "menu" UI subsystem support). Split from the
 *        gs_model.c splitter bucket (address range 0x80103E68 -
 *        0x80103FE4, 4 fns). Self-contained mini-TU owning bss
 *        lbl_80404A98; mirrors XD's cursorBios.cpp
 *        (0x80116A90-0x80116BD4, GetPos/SetPos/Init). cursorBiosInit is
 *        called by menuInit (menu.c).
 */
