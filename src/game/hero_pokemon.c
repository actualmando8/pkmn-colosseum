 ...
 *
 * XD source unit: heroPokemonGet* (XD heroPokemon.cpp)
 * Address range: 0x80130660 - 0x80130CE0 (~7 functions)
 *
...
void heroPokemonGetCelebi(u8* arg1) {
    ...
    pokemonSetCatchStatus(buf, 0xff, 0xa, 4, 1, 0x7991, GSmsgGetGSchar(0x12af));
...
void heroPokemonGetPikachu(u8* arg1) {
    ...
    pokemonSetStatus(buf, 0, 0x99, 0, 0x46);
    pokemonSetCatchStatus(buf, 0xff, 0xa, 4, 0, 0x7991, GSmsgGetGSchar(0x12ae));
    tmp = pokemonCreateRndFit(buf, -1, -1, 0, 0x7991);
    pokemonSetStatus(buf, 0, 0x6f, 0, tmp);
...
void heroPokemonGetHouou(u8* arg1) {
    ...
    pokemonSetStatus(buf, 0, 0x99, 0, 0x46);
    pokemonSetCatchStatus(buf, 0xff, 0x46, 4, 0, 0x2740, GSmsgGetGSchar(0x12ad));
