...
void fn_80044378(u8* ctx, u8* p) {
    ...
    val = *(s16*)(p + 6);
    if (val == 0x12b2) {
        ctx[0x8b] = (u8)(s32)(lbl_8047BCA0 * *(f32*)((u8*)lbl_803A6818 + 0x54));
    } else {
        ctx[0x8b] = (u8)(s32)(lbl_8047BCA0 * *(f32*)((u8*)lbl_803A6818 + 0x4c));
    }
    val = *(s16*)(p + 6);
    switch (val) {
        case 0xd46:
...
#else
void fn_800492CC(u8* a, u8* b) { /* TODO */ }
#endif
...
u8 fn_8004DFCC(u8 a) {
    ...
    fn_80102510(0x76);
    fn_80102428(0x76, 1);
    snd = fn_801D1650((u32)(u8)lbl_8047A524);
    if (snd != 0) {
        fn_801669E4(snd, 0, 0);
    }
    snd = fn_801D1650((u32)(u8)lbl_8047A524);
...
void fn_80054EC8(u8* ctx) {
    ...
    switch (state) {
    case 1:
        if (fn_80057538() == 0) { break; }
        slot = (s8)ctx[0x95];
        if (slot >= 0 && slot < 0x20) {
            r30 = *(s32*)(lbl_80267398 + (u32)slot * 0xc + 8);
        }
        {
            s32 r31 = fn_80056A78();
            fn_80134EF0(0, (s8)r31, (s8)r30);
            fn_800574FC(0);
            fn_80134AF8(0, (s8)r31, (s8)r30);
        }
        fn_800576C4(2);
        break;
    case 2:
    ...
    case 4:
        ...
        {
            s32 r31 = fn_80056A78();
            fn_80134E10(0, fn_800574E0(), (s8)r31, (s8)r30);
            fn_800574A8();
        }
        fn_800576C4(5);
        break;
