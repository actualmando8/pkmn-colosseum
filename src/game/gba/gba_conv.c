...
L_800846B4:
    ...
    *(u32*)((u8*)r26 + 0x64) = tmp;
    ...
    do {
        ...
        if ((s32)tmp >= 0xb || (s32)tmp >= 8) break;
...
s32 fn_80087C64(void) {
    ...
    *(u32*)(sp + 0xA8) = tmp;
    while (1) {
        ...
        *(u16*)(sp + 0x58) = tmp;
        do {
        if ((s32)r31 < 0 || (s32)r31 >= 3 || (s32)r24 < 0 || (s32)r24 >= 3) break;
