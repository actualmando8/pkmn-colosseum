...
void* fn_80134A98(void* base, s8 index) {
    ...
    if ((s8)index >= 0 && (s8)index < 3) {
        return (u8*)base + (s32)(s8)index * 0x24a4;
    }
    return 0;
}
#endif
