...
L_8007583C: ;
    ...
    r31 = r3;
    if ((s32)r31 == 0xb8) goto L_80075880;
    if ((s32)r31 >= 0xb8) goto L_80075880;
    if ((s32)r31 == 0xb3) goto L_80075878;
    goto L_80075880;
L_80075878: ;
...
L_80075880: ;
    ...
    *(u32*)((u8*)r3 + 0x20) = r31;
    ...
    r31 = r3;
    if ((s32)r31 == 0xb4) goto L_8007596C;
    if ((s32)r31 >= 0xb4) goto L_800758E4;
    if ((s32)r31 == 0xac) goto L_8007594C;
    if ((s32)r31 >= 0xac) goto L_800758DC;
    if ((s32)r31 == (s32)-0x1) goto L_8007596C;
    goto L_8007596C;
L_800758DC: ;
    goto L_8007596C;
L_800758E4: ;
    if ((s32)r31 == 0xd1) goto L_80075904;
    if ((s32)r31 >= 0xd1) goto L_800758F8;
    goto L_8007596C;
L_800758F8: ;
    if ((s32)r31 == 0x105) goto L_8007593C;
    goto L_8007596C;
L_80075904: ;
    r3 = 0x0;
    r4 = 0xe;
    ((void(*)(void))fn_80129280)();
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((s32)r0 != 0x1) goto L_80075978;
    r3 = 0x0;
    r4 = 0xe;
    ((void(*)(void))fn_80129280)();
    r0 = *(u32*)((u8*)r3 + 0x20);
    if ((s32)r0 != 0x2) goto L_80075978;
    r30 = 0x0;
    goto L_80075978;
L_8007593C: ;
    r3 = 0x105;
...
L_80075978: ;
    r0 = r30 & 0xFF;
    if (r0 != 0x0) goto L_8007583C;
L_80075984: ;
    ((void(*)(void))fn_800FF52C)();
    r0 = r3 & 0xFF;
    if (r0 == 0x0) goto L_80075A14;
    r3 = 0x0;
    r4 = 0xe;
    ((void(*)(void))fn_80129280)();
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((s32)r0 == 0x1) goto L_800759C4;
    r3 = (u32)&lbl_802688F8;
    r5 = (u32)&lbl_8026890C;
    r3 = (u32)&lbl_802688F8;
    r4 = 0xa7;
...
L_800759C4: ;
    ...
    ((void(*)(void))fn_80129280)();
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((s32)r0 == 0x1) goto L_800759E4;
    goto L_80075A1C;
L_800759E4: ;
    if ((s32)r31 == 0xd1) goto L_80075A1C;
    r3 = 0x8ae;
    r4 = 0x0;
    fn_8019075C();
    r3 = (0x596 << 16);
...
L_80075CA4:
    ...
    r3 = 0x1;
    fn_801C40F0();
    if ((s32)r31 == 1) goto L_80075D10;
    if ((s32)r31 >= 1) goto L_80075CF8;
...
L_80075D10:
    ...
    fn_801D0748();
    r31 = r3;
    if ((s32)r31 != 3) goto L_80075D40;
    r3 = 0x0;
    r4 = 0x4;
    ((void(*)(void))fn_80135168)();
    if (r3 != 0) goto L_80075D68;
L_80075D40:
...
s32 fn_80075DC8(void) {
    ...
    if ((s32)r3 != 0x32) goto L_80075E1C;
    f1 = *(f32*)&lbl_8047C0C0;
    ((void(*)(void))fn_800C46B0)();
    r30 = r3;
    if (r30 >= 1) goto L_80075E1C;
    r30 = 0x1;
L_80075E1C:
    r31 = 0x0;
    goto L_80075E30;
...
L_80075E30:
    ...
    r8 = 0x0;
    ((void(*)(void))fn_801026A4)();
    if ((s32)r3 == 0) goto L_80075E8C;
    if ((s32)r3 >= 0) goto L_80075E84;
    goto L_80075E94;
L_80075E84:
    goto L_80075E94;
L_80075E8C:
...
s32 fn_80075F78(void) {
    ...
    tmp = *(u8*)((u8*)r3 + 0x95);
    tmp = (s8)tmp;
    if ((s32)tmp == 1) goto L_80075FB8;
    if ((s32)tmp >= 1) goto L_80075FA4;
    if ((s32)tmp >= 0) goto L_80075FB0;
    goto L_80075FC8;
L_80075FA4:
    if ((s32)tmp >= 3) goto L_80075FC8;
    goto L_80075FC0;
L_80075FB0:
    r3 = 0x43bc;
    goto L_80075FCC;
...
s32 fn_80075FEC(void) {
    ...
    tmp = r3 & 0xFFFF;
    if ((s32)tmp == 0x19a) goto L_80076020;
    if ((s32)tmp >= 0x19a) goto L_8007603C;
    if ((s32)tmp == 0x97) goto L_80076020;
    goto L_8007603C;
L_80076020:
    r3 = r31;
    ((void(*)(void))fn_8011E7A4)();
    tmp = r3 & 0xFF;
    if (tmp != 0) goto L_8007603C;
    r3 = 0x0;
    goto L_80076040;
L_8007603C:
    r3 = 0x1;
...
L_800760AC:
    r26 = r26 + 0x1;
    if ((s32)r26 < 6) goto L_8007607C;
    r25 = r25 + 0x1;
    if (r25 < 6) goto L_80076078;
    if (r28 != 0) goto L_800760D4;
    r3 = 0x0;
    goto L_80076320;
L_800760D4:
    r30 = 0x0;
...
L_800760DC:
    ...
    r25 = r3;
    r26 = 0x0;
    if (r25 == 0) goto L_80076110;
    r4 = 0x0;
    r5 = 0x6e;
    r6 = 0x0;
    ((void(*)(void))fn_8012640C)();
    if ((s32)r3 != 0) goto L_80076114;
L_80076110:
    r26 = 0x1;
L_80076114:
    if ((s32)r26 == 0) goto L_80076124;
    tmp = 0x1;
    goto L_800762AC;
L_80076124:
    if ((s32)r30 == 1) goto L_80076170;
    if ((s32)r30 >= 1) goto L_8007613C;
    if ((s32)r30 >= 0) goto L_80076148;
    goto L_80076298;
L_8007613C:
    if ((s32)r30 >= 3) goto L_80076298;
    goto L_80076198;
L_80076148:
    r3 = r25;
...
L_80076198:
    ...
    tmp = r25 & 0xFFFF;
    r26 = r3;
    if ((s32)tmp == 0xaf) goto L_800761D0;
    if ((s32)tmp >= 0xaf) goto L_800761D8;
    if ((s32)tmp == 0) goto L_800761C8;
    goto L_800761D8;
L_800761C8:
    r3 = 0x1;
    goto L_800761E0;
...
L_800761E0:
    tmp = r3 & 0xFF;
    if (tmp != 0) goto L_800761F4;
    tmp = 0x0;
    goto L_800762AC;
L_800761F4:
    tmp = *(u32*)((u8*)r26 + 0x8);
    if ((s32)tmp == 1) goto L_80076224;
    if ((s32)tmp >= 1) goto L_80076210;
    if ((s32)tmp >= 0) goto L_8007621C;
    goto L_80076290;
L_80076210:
    if ((s32)tmp >= 3) goto L_80076290;
    goto L_80076238;
L_8007621C:
    tmp = 0x1;
    goto L_800762AC;
...
L_80076238:
    ...
    if (tmp <= 0) goto L_80076288;
L_80076258:
    tmp = *(u16*)((u8*)r5 + 0x0);
    if (r3 != tmp) goto L_8007627C;
    tmp = r4 + 0x18;
    tmp = *(u8*)(r26 + tmp);
    tmp = __cntlzw(tmp);
    tmp = (u32)tmp >> 5;
...
L_800762C8:
    r29 = r29 + 0x1;
    if ((s32)r29 < 6) goto L_800760DC;
    r30 = r30 + 0x1;
    if (r30 < 3) goto L_800760D8;
    r25 = 0x0;
L_800762E4:
    r3 = r27;
    r4 = r28;
...
L_80076350:
    ...
    fn_80076398();
    tmp = r3 & 0xFF;
    if (tmp != 0) goto L_80076370;
    r3 = 0x0;
    goto L_80076380;
L_80076370:
    r31 = r31 + 0x1;
    if ((s32)r31 < 6) goto L_80076350;
    r3 = 0x1;
L_80076380:
    return;
}
...
s32 fn_80076398(void) {
    ...
    r30 = 0x0;
    if (r31 == 0) goto L_800763E8;
    r4 = 0x0;
    r5 = 0x6e;
    r6 = 0x0;
    ((void(*)(void))fn_8012640C)();
    if ((s32)r3 != 0) goto L_800763EC;
L_800763E8:
    r30 = 0x1;
L_800763EC:
    if ((s32)r30 == 0) goto L_800763FC;
    r3 = 0x1;
    goto L_80076798;
L_800763FC:
    if ((s32)r28 == 3) goto L_800766B0;
    if ((s32)r28 >= 3) goto L_80076420;
    if ((s32)r28 == 1) goto L_80076678;
    if ((s32)r28 >= 1) goto L_80076694;
    if ((s32)r28 >= 0) goto L_80076430;
    goto L_80076784;
L_80076420:
    if ((s32)r28 == 5) goto L_80076748;
    if ((s32)r28 >= 5) goto L_80076784;
    goto L_800766EC;
L_80076430:
    r3 = r31;
    r4 = 0x2;
...
L_80076450:
    ...
    ((void(*)(void))fn_8011F5C8)();
    tmp = r3 & 0xFFFF;
    if ((s32)tmp == 0x19a) goto L_80076474;
    if ((s32)tmp >= 0x19a) goto L_80076490;
    if ((s32)tmp == 0x97) goto L_80076474;
    goto L_80076490;
L_80076474:
    r3 = r31;
    ((void(*)(void))fn_8011E7A4)();
    tmp = r3 & 0xFF;
    if (tmp != 0) goto L_80076490;
    tmp = 0x0;
    goto L_80076494;
L_80076490:
    tmp = 0x1;
...
L_800766B0:
    ...
    ((void(*)(void))fn_8011F1A0)();
    tmp = r3 & 0xFFFF;
    if ((s32)tmp == 0xaf) goto L_800766DC;
    if ((s32)tmp >= 0xaf) goto L_800766E4;
    if ((s32)tmp == 0) goto L_800766D4;
    goto L_800766E4;
L_800766D4:
    r3 = 0x1;
    goto L_80076798;
...
L_800766F0:
    ...
    ((void(*)(void))fn_8012640C)();
    r28 = r3 & 0xFFFF;
    if (r28 == 0) goto L_80076734;
    r3 = 0x0;
    ((void(*)(void))fn_8011CA34)();
    r30 = r3;
    r3 = r28;
    ((void(*)(void))fn_8011CA34)();
    if (r3 != r30) goto L_80076734;
    r3 = 0x0;
    goto L_80076798;
L_80076734:
    r29 = r29 + 0x1;
    if ((s32)r29 < 4) goto L_800766F0;
    r3 = 0x1;
    goto L_80076798;
L_80076748:
    r3 = r31;
