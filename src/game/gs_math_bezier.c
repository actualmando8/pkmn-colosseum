/**
 * @file gs_math_bezier.c
 * @brief GS render engine segment -- split from gs_render.c.
 *
 * XD source unit: game/pxdvs/GSAPI/GSmath/GSbezier.cpp
 * Address range: 0x800E07E4 - 0x800E090C (1 functions)
 *
 * Single function, size 0x128 EXACT match = XD's entire GSbezier.cpp text.
 *
