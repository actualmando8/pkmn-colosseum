...
void fn_80122040(void) {
    ...
    /* Check slot 8 - if active, set flag 1 */
    r3 = 0x8;
    fn_80119ED0();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x7c || (u32)r0 == (u32)0xc8) {
        r3 = r30;
        r4 = 0x8;
        fn_8011B67C();
    } else {
    ...
    /* Check slot 7 - if active, set flag 2 */
    r3 = 0x7;
    fn_80119ED0();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x7c || (u32)r0 == (u32)0xc8) {
    ...
    /* Check if r30 is null */
    if ((u32)r30 == (u32)0x0) {
        r0 = 0x0;
    } else {
        /* Check slots 3-8 for completion */
        r0 = 0x1;

        /* Slot 3 */
        r3 = 0x3;
        fn_80119ED0();
        if ((r3 & 0xFFFF) == 0x7c || (r3 & 0xFFFF) == 0xc8) {
            r3 = r30; r4 = 0x3; fn_8011B67C();
        } else {
            r3 = 0x0;
        }
        if ((r3 & 0xFF) == 0x1) { r0 = 0x0; }
