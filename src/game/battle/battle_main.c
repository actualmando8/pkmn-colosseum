...
L_801EF0B4: ;
    r0 = r30 & 0xFFFF;
    if ((u32)r0 < (u32)r31) goto L_801EF0A0;
    /* lmw r30, 0x8(r1) */;
    return;
}
#pragma pop
...
L_801EF108: ;
    r0 = r30 & 0xFFFF;
    if ((u32)r0 < (u32)r31) goto L_801EF0F4;
    /* lmw r30, 0x8(r1) */;
    return;
}
#pragma pop
...
void fn_801EF128(void) {
    ...
    /* stmw r27, 0xc(r1) */;
    r29 = r3;
    if ((u32)r3 != (u32)0x0) goto L_801EF154;
    r3 = 0x0;
    r4 = 0xf;
    fn_80129280();
    r29 = r3;
...
L_801EF164: ;
    ...
    *(u8*)((u8*)r27 + 0xE) = r28;
    r28 = r28 + 0x1;
    if ((s32)r28 < (s32)0x61) goto L_801EF164;
    /* lmw r27, 0xc(r1) */;
    return;
}
#pragma pop
...
void fn_801EF1E4(void) {
    ...
    if ((u32)r3 != (u32)0x0) goto L_801EF204;
    r3 = 0x0;
    r4 = 0xf;
    fn_80129280();
L_801EF204: ;
...
L_801EF230: ;
    ...
    fn_801EEC74();
    r0 = r3 & 0xFF;
    if ((s32)r0 == (s32)0) goto L_801EF244;
    r30 = r30 + 0x1;
L_801EF244: ;
    r31 = r31 + 0x1;
L_801EF248: ;
    ...
    r4 = r31 & 0xFFFF;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r4 < (u32)r0) goto L_801EF230;
    r3 = r30;
    /* lmw r30, 0x8(r1) */;
    return;
}
...
L_801EF290: ;
    ...
    fn_801EEAD0();
    r0 = r3 & 0xFF;
    if ((s32)r0 == (s32)0) goto L_801EF2A4;
    r30 = r30 + 0x1;
L_801EF2A4: ;
    r31 = r31 + 0x1;
L_801EF2A8: ;
    ...
    r4 = r31 & 0xFFFF;
    r0 = *(u32*)((u8*)r3 + 0x0);
    if ((u32)r4 < (u32)r0) goto L_801EF290;
    r3 = r30;
    /* lmw r30, 0x8(r1) */;
    return;
}
...
L_801EF324: ;
    ...
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EF350;
    r3 = r30;
    r4 = 0x0;
    r5 = 0x0;
...
L_801EF354: ;
    r0 = r29 & 0xFF;
    if ((u32)r0 < (u32)0x15) goto L_801EF324;
    /* lmw r29, 0x64(r1) */;
    return;
}
#pragma pop
...
L_801EF664: ;
    r0 = (s8)r29;
    if ((s32)r0 < (s32)0) goto L_801EF688;
    r3 = (u32)lbl_803752A0;
    /* clrlslwi r4, r30, 16, 1 */;
    r0 = (u32)lbl_803752A0;
    r3 = r0 + r4;
    r0 = *(u16*)((u8*)r3 + 0x2);
    if ((s32)r31 != (s32)r0) goto L_801EF6D4;
L_801EF688: ;
    r4 = (u32)lbl_803752A0;
    r3 = (u32)lbl_803727C8;
...
L_801EF6B8: ;
    r3 = r28;
    fn_8017B2CC();
    if ((s32)r3 == (s32)0x0) goto L_801EF6D4;
    if ((s32)r3 < (s32)0x0) goto L_801EF6D4;
...
L_801EF6D8: ;
    r0 = *(u16*)lbl_80478D10;
    r3 = r30 & 0xFFFF;
    if ((u32)r3 < (u32)r0) goto L_801EF664;
    /* lmw r28, 0x10(r1) */;
    return;
}
#pragma pop
...
void fn_801EF6FC(void) {
    ...
    r0 = *(u8*)lbl_8047B5E1;
    if ((u32)r0 == (u32)0x1) goto L_801EF748;
    r0 = r3 & 0xFF;
    if ((u32)r0 == (u32)0x1) goto L_801EF748;
    fn_801EF624();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x1) goto L_801EF748;
    fn_8020DD44();
    if ((u32)r3 == (u32)0x0) goto L_801EF740;
    r4 = 0x3e8;
    r5 = 0xff;
...
void fn_801EF758(void) {
    ...
    r0 = *(u8*)lbl_8047B5E0;
    if ((u32)r0 == (u32)0x1) goto L_801EF7A4;
    r0 = r3 & 0xFF;
    if ((u32)r0 == (u32)0x1) goto L_801EF7A4;
    fn_801EF624();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x1) goto L_801EF7A4;
    fn_8020DD80();
    if ((u32)r3 == (u32)0x0) goto L_801EF79C;
    r4 = 0x0;
    r5 = 0xff;
...
L_801EF824: ;
    ...
    fn_801F47B4();
    /* mr. r31, r3 */;
    if ((s32)r0 == (s32)0) goto L_801EF8D0;
    r30 = 0x0;
    goto L_801EF8C4;
L_801EF840: ;
    r3 = r31;
    ...
    fn_801F7258();
    /* mr. r25, r3 */;
    if ((s32)r0 == (s32)0) goto L_801EF8C0;
    r4 = 0x0;
    r5 = 0x4c;
    r6 = 0x0;
    fn_801FB1C0();
    if ((u32)r3 == (u32)0x0) goto L_801EF8C0;
    r4 = r24;
    fn_801DA4E8();
    r29 = 0x0;
    goto L_801EF8B4;
L_801EF87C: ;
    ...
    r4 = r29;
    fn_801F981C();
    if ((u32)r3 == (u32)0x0) goto L_801EF8B0;
    r4 = 0x0;
    r5 = 0xee;
    r6 = 0x0;
    fn_8012640C();
...
L_801EF8B4: ;
    r0 = r29 & 0xFFFF;
    if ((u32)r0 < (u32)r26) goto L_801EF87C;
L_801EF8C0: ;
    r30 = r30 + 0x1;
L_801EF8C4: ;
    r0 = r30 & 0xFFFF;
    if ((u32)r0 < (u32)r27) goto L_801EF840;
L_801EF8D0: ;
    r28 = r28 + 0x1;
L_801EF8D4: ;
    r0 = r28 & 0xFFFF;
    if ((u32)r0 < (u32)0x2) goto L_801EF824;
    /* lmw r24, 0x10(r1) */;
    return;
}
#pragma pop
...
void fn_801EF95C(void) {
    ...
    fn_8000816C();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EF99C;
    r3 = 0x1;
...
L_801EF9A4: ;
    ...
    r0 = *(u16*)(sp + 0x8);
    r0 = r0 & 0x00000800;
    if ((u32)r0 != (u32)0x1) goto L_801EF9D8;
    ((void(*)(void))fn_800F0308)();
...
L_801EF9CC: ;
    r0 = r31 & 0xFF;
    if ((u32)r0 < (u32)0x4) goto L_801EF9A4;
L_801EF9D8: ;
    r0 = r31 & 0xFF;
    if ((u32)r0 >= (u32)0x4) goto L_801EF9EC;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EF9EC: ;
    r3 = r30;
...
void fn_801EFA08(void) {
    ...
    /* stmw r26, 0x48(r1) */;
    ((void(*)(void))fn_801F54A4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFA40;
    r4 = 0x3e8;
    r5 = 0xff;
    ((void(*)(void))fn_801659FC)();
L_801EFA40: ;
    ...
    if ((u32)r3 == (u32)0x0) goto L_801EFA98;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
...
L_801EFA98: ;
    ...
    fn_8000816C();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFACC;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
    goto L_801EFB1C;
L_801EFACC: ;
...
L_801EFAD4: ;
    ...
    r0 = *(u16*)(sp + 0x24);
    r0 = r0 & 0x00000800;
    if ((u32)r0 != (u32)0x1) goto L_801EFB08;
    ((void(*)(void))fn_800F0308)();
    ((void(*)(void))fn_800D3088)();
    r0 = r29 + r3;
    r29 = r0 & 0xFF;
L_801EFAFC: ;
    r0 = r29 & 0xFF;
    if ((u32)r0 < (u32)0x4) goto L_801EFAD4;
L_801EFB08: ;
    r0 = r29 & 0xFF;
    if ((u32)r0 >= (u32)0x4) goto L_801EFB1C;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EFB1C: ;
    r3 = r28;
    ...
    fn_801EF634();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 != (u32)0x4) goto L_801EFE5C;
    ((void(*)(void))fn_801C2D54)();
    ((void(*)(void))fn_801C2D68)();
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFB54;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFB54: ;
    ...
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFB9C;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFB9C: ;
    ...
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFBE4;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFBE4: ;
    ...
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFC28;
...
L_801EFC44: ;
    ...
    fn_8000816C();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFC70;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
    goto L_801EFCC0;
L_801EFC70: ;
...
L_801EFC78: ;
    ...
    r0 = *(u16*)(sp + 0x8);
    r0 = r0 & 0x00000800;
    if ((u32)r0 != (u32)0x1) goto L_801EFCAC;
    ((void(*)(void))fn_800F0308)();
    ((void(*)(void))fn_800D3088)();
    r0 = r26 + r3;
    r26 = r0 & 0xFF;
L_801EFCA0: ;
    r0 = r26 & 0xFF;
    if ((u32)r0 < (u32)0x4) goto L_801EFC78;
L_801EFCAC: ;
    r0 = r26 & 0xFF;
    if ((u32)r0 >= (u32)0x4) goto L_801EFCC0;
    r3 = 0x1;
    ((void(*)(void))fn_80133810)();
L_801EFCC0: ;
    r3 = r27;
    ...
    fn_801EF634();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 != (u32)0x4) goto L_801EFE58;
    r3 = 0x0;
    ((void(*)(void))fn_801F1758)();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFD5C;
    fn_80265B3C();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFD5C;
    ((void(*)(void))fn_801C2D54)();
    ...
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFD1C;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFD1C: ;
    ...
    fn_80008184();
    /* mr. r28, r3 */;
    if ((u32)r3 == (u32)0x0) goto L_801EFE58;
    r26 = 0x0;
    goto L_801EFD50;
L_801EFD44: ;
    ((void(*)(void))fn_800F0308)();
    ...
    r26 = r26 + r3;
L_801EFD50: ;
    if ((u32)r26 < (u32)r28) goto L_801EFD44;
    goto L_801EFE58;
L_801EFD5C: ;
    r3 = 0x0;
    fn_801F1700();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFD78;
    fn_80265A6C();
    fn_802659F8();
L_801EFD78: ;
    ((void(*)(void))fn_801C2D54)();
    ...
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFD9C;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFD9C: ;
    ...
    fn_801F1700();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFDF0;
    fn_802659A4();
    fn_802658C8();
L_801EFDF0: ;
    fn_801EF634();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFE58;
    r3 = r28;
    r8 = r29;
    r4 = 0x0;
    r5 = 0x0;
...
L_801EFE4C: ;
    fn_801EF634();
    r0 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x1) goto L_801EFC44;
L_801EFE58: ;
    ((void(*)(void))fn_801F09D0)();
L_801EFE5C: ;
    ((void(*)(void))fn_801C2D54)();
    ...
    ((void(*)(void))fn_800FF56C)();
    ((void(*)(void))fn_80113FB4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFE80;
    r4 = (0x7b << 16);
    r4 = r4 + 0x1800;
    ((void(*)(void))fn_801C2F00)();
L_801EFE80: ;
    ...
    ((void(*)(void))fn_801F1758)();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1) goto L_801EFEA0;
    fn_80265BBC();
    fn_80265D54();
L_801EFEA0: ;
    r3 = (u32)lbl_8046D760;
    ...
    r6 = 0x0;
    ((void(*)(void))fn_801F54A4)();
    if ((u32)r3 == (u32)0x0) goto L_801EFF14;
    r4 = 0x3e8;
...
L_801EFF14: ;
    ...
    r6 = 0x0;
    ((void(*)(void))fn_801F54A4)();
    if ((u32)r3 != (u32)0x0) goto L_801EFF44;
    r3 = 0x1;
    r4 = 0x3e8;
    r5 = 0x3e8;
    r6 = 0xff;
...
void fn_801EFFC4(void) {
    ...
    /* stmw r30, 0x8(r1) */;
    /* mr. r30, r3 */;
    if ((s32)r0 == (s32)0) goto L_801EFFF8;
    r31 = 0x0;
    goto L_801EFFF0;
L_801EFFE4: ;
    ((void(*)(void))fn_800F0308)();
    ...
    r31 = r31 + r3;
L_801EFFF0: ;
    if ((u32)r31 < (u32)r30) goto L_801EFFE4;
L_801EFFF8: ;
    /* lmw r30, 0x8(r1) */;
    return;
}
