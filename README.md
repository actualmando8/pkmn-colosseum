...
|---|---|
| Fuzzy match | 57.80% |
| Function match | 73.31% (6,307 / 8,603 functions) |
| Code match | 36.13% (901,420 / 2,495,108 matched code bytes) |
| Data match | 97.29% (2,136,509 / 2,196,100 matched data bytes) |
| Linked into DOL | 765 / 1,384 units (24.40% of code) |
