 ...
 *
 * XD source unit: game/pxdvs/GSAPI/GSmath/GSutil.cpp
 * Address range: 0x800E0D24 - 0x800E0DDC (1 functions)
 *
 * GSmathInitCosTable size 0xB8 EXACT = XD GSutil.cpp entire .text (one-function TU in both games; owns the cos-table .bss).
 *
