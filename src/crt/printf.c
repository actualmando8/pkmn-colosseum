...
L_800C855C:
    ...
    if (r25 == 0) goto L_800C85EC;
    tmp = -0x1;
    r4 = -0x2;
    if (r3 >= tmp) goto L_800C85E4;
    r4 = r3;
L_800C85E4:
    tmp = 0x0;
    *(u8*)(r25 + r4) = tmp;
...
void fn_800C8600(void) {
    ...
    *(u32*)(sp + 0x10) = tmp;
    ((void(*)(void))__pformatter)();
    if (r31 == 0) goto L_800C8664;
    tmp = -0x1;
    r4 = -0x2;
    if (r3 >= tmp) goto L_800C865C;
    r4 = r3;
L_800C865C:
    tmp = 0x0;
    *(u8*)(r31 + r4) = tmp;
...
L_800C9770:
    ...
    r8 = r6 + 0x5;
    r6 = (s8)tmp;
    if ((s32)r6 != 5) goto L_800C97D4;
    r5 = r3 + r7;
    r5 = r5 + 0x5;
L_800C97A0:
    if (r5 <= r8) goto L_800C97B8;
    tmp = *(u8*)((u8*)r5 + 0x0);
    if ((s32)tmp == 0x30) goto L_800C97A0;
L_800C97B8:
    if (r5 != r8) goto L_800C97CC;
    tmp = *(u8*)((u8*)r8 + (-1));
    r5 = tmp & 0x1;
    goto L_800C9834;
L_800C97CC:
...
L_800C97F0:
    ...
    tmp = r5 - tmp;
    /* srwi. r5, tmp, 31 */;
    if (r5 != r8) goto L_800C9820;
    tmp = (s8)r7;
    if (r5 != r8) goto L_800C9828;
L_800C9820:
    goto L_800C9838;
L_800C9828:
    tmp = r7 + 0x30;
...
L_800C9834:
    r6 = 0x9;
L_800C9838:
    if ((s32)r4 != 0) goto L_800C97F0;
L_800C9840:
    if ((s32)r5 == 0) goto L_800C9868;
    r5 = *(s16*)((u8*)r3 + 0x2);
    r4 = 0x1;
    tmp = 0x31;
    r5 = r5 + 0x1;
...
L_800CA6A8:
    /* subic. r5, r5, 0x1 */;
    if (r28 != 1) goto L_800CA68C;
    if (r27 == 1) goto L_800CA778;
    r24 = r24 - r30;
L_800CA6C0:
    r26 = r28;
    tmp = r30 * tmp;
...
L_800CA760:
    /* subic. r5, r5, 0x1 */;
    if ((s32)r3 != 0) goto L_800CA744;
L_800CA768:
    tmp = r26 << 1;
    if (tmp <= r27) goto L_800CA6D4;
    goto L_800CA668;
L_800CA778:
    return;
}
