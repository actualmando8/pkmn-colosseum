...
L_800A28A8:
    ...
    *(u32*)((u8*)r4 + 0x1C) = tmp;
    ...
    r3 = r3 * 0x64;
    r3 = r5 - r3;
    if ((s32)r3 == 0) goto L_800A290C;
    r8 = r7;
L_800A290C:
    if ((s32)r8 != 0) goto L_800A2940;
    r3 = 0x51EC0000;
    r3 = (s32)((s64)r3 * (s64)r5 >> 32);
    r3 = (s32)r3 >> 7;
    r6 = (u32)r3 >> 31;
    ...
    r3 = r3 * 0x190;
    r3 = r5 - r3;
    if ((s32)r3 == 0) goto L_800A2940;
    r7 = 0x0;
L_800A2940:
    if ((s32)r7 == 0) goto L_800A2954;
    r3 = (u32)lbl_803118A8;
    r6 = (u32)lbl_803118A8;
    goto L_800A295C;
L_800A2954:
