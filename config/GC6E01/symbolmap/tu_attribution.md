...
| `0x800a4d28`-`0x800a5624` | GAP | dvdfs_range_800A4D28.c | `dvdfs.c`×5 | ✅ match |
| `0x800a5624`-`0x800a7820` | KNOWN | DVD.c | `dvd.c`×2 | ✅ match |
| `0x800a8178`-`0x800aa280` | GAP | VI_range_800A8178.c | `vi.c`×1 | 🔀 relabel (assigned VI_range_800A8178.c but code is vi.c) |
...
| `0x80193c24`-`0x80197a64` | KNOWN | hsd_cobj.c | `cobj.c`×24 | ✅ match |
...
| `0x8019b7c0`-`0x8019c690` | KNOWN | hsd_fog.c | `fog.c`×3, `hash.c`×1, `id.c`×1 | ✂️ split (also holds: hash.c, id.c) |
| `0x8019c690`-`0x8019ce50` | KNOWN | hsd_initialize.c | `initialize.c`×4 | ✅ match |
| `0x8019ce50`-`0x801a4000` | KNOWN | hsd_jobj.c | `jobj.c`×18, `list.c`×2 | ✂️ split (also holds: list.c) |
| `0x801a4000`-`0x801a69c0` | KNOWN | hsd_lobj.c | `lobj.c`×9 | ✅ match |
| `0x801a69c0`-`0x801a6ca4` | KNOWN | hsd_memory.c | `memory.c`×1 | ✅ match |
| `0x801a6ca4`-`0x801a8428` | KNOWN | hsd_mobj.c | `mobj.c`×10 | ✅ match |
...
| `0x801aa608`-`0x801add48` | GAP | hsd_pobj_range_801AA608.c | `pobj.c`×14 | ✅ match |
| `0x801add48`-`0x801ae000` | GAP | hsd_robj_range_801ADD48.c | `robj.c`×3 | ✅ match |
| `0x801ae008`-`0x801aebe0` | GAP | hsd_robj_range_801AE008.c | `robj.c`×3 | ✅ match |
...
| `0x801bbac8`-`0x801bf098` | KNOWN | hsd_tobj.c | `tobj.c`×21 | ✅ match |
...
- **`pobj.c`** — 14 GAP function(s), `0x801aa8bc`..`0x801ad354` (e.g. HSD_PObjDisp, fn_801AA8BC, SetupEnvelopeModelMtx, fn_801AAEA8, …)
...
- **`dvdfs.c`** — 5 GAP function(s), `0x800a4d28`..`0x800a5558` (e.g. DVDConvertPathToEntrynum, fn_800A4D28, fn_800A532C, fn_800A541C, …)
