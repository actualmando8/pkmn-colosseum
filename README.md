...
| Metric | Value |
|---|---|
| Function match | ~60.6% (4,075 / 6,725 functions) |
| Code match | ~38.0% (509,372 / 1,341,936 matched code bytes) |

Last measured 2026-06-19 with `python tools/gen_decomp_report.py -o report.json`
