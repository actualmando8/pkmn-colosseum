...
L_80199F74:
    ...
    *(u32*)((u8*)r29 + 0x4) = tmp;
    ...
    r4 = r4 + 0x7;
    r5 = r5 | r3;
    if (r3 != tmp) goto L_80199F74;
    *(u16*)((u8*)r29 + 0x1A) = r5;
    tmp = *(u8*)((u8*)r29 + 0x10);
    tmp = tmp | 0x20;
    *(u8*)((u8*)r29 + 0x10) = tmp;
    if (r29 == 0) goto L_80199FC4;
    tmp = *(u8*)((u8*)r29 + 0x10);
    tmp = tmp & 0x000000F0;
    tmp = tmp | 0x2;
    *(u8*)((u8*)r29 + 0x10) = tmp;
...
L_8019A330:
    ...
    if ((s32)tmp >= 6) goto L_8019B474;
    goto L_8019AF60;
L_8019A340:
    if (r31 != 0) goto L_8019A350;
    r30 = 0x0;
    goto L_8019A358;
L_8019A350:
    tmp = *(u8*)((u8*)r31 + 0x10);
...
L_8019A358:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019A380;
    r5 = 0x0;
L_8019A380:
    if ((s32)r5 != 0) goto L_8019A39C;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x17f;
...
L_8019A5F0:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019A618;
    r5 = 0x0;
L_8019A618:
    if ((s32)r5 != 0) goto L_8019A634;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x193;
...
L_8019A888:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019A8B0;
    r5 = 0x0;
L_8019A8B0:
    if ((s32)r5 != 0) goto L_8019A8CC;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x1a7;
...
L_8019AB14:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019AB3C;
    r5 = 0x0;
L_8019AB3C:
    if ((s32)r5 != 0) goto L_8019AB58;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x1b9;
...
L_8019AF78:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019AFA0;
    r5 = 0x0;
L_8019AFA0:
    if ((s32)r5 != 0) goto L_8019AFBC;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x1cc;
...
L_8019B1D8:
    ...
    tmp = r3 - tmp;
    /* srwi. tmp, tmp, 31 */;
    if (r31 != 0) goto L_8019B200;
    r5 = 0x0;
L_8019B200:
    if ((s32)r5 != 0) goto L_8019B21C;
    r4 = (u32)lbl_8027477C;
    r3 = (u32)lbl_8047DA30;
    r5 = (u32)lbl_8027477C;
    r4 = 0x1e9;
