...
void fn_8019B490(void) {
    ...
    goto L_8019B500;
L_8019B4C0:
    if (r29 == 0) goto L_8019B4FC;
    tmp = *(u8*)((u8*)r29 + 0x12);
    if (tmp != 6) goto L_8019B4E8;
    f1 = f31;
    r3 = r29;
    r4 = r30;
    r5 = r31;
...
void fn_8019B528(void) {
    ...
    if (r3 == 0) goto L_8019B5E0;
    goto L_8019B5D8;
L_8019B538:
    if (r3 == 0) goto L_8019B5D4;
    r4 = *(u32*)((u8*)r3 + 0x8);
    tmp = 0x43300000;
    r6 = 0x0;
    f6 = *(f64*)lbl_8047DA58;
...
void fn_8019B5E8(void) {
    ...
    /* mr. r31, r3 */;
    if ((s32)tmp == 0) goto L_8019B73C;
    r30 = *(u32*)((u8*)r31 + 0x0);
    if (r30 == 0) goto L_8019B724;
    r29 = *(u32*)((u8*)r30 + 0x0);
    if (r29 == 0) goto L_8019B70C;
    r28 = *(u32*)((u8*)r29 + 0x0);
    if (r28 == 0) goto L_8019B6F4;
    r27 = *(u32*)((u8*)r28 + 0x0);
    if (r27 == 0) goto L_8019B6DC;
    r26 = *(u32*)((u8*)r27 + 0x0);
    if (r26 == 0) goto L_8019B6C4;
    r25 = *(u32*)((u8*)r26 + 0x0);
    if (r25 == 0) goto L_8019B6AC;
    r24 = *(u32*)((u8*)r25 + 0x0);
    if (r24 == 0) goto L_8019B680;
    r23 = *(u32*)((u8*)r24 + 0x0);
    if (r23 == 0) goto L_8019B670;
    r3 = *(u32*)((u8*)r23 + 0x0);
    fn_8019B5E8();
    r3 = r23;
    fn_8019B750();
...
void fn_8019B948(void) {
    ...
    if (r3 == 0) goto L_8019BB70;
    if (r4 > 0x15) goto L_8019BB70;
...
L_8019BAE0:
    if (r3 == 0) goto L_8019BB70;
    if ((s32)tmp > (s32)-0x140) goto L_8019BAFC;
    tmp = -0x140;
    *(u16*)((u8*)r3 + 0xC) = tmp;
    goto L_8019BB70;
L_8019BAFC:
    if ((s32)tmp < 0x140) goto L_8019BB10;
    tmp = 0x140;
    *(u16*)((u8*)r3 + 0xC) = tmp;
    goto L_8019BB70;
L_8019BB10:
...
L_8019BB3C:
    if (r3 == 0) goto L_8019BB70;
    if ((s32)tmp > 0) goto L_8019BB58;
    tmp = 0x0;
    *(u16*)((u8*)r3 + 0xE) = tmp;
    goto L_8019BB70;
L_8019BB58:
    if ((s32)tmp < 0x280) goto L_8019BB6C;
    tmp = 0x280;
    *(u16*)((u8*)r3 + 0xE) = tmp;
    goto L_8019BB70;
L_8019BB6C:
...
L_8019BBB8:
    /* mr. r31, r29 */;
    if ((s32)tmp != 0) goto L_8019BBD0;
    r3 = (u32)lbl_8047DA74;
    r4 = 0xae;
    r5 = (u32)lbl_8047DA80;
    fn_80196E10();
L_8019BBD0:
    if (r31 == 0) goto L_8019BC44;
    if (r30 == 0) goto L_8019BC04;
    tmp = *(u32*)((u8*)r30 + 0x0);
    *(u32*)((u8*)r31 + 0x8) = tmp;
    f0 = *(f32*)((u8*)r30 + 0x8);
    *(f32*)((u8*)r31 + 0x10) = f0;
...
L_8019BC44:
    tmp = *(u32*)((u8*)r30 + 0x4);
    if (tmp == 0) goto L_8019BCF8;
    r3 = (u32)lbl_8036C828;
    r30 = *(u32*)((u8*)r30 + 0x4);
    r3 = (u32)lbl_8036C828;
    fn_80193828();
    /* mr. r29, r3 */;
    if (tmp != 0) goto L_8019BC78;
    r3 = (u32)lbl_8047DA74;
    r4 = 0xf9;
    r5 = (u32)lbl_8047DA7C;
    fn_80196E10();
L_8019BC78:
    if (r29 != 0) goto L_8019BC90;
    r3 = (u32)lbl_8047DA74;
    r4 = 0x109;
    r5 = (u32)lbl_8047DA7C;
    fn_80196E10();
L_8019BC90:
    if (r29 == 0) goto L_8019BCF4;
    if (r30 == 0) goto L_8019BCCC;
    tmp = *(u32*)((u8*)r30 + 0x0);
    r3 = r29 + 0x10;
    r4 = r30 + 0x8;
    r5 = 0x40;
...
L_8019BD94:
    ...
    *(u32*)(sp + 0x8) = tmp;
    ...
    r4 = r31;
    fn_800BC8F8();
    if (r28 == 0) goto L_8019BDE0;
    r30 = *(u32*)((u8*)r28 + 0xC);
    goto L_8019BDE4;
L_8019BDE0:
    r30 = 0x0;
L_8019BDE4:
    if (r30 == 0) goto L_8019BDF4;
    r31 = *(u32*)((u8*)r30 + 0x8);
    goto L_8019BDF8;
L_8019BDF4:
    r31 = 0x0;
L_8019BDF8:
    if (r30 == 0) goto L_8019BFB0;
    tmp = r31 & 0x7;
    if (r30 == 0) goto L_8019BFB0;
    r3 = (u32)sp + 0x30;
    fn_800BD768();
    tmp = r31 & 0x1;
    if (r30 == 0) goto L_8019BE74;
    f4 = *(f32*)(sp + 0x30);
    f3 = *(f32*)(sp + 0x38);
    if (r30 == 0) goto L_8019BE30;
    r3 = *(s16*)((u8*)r30 + 0xC);
    goto L_8019BE34;
L_8019BE30:
    r3 = -0x1;
...
L_8019BE90:
    tmp = r31 & 0x00000002;
    if (r30 == 0) goto L_8019BEB0;
    if (r30 == 0) goto L_8019BEA8;
    r28 = *(u16*)((u8*)r30 + 0xE);
    goto L_8019BEC0;
L_8019BEA8:
    r28 = -0x1;
...
L_8019BEC0:
    tmp = r31 & 0x00000004;
    if (r30 == 0) goto L_8019BEE0;
    if (r30 == 0) goto L_8019BED8;
    r30 = r30 + 0x10;
    goto L_8019BF8C;
L_8019BED8:
    r30 = 0x0;
...
L_8019C070:
    ...
    ctr_fn = (void(*)(void))r12;
    ctr_fn();
    if ((s32)r3 != 0) goto L_8019C098;
    goto L_8019C0A8;
L_8019C098:
    r30 = *(u32*)((u8*)r30 + 0x0);
L_8019C09C:
    if (r30 != 0) goto L_8019C070;
    r30 = 0x0;
L_8019C0A8:
    r3 = r30;
    if (r31 == 0) goto L_8019C0C4;
    tmp = -r3;
    tmp = tmp | r3;
    tmp = (u32)tmp >> 31;
    *(u32*)((u8*)r31 + 0x0) = tmp;
L_8019C0C4:
    if (r3 == 0) goto L_8019C0D4;
    r3 = *(u32*)((u8*)r3 + 0x8);
    goto L_8019C0D8;
L_8019C0D4:
    r3 = 0x0;
...
L_8019C168:
    tmp = *(u32*)((u8*)r3 + 0x4);
    if (tmp != r4) goto L_8019C18C;
    if (r5 == 0) goto L_8019C184;
    tmp = 0x1;
    *(u32*)((u8*)r5 + 0x0) = tmp;
L_8019C184:
    r3 = *(u32*)((u8*)r3 + 0x8);
...
L_8019C18C:
    r3 = *(u32*)((u8*)r3 + 0x0);
L_8019C190:
    if (r3 != 0) goto L_8019C168;
    if (r5 == 0) goto L_8019C1A8;
    tmp = 0x0;
    *(u32*)((u8*)r5 + 0x0) = tmp;
L_8019C1A8:
    r3 = 0x0;
...
L_8019C204:
    tmp = *(u32*)((u8*)r5 + 0x4);
    if (tmp != r4) goto L_8019C244;
    if (r6 == 0) goto L_8019C224;
    tmp = *(u32*)((u8*)r5 + 0x0);
    *(u32*)((u8*)r6 + 0x0) = tmp;
    goto L_8019C230;
L_8019C224:
...
L_8019C2C4:
    tmp = *(u32*)((u8*)r4 + 0x4);
    if (tmp == r30) goto L_8019C2DC;
    r4 = *(u32*)((u8*)r4 + 0x0);
L_8019C2D4:
    if (r4 != 0) goto L_8019C2C4;
L_8019C2DC:
    if (r4 == 0) goto L_8019C2F0;
    *(u32*)((u8*)r4 + 0x4) = r30;
    *(u32*)((u8*)r4 + 0x8) = r31;
    goto L_8019C344;
L_8019C2F0:
