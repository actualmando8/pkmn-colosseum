 ...
 */
SDATA2 const f64 lbl_8047DA90 = 4.503601774854144e+15;
SDATA2 const u8 lbl_8047DA98[7] = "hash.c";
SDATA2 const u8 lbl_8047DAA0[5] = "id.c";
SDATA2 const u8 lbl_8047DAA8[6] = "entry";
...
SDATA2 const u8 lbl_8047DB34[7] = "jobj.h";
SDATA2 const u8 lbl_8047DB3C[5] = "jobj";
SDATA2 const f32 lbl_8047DB44 = 1.000000013351432e-10f;
SDATA2 const f32 lbl_8047DB48 = 0.0f;
SDATA2 const f64 lbl_8047DB50 = 0.5;
SDATA2 const f64 lbl_8047DB58 = 3.0;
SDATA2 const f64 lbl_8047DB60 = 0.0;
SDATA2 const u8 lbl_8047DB68[4] = "eff";
SDATA2 const u8 lbl_8047DB6C[5] = "robj";
SDATA2 const f32 lbl_8047DB74 = -1.0f;
SDATA2 const f32 lbl_8047DB78 = 3.1415927f;
