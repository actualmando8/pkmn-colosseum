...
void fn_80137780(void) {
    ...
    *(u8*)((u8*)r27 + 0x4C) = tmp;
    tmp = *(u32*)((u8*)r30 + 0x8);
    if ((s32)tmp >= 1 && (s32)tmp < 3) {
        /* L_801377D4: cases 1, 2 */
        r3 = -0x4;
    } else {
        /* L_801377DC: cases 0, 3+ */
        r3 = *(u32*)((u8*)r30 + 0xC);
        tmp = r3 & 0x00000004;
        if ((s32)tmp == 4) {
            r28 = 0x0;
...
void fn_80137F58(void) {
    ...
    if (r3 <= 1) { r3 = 0x0; return; }
    if (r31 <= 1) { r3 = 0x0; return; }
    fn_800D2248();
    r3 = 0x1;
    r4 = 0x6;
    r5 = 0x7;
