...
void fn_80195F0C(HSD_CObj* cobj_param) {
    ...
    cobj_param = *(u32*)((u8*)cobj_param + 0x24);
    tmp = *(u32*)((u8*)cobj_param + 0x8);
    tmp = tmp & 0x00000002;
    if (tmp == 0) goto L_80195F64;
    r6 = 0x1;
...
L_80195F70:
    ...
    cobj_param = *(u32*)((u8*)cobj_param + 0x28);
    tmp = *(u32*)((u8*)cobj_param + 0x8);
    tmp = tmp & 0x00000002;
    if (tmp == 0) goto L_80195F9C;
    r5 = 0x1;
...
L_80195FA8:
    ...
    if (cobj_param != 0) goto L_80195FC8;
    cobj_param = (u32)lbl_8047D958;
    r4 = 0x318;
    r5 = (u32)lbl_8047D960;
    fn_80196E10();
L_80195FC8:
    if (cobj_param != 0) goto L_80195FE0;
    cobj_param = (u32)lbl_8047D958;
    r4 = 0x2e8;
    r5 = (u32)lbl_8047D960;
    fn_80196E10();
L_80195FE0:
    ...
    *(f32*)(sp + 0x1C) = f0;
L_80196018:
    if (cobj_param != 0) goto L_80196030;
    cobj_param = (u32)lbl_8047D958;
    r4 = 0x300;
    r5 = (u32)lbl_8047D960;
    fn_80196E10();
L_80196030:
    if (cobj_param != 0) goto L_80196048;
    cobj_param = (u32)lbl_8047D958;
    r4 = 0x2d0;
    r5 = (u32)lbl_8047D960;
    fn_80196E10();
L_80196048:
    ...
    *(u32*)((u8*)cobj_param + 0x8) = tmp;
    ...
    tmp = tmp & 0xFFFFFFFD;
    *(u32*)((u8*)cobj_param + 0x8) = tmp;
    if (cobj_param == 0) goto L_8019609C;
    tmp = *(u32*)((u8*)cobj_param + 0x8);
    tmp = tmp & 0xBFFFFFFF;
    *(u32*)((u8*)cobj_param + 0x8) = tmp;
L_8019609C:
    if (cobj_param == 0) goto L_801960B0;
    tmp = *(u32*)((u8*)cobj_param + 0x8);
    tmp = tmp | (0x8000 << 16);
    *(u32*)((u8*)cobj_param + 0x8) = tmp;
L_801960B0:
