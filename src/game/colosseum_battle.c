...
u32 fn_8025F2FC(u32 idx) {
    extern u8 lbl_804783E0[];
    u8* entry;
    entry = lbl_804783E0 + (idx << 8);
    if (*(u32*)(entry + 0x20) != 0) return 0;
    if (*(u8*)(entry + 0x5) != 0 || *(u8*)(entry + 0x6) != 4) {
        *(u32*)(entry + 0x20) = 1;
        return 0;
    }
    *(u8*)*(u32*)(entry + 0x14) = *(u8*)(entry + 0x7) & 0x3A;
    return 0;
}
...
u32 fn_802658C8(void* ctx, u32 slot, u32 param) {
    ...
    u8* base = lbl_80478800;
    f32 zero;
    u32 handle = *(u32*)(base + 0xC);
    if (handle != 0) {
        fn_800F05A0(handle);
    }
    base[0] = 0;
    *(u32*)(base + 0xC) = 0;
    zero = *(f32*)lbl_8047E6D8;
    *(f32*)(base + 0x4) = zero;
    *(f32*)(base + 0x8) = zero;
    base[0x1] = 0;
    return 0;
...
f32 fn_8026595C(void) {
    ...
    if (*(u8*)(data + 0x1) == 1) {
        return *(f32*)lbl_8047E6E8;
    }
    if (*(u32*)(data + 0xC) == 0) {
        return *(f32*)lbl_8047E6D8;
    }
    return *(f32*)(data + 0x8) - *(f32*)(data + 0x4) / *(f32*)lbl_8047E6DC;
}
...
u32 fn_80265EC4(void* ctx, u32 slot, u32 param) {
    extern void* fn_80129280();
    u8* base;
    base = (u8*)fn_80129280(0, 0x10);
    if (base[(u32)ctx] == 0 && (slot & 0xFF) != 0) {
        base[(u32)ctx] = (u8)slot;
    }
    return 0;
}
