...
void fn_800E3604(u32 flags, u8 slot) {
    ...
    ctx = fn_800D2584();
    if (ctx != NULL) {
        if (fn_80195A6C(*(void**)((u8*)ctx + 0xc)) != 0) {
            fn_800DD174(*(void**)((u8*)ctx + 0xc));
            slotMatch = (u8)slot;
            animFlag = flags & 0x10;
...
void fn_800E43A4(void* entry, void* param) {
    ...
    if (*(u32*)((u8*)entry + 0x114) == 0) {
        ...
        r30 = *(void**)((u8*)entry + 0x8);
        if (r30 == NULL) {
            fn_80196E10(lbl_8047CB60, 0x3a9, lbl_8047CB68);
        }
        if (param == NULL) {
...
void fn_800E4598(void* entry, void* r4) {
    void* r31 = *(void**)((u8*)entry + 0x8);
    if (r31 == NULL) {
        fn_80196E10(lbl_8047CB60, 0x495, lbl_8047CB68);
    }
    if (r4 == NULL) {
        fn_80196E10(lbl_8047CB60, 0x496, lbl_8047CB78);
    }
...
void fn_800E465C(void* entry, u8 r4) {
    ...
    *(u32*)((u8*)entry + 0x114) = 0;
    ...
    if (*(u32*)((u8*)entry + 0x114) == 0) {
        ...
        if (((u8*)entry + 0x120) == NULL) fn_80196E10(lbl_8047CB60, 0x3aa, lbl_80270E50);
    ...
    if (*(u32*)((u8*)entry + 0x114) == 0) {
        ...
        r30 = *(void**)((u8*)entry + 0x8);
        if (r30 == NULL) fn_80196E10(lbl_8047CB60, 0x316, lbl_8047CB68);
        if (((u8*)entry + 0x138) == NULL) fn_80196E10(lbl_8047CB60, 0x317, lbl_8047CB70);
...
void fn_800E4DB0(void* entry, void* r4) {
    fn_800E01D0((u8*)entry + 0x30, r4);
    {
        void* r31 = *(void**)((u8*)entry + 0x8);
        if (r31 == NULL) {
            fn_80196E10(lbl_8047CB60, 0x316, lbl_8047CB68);
        }
        if (r4 == NULL) {
            fn_80196E10(lbl_8047CB60, 0x317, lbl_8047CB70);
        }
        *(u32*)((u8*)r31 + 0x2c) = *(u32*)((u8*)r4 + 0x0);
        *(u32*)((u8*)r31 + 0x30) = *(u32*)((u8*)r4 + 0x4);
        *(u32*)((u8*)r31 + 0x34) = *(u32*)((u8*)r4 + 0x8);
...
void fn_800E4E8C(void* entry, f32* r4) {
    ...
    if (*(u32*)((u8*)r29 + 0x14) & 0x20000)
        fn_80196E10(lbl_8047CB60, 0x2a5, lbl_80270E28);
    *(f32*)((u8*)r29 + 0x1c) = r4[0];
    ...
    if (r29 == NULL) fn_80196E10(lbl_8047CB60, 0x2b8, lbl_8047CB68);
    if (*(u32*)((u8*)r29 + 0x14) & 0x20000)
        fn_80196E10(lbl_8047CB60, 0x2b9, lbl_80270E28);
    *(f32*)((u8*)r29 + 0x20) = r4[1];
    ...
    if (r29 == NULL) fn_80196E10(lbl_8047CB60, 0x2cc, lbl_8047CB68);
    if (*(u32*)((u8*)r29 + 0x14) & 0x20000)
        fn_80196E10(lbl_8047CB60, 0x2cd, lbl_80270E28);
    ...
    *(u16*)((u8*)entry + 0x152) = *(u16*)((u8*)entry + 0x152) + 1;
    {
        ...
        while (r23 < r24) {
            void* p = r25[r23];
            if (p != NULL) {
                ((void(*)(void*, void*))fn_800DF498)(p, param);
            }
            r23++;
            r25++;
        }
...
void fn_800E6DCC(void* entry) {
    ...
    if (mobj == NULL) {
        ...
        texObj = *(void**)((u8*)mobj + 0x10);
    }

    if (mobj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x3e4, &lbl_8047CBA4);
    }
    if ((u32)&stk0[0] == 0) {
        fn_80196E10(&lbl_8047CB9C, 0x3e5, lbl_80270E60);
    }

    stk0[0] = *(u32*)((u8*)mobj + 0x38);
    stk0[1] = *(u32*)((u8*)mobj + 0x3c);
    stk0[2] = *(u32*)((u8*)mobj + 0x40);

    if (mobj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x2ec, &lbl_8047CBA4);
    }
    fA = *(f32*)((u8*)mobj + 0x1c);

    if (mobj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x2fa, &lbl_8047CBA4);
    }
    fB = *(f32*)((u8*)mobj + 0x20);

    if (mobj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x308, &lbl_8047CBA4);
    }
    fC = *(f32*)((u8*)mobj + 0x24);

    if ((u32)&stk1[0] == 0) {
        fn_80196E10(&lbl_8047CB9C, 0x352, &lbl_8047CBAC);
    }

    stk1[0] = *(u32*)((u8*)mobj + 0x2c);
    stk1[1] = *(u32*)((u8*)mobj + 0x30);
    stk1[2] = *(u32*)((u8*)mobj + 0x34);

    if (texObj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x3a9, &lbl_8047CBA4);
    }
    if ((u32)&stk0[0] == 0) {
        fn_80196E10(&lbl_8047CB9C, 0x3aa, lbl_80270E60);
    }

    *(u32*)((u8*)texObj + 0x38) = stk0[0];
    *(u32*)((u8*)texObj + 0x3c) = stk0[1];
    *(u32*)((u8*)texObj + 0x40) = stk0[2];

    if (!(*(u32*)((u8*)texObj + 0x14) & 0x02000000)) {
        if (texObj != NULL) {
            u32 fl;
            s32 check;
            if (texObj == NULL) {
    ...
    if (texObj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x2a4, &lbl_8047CBA4);
    }
    if (*(u32*)((u8*)texObj + 0x14) & 0x20000) {
        fn_80196E10(&lbl_8047CB9C, 0x2a5, lbl_80270E6C);
    }
    *(f32*)((u8*)texObj + 0x1c) = fA;
    ...
    if (texObj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x2b8, &lbl_8047CBA4);
    }
    if (*(u32*)((u8*)texObj + 0x14) & 0x20000) {
        fn_80196E10(&lbl_8047CB9C, 0x2b9, lbl_80270E6C);
    }
    *(f32*)((u8*)texObj + 0x20) = fB;
    ...
    if (texObj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x2cc, &lbl_8047CBA4);
    }
    if (*(u32*)((u8*)texObj + 0x14) & 0x20000) {
        fn_80196E10(&lbl_8047CB9C, 0x2cd, lbl_80270E6C);
    }
    *(f32*)((u8*)texObj + 0x24) = fC;
    ...
    if (texObj == NULL) {
        fn_80196E10(&lbl_8047CB9C, 0x316, &lbl_8047CBA4);
    }
    if ((u32)&stk1[0] == 0) {
        fn_80196E10(&lbl_8047CB9C, 0x317, &lbl_8047CBAC);
    }

    *(u32*)((u8*)texObj + 0x2c) = stk1[0];
    *(u32*)((u8*)texObj + 0x30) = stk1[1];
    *(u32*)((u8*)texObj + 0x34) = stk1[2];
...
void fn_800EAFE4(void* obj, void* dst, void* unused, void* output) {
    ...
    ret = fn_8019F01C(obj);
    fn_801AB63C(0, 2);
    xform = fn_80197A64(ret, (void*)mtxStack);
    ...
    while (i < 10 && node != NULL) {
        nodeData = *(void**)((u8*)node + 0x4);
        if (nodeData == NULL) {
            fn_80196E10(&lbl_8047CC10, 0x65, assertStr);
        }
        if (*(f32*)((u8*)nodeData + 0x8) >= threshold) {
            ...
            while (nodeData != NULL) {
                if (*(void**)((u8*)nodeData + 0x4) == NULL) {
                    fn_80196E10(&lbl_8047CC10, 0x7e, assertStr + 0xc);
                }
                texObj = *(void**)((u8*)nodeData + 0x4);
                if (texObj != NULL) {
                    u32 flags2;
                ...
                if ((u32)texObj + 0x44 == 0) {
                    fn_80196E10(&lbl_8047CC10, 0x81, &lbl_8047CC20);
                }
        ...
        if (obj != NULL) {
            fn_800A2D98(mtxPtr, obj, (void*)mtxBuf);
        }
        fn_800A2D98(dst, mtxPtr, (void*)mtxTmp);
...
void fn_800EC208(void* entry, s32 mode) {
    ...
    *(s32*)((u8*)entry + 0xa4) = mode;
    ...
    if (mode == 0) {
        fn_801C028C(mobj, 6, 0x64db, fn_800EE054, 3, 0);
    } else if (mode == 1) {
        fn_801C028C(mobj, 6, 0x64db, fn_800EE054, 3, 1);
    }
}
#endif
...
void fn_800EC5FC(void* entry, u32 start, u32 end) {
    ...
    *(f32*)((u8*)entry + 0xcc) = fval;
    fn_801C028C(*(void**)((u8*)entry + 0x10), 6, 0x9B2F, (void*)fn_800EE08C, 2, (u8*)entry + 0xcc);

    /* Setup timer callbacks for entry->0x14 */
    fval = *(f32*)&lbl_8047CC5C;
    *(f32*)((u8*)entry + 0xd0) = fval;
    fn_801C028C(*(void**)((u8*)entry + 0x14), 6, 0x9B2F, (void*)fn_800EE08C, 2, (u8*)entry + 0xd0);
    ...
    if (end != *(u32*)((u8*)entry + 0xa8)) {
        ...
        *(f32*)((u8*)entry + 0xb8) = fval;
        fn_801C028C(dobj, 6, 0x64db, (void*)fn_800EE08C, 2, (u8*)entry + 0xb8);
    }
    ...
    /* Handle entry->0xa4 switch */
    {
        ...
        *(s32*)((u8*)entry + 0xa4) = mode;
        switch (mode) {
        case 0:
            fn_801C028C(obj3, 6, 0x64db, (void*)fn_800EE054, 3, 0);
            break;
        case 1:
            fn_801C028C(obj3, 6, 0x64db, (void*)fn_800EE054, 3, 1);
            break;
        }
    }
...
void fn_800ECCA8(void* entry, s32 idx) {
    ...
    *(f32*)((u8*)entry + 0xa0) = fval;
    fn_801C028C(dobj, 6, 0x9B2F, (void*)fn_800EE08C, 2, (u8*)entry + 0xa0);
...
section3:
    {
        ...
        *(s32*)((u8*)entry + 0x8c) = mode;
        if (mode == 0) {
            fn_801C028C(mobj, 6, 0x9B2F, (void*)fn_800EE054, 3, 0);
        } else if (mode == 1) {
            fn_801C028C(mobj, 6, 0x9B2F, (void*)fn_800EE054, 3, 1);
        }
    }
...

    {
        ...
        *(s32*)((u8*)entry + 0xa4) = *(s32*)((u8*)entry + 0xa4);
        mode = *(s32*)((u8*)entry + 0xa4);
        if (mode == 0) {
            fn_801C028C(mobj2, 6, 0x64db, (void*)fn_800EE054, 3, 0);
        } else if (mode == 1) {
            fn_801C028C(mobj2, 6, 0x64db, (void*)fn_800EE054, 3, 1);
        }
    }
