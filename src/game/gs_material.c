...
extern void  fn_80191118(void* mtx);                   /* MTXIsIdentity */
...
/* =======================================================================
 *  GSmaterialStoreResult / fn_800EE044
 *  Address: 0x800EE044, Size: 0x10
 *
 *  Assembly:
 *    cmplwi r3, 0
 *    beqlr                      ; if NULL, return
 *    stw r3, 0x0(r4)           ; store r3 into *r4
 *    blr
 * ======================================================================= */
/* (This is a generic helper used internally) */

/* =======================================================================
 *  Remaining ~140 functions in the 0x800E3604-0x800EE2C8 range are
 *  stub-documented above in the file header and in gs_material.h.
 *
 *  The functions fall into these categories:
 *
 *  CRITICAL FOR PC PORT (shader pipeline):
 *    fn_800E732C (0x12BC) -- Full TEV pipeline setup
 *    fn_800E8684 (0x878)  -- Full lighting setup
 *    fn_800E93B8 (0x5E0)  -- Environment map pipeline
 *    fn_800E9E90 (0x77C)  -- Environment map render
 *    fn_800EC5FC (0x2CC)  -- Material render entry point
 *    fn_800ECCA8 (0x428)  -- Shadow pipeline
 *    fn_800EDA98 (0x5AC)  -- Complete draw sequence
 *
 *  MEDIUM PRIORITY (blend / depth / alpha):
 *    fn_800E4170 (0x234)  -- Alpha blend mode
 *    fn_800E43A4 (0x170)  -- Z-mode configuration
 *    fn_800EACD0 (0x314)  -- Blend configuration
 *    fn_800EAFE4 (0x284)  -- Z-mode configuration
 *    fn_800EB904 (0x5E8)  -- Large render setup
 *    fn_800EBEEC (0x1FC)  -- Render configuration
 *
 *  LOWER PRIORITY (helpers / small functions):
 *    Remaining accessor and helper functions are straightforward
 *    and can be decompiled incrementally as needed.
 * ======================================================================= */
