...
| Metric | Value |
|---|---|
| Function match | ~58.2% (5305 / 9120 functions) |
| Code match | ~48.8% (821,408 / 1,683,396 matched code bytes) |

Last measured 2026-06-13 with `python tools/gen_decomp_report.py -o report.json`
