...
L_801E42B4:
    ...
    r5 = 0x1;
    ((void(*)(void))fn_8009F2F8)();
    if ((s32)tmp == 0 || (s32)tmp == 0) goto L_801E43C4;
...
L_801E5664:
    ...
    goto L_801E5718;
L_801E567C:
    if (tmp < 0xd8 || tmp > 0xdf) goto L_801E56DC;
...
void fn_801E6578(void) {
    ...
    *(u32*)lbl_8047B5A8 = tmp;
    ...
    r4 = *(u32*)lbl_8047B5B0;
    tmp = *(u16*)((u8*)r4 + 0x692);
    if (tmp != 0x200 || r30 != 0x1c0) goto L_801E6610;
...
L_801E6610:
    r4 = *(u32*)lbl_8047B5B0;
    tmp = *(u16*)((u8*)r4 + 0x692);
    if (tmp != 0x280 || r30 != 0x1e0) goto L_801E6650;
...
L_801EBA74:
    ...
    r29 = *(u8*)(r7 + r31);
    r31 = r6 + r29;
    if ((s32)r30 == 0xff || (s32)r31 > 0x21) goto L_801EBB80;
...
void fn_801ED3B8(void) {
    ...
    L_801ED3E4:
        ...
        fn_80123FBC();
        tmp = r3 & 0xFF;
        if ((s32)tmp == 0 || r28 == 0) goto L_801ED494;
