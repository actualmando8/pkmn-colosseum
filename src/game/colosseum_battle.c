                        ...
                        if ((u32)r0 != (u32)0x9) {
                            ...
                            if ((u32)r0 == (u32)0x41) {
                                ...
                                while (1) {
                                    ...
                                    if ((u32)r0 != (u32)0x1 || (u32)r0 != (u32)0x2 && (u32)r0 != (u32)0x3 || (u32)r0 != (u32)0x2 && (u32)r0 != (u32)0x3) {
...
while (1) {
    ...
    while (1) {
            ...
            *(u8*)(sp + 0x23) = r3;
            ...
            if ((u32)r0 == (u32)0x1 || (s32)r24 >= (s32)0x0) {
            ...
            if ((u32)r0 == (u32)0x1) {
                ...
                r0 = r25 & 0xFF;
                if ((u32)r0 != (u32)0x1 || (u32)r3 != (u32)0x0) continue;
...
void fn_80241DE8(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    while (1) {
        ...
        fn_802377E8();
        r0 = r3 & 0xFFFF;
        if ((u32)r0 != (u32)0x12e && (u32)r0 != (u32)0xd4) {
        ...
        if ((u32)r30 != (u32)r4) {
            ...
            if ((u32)r30 != (u32)r4) {
                ...
                while (1) {
                    ...
                    if ((u32)r3 == (u32)r19 || (u32)r3 == (u32)r20) {
...
void fn_80245578(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    if ((u32)r0 == (u32)0x3 || (u32)r0 == (u32)0x9) {
...
void fn_80245DFC(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    if ((u32)r0 == (u32)0x1 || (u32)r0 == (u32)0x2) {
...
void fn_802477B0(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    if ((s32)r0 == (s32)0) {
        r0 = r25 & 0xFFFF;
        if ((u32)r0 != (u32)0xaf && (u32)r0 != (u32)0x0) {
        ...
        if ((u32)r29 != (u32)r4) {
            ...
            if ((u32)r29 != (u32)r4) {
                ...
                while (1) {
                    ...
                    r0 = *(u16*)(r3 + r0);
                    if ((u32)r0 != (u32)0xb6 && (u32)r0 != (u32)0xc5) {
...
void fn_8024CED8(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    if ((u32)r0 == (u32)0x13 || (u32)r0 == (u32)0x154) {
            ...
            if ((u32)r23 != (u32)0x0) {
                ...
                if ((u32)r0 != (u32)0x7) {
                    ...
                    if ((u32)r0 != (u32)0x7) {
                        ...
                        if ((u32)r0 == (u32)0x2 || (u32)r0 == (u32)0x1) {
                        ...
                        if ((u32)r0 == (u32)0x3 || (u32)r0 == (u32)0x1) {
...
u32 fn_80250E84()
{
  ...
  fn_80211170(r3,r5,r4,r6,0,0,0x80250ec4,0);
  return 0;
}
...
u32 fn_80250F7C()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80250fbc,0);
  return 0;
}
...
u32 fn_80251CEC()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80251d2c,0);
  return 0;
}
...
u32 fn_80252038()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80252078,0);
  return 0;
}
...
u32 fn_80252148()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80252188,0);
  return 0;
}
...
u32 fn_80252208()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80252248,0);
  return 0;
}
...
u32 fn_8025228C()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x802522cc,0);
  return 0;
}
...
u32 fn_80252398()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x802523d8,0);
  return 0;
}
...
u32 fn_802527C4()
{
    ...
    u32 r6;
    extern u32 fn_80211170();
  fn_80211170(r3,r5,r4,r6,0,0,0x80252804,0);
  return 0;
}
...
void fn_80254268(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    fn_80237F74();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1) {
        r3 = r27;
        r4 = r31;
        r5 = 0x14;
        fn_80237F74();
...

{
  ...
  uVar1 = fn_80215008(r3,auStack_38,0x18,r4);
...

{
  ...
  sVar1 = (int)fn_8012640C(r4,0,0xed,0);
  return sVar1 != 0;
}
...

{
  ...
  uVar1 = fn_802373B0((double)*(float *)(lbl_8047E648),r3,r4,0);
  iVar2 = -(uVar1 & 0xff) + 1;
  return iVar2 - ((u32)(iVar2 == 0) + -(uVar1 & 0xff));
}
...
void fn_80257EE4(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    while (1) {
        ...
        if ((u32)r0 >= (u32)r31) break;
        r27 = *(u16*)(r30 + r0);
        if ((u32)r27 != (u32)0x165 && (u32)r27 != (u32)0x163) {

            r3 = r27;
            fn_80218FDC();
            r0 = r3 & 0xFF;
            if ((u32)r27 == (u32)0x163 && (u32)r27 != (u32)0x108 && (u32)r27 != (u32)0xfd) {
...
void fn_8025BFAC(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    fn_80237F74();
    r0 = r3 & 0xFF;
    if ((u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1 && (u32)r0 != (u32)0x1) {
        r3 = r28;
        r4 = r30;
        r5 = 0x14;
        fn_80237F74();
...
void fn_8025C264(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    if ((u32)r29 == (u32)0xffff || (u32)r29 == (u32)0xfffe) {
    ...
    if ((u32)r24 == (u32)0x1 && (u32)r0 == (u32)0x1 && (u32)r0 != (u32)0x39 && (u32)r0 != (u32)0xfa) {
        r3 = r25;
        r4 = r28;
        r5 = 0x1f;
        fn_80236BFC();
...
void fn_8025C5A4(void* ctx, u32 param1, u32 param2, u32 param3) {
    ...
    r0 = r30 & 0xFFFF;
    r3 = r3 & 0xFFFF;
    if ((u32)r0 == (u32)0x1f && (u32)r3 == (u32)0xcf) {
    ...
    r0 = r30 & 0xFFFF;
    if ((u32)r0 == (u32)0x21 && (u32)r0 == (u32)0xfa) {
        r0 = r31 & 0xFFFF;
...
void fn_8025DDAC(int *r3,u32 r4)

{
    extern int fn_800E4170();
    extern int fn_801DAC3C();
  int iVar1;
  
  if ((*r3 != 0) && (iVar1 = fn_801DAC3C(), iVar1 != 0)) {
...
void fn_8025DE0C(int *r3,u32 r4)

{
    extern int fn_800E43A4();
  int iVar1;
...

{
  ...
  if (r7 == 1) {
    fn_801C41C8((double)*(float *)(lbl_8047E670),2);
  }
  fn_801DA4E8(*r3,1);
  for (iVar2 = 0; iVar2 < r5; iVar2 = iVar2 + 1) {
    if (r6 == 0) {
      fn_801DA914(*r3,*r4,r4[1]);
    }
    fn_801DA9E8(*r3,*r4,r4[1]);
    while (1) {
    ...
    if (sVar4 == 0) {
      ...
      *r3 = iVar3;
      if (iVar3 == 0) {
        ...
        for (iVar3 = 0; iVar3 < r6; iVar3 = iVar3 + 1) {
          cVar5 = fn_801DDD28(*r3,*r5,r5[1],0);
          if (cVar5 == '\0') {
            return 0;
          }
          r5 = r5 + 2;
...
{
    extern u32 _DAT_8027a478;
    extern u32 _DAT_8027a47c;
    extern u32 _DAT_8027a480;
  ...
  local_18 = _DAT_8027a478;
  local_14 = _DAT_8027a47c;
  local_10 = _DAT_8027a480;
  if (*(int *)(lbl_8047B664) == 1) {
    fn_80118A68(*(u32 *)(lbl_8047B660),1);
    *(u32 *)(lbl_8047B660) = 0;
    *(u32 *)(lbl_8047B664) = 0;
  }
  uVar2 = fn_80113F48();
  ...
  *(u32 *)(lbl_8047B660) = uVar2;
  fn_80118F04(uVar2,&local_18);
  fVar1 = *(float *)(lbl_8047E684);
  *(u32 *)(lbl_8047B664) = 1;
...

{
  ...
  if (sVar2 != 0) {
    uVar1 = fn_800FF560();
    fn_800F07A8(1,uVar1,0x4000,1,1,0x8025e534);
  }
  return;
}
...

{
  ...
  if (*(int *)(lbl_8047B668) != -1) {
    ...
    else if (*(int *)(lbl_8047B668) == 1) {
      iVar1 = 2;
    }
    if (iVar1 == 2) {
      fn_8025DD14((int*)auStack_28);
      fn_80165668(0x3c8,0,0xff);
      uVar2 = fn_8012A5B0(0,3,*(u32 *)(lbl_8047B66C) & 0xffff);
      _DAT_804782c0 = (int)fn_8012640C(uVar2,0,0x6e,0);
      _DAT_804782bc = 1;
      _DAT_804782c4 = *(u32 *)(lbl_8047B66C);
      fn_801C41C8((double)*(float *)(lbl_8047E680),3);
      fn_801C40F0(1);
      fn_800FF730(0x385);
      fn_8011288C(0,0);
      fn_800F0308();
      fn_801C41C8((double)*(float *)(lbl_8047E68C),2);
      fn_801C40F0(1);
      ...
      sVar6 = fn_801CAF0C();
      if (sVar6 == 0) {
        *(u32 *)(lbl_8047B668) = 0xffffffff;
        *(u32 *)(lbl_8047B66C) = 0xffffffff;
      }
      else {
...

{
  ...
  uVar1 = *(u32 *)(lbl_8047E690);
  if (r3 == 0x92) {
    uVar1 = *(u32 *)(lbl_8047E6A4);
  }
  else if (r3 < 0x92) {
    if (r3 == 0x4a) {
      uVar1 = *(u32 *)(lbl_8047E698);
    }
    else if (r3 < 0x4a) {
      if (r3 == 0x26) {
        uVar1 = *(u32 *)(lbl_8047E694);
      }
      else if (r3 < 0x26) {
        if (r3 == 0x1a) {
          uVar1 = *(u32 *)(lbl_8047E6A0);
        }
        ...
        uVar1 = *(u32 *)(lbl_8047E6A8);
      }
    }
    else if (r3 == 0x8e) {
      uVar1 = *(u32 *)(lbl_8047E69C);
    }
    else if (r3 < 0x8e) {
      if (r3 == 0x85) {
        uVar1 = *(u32 *)(lbl_8047E698);
...

{
  ...
  for (uVar4 = 1; uVar4 < 0xfc; uVar4 = uVar4 + 1) {
    ...
    for (uVar3 = 0; (uVar3 & 0xffff) < (u32)*puVar1; uVar3 = uVar3 + 1) {
      if ((puVar1[(uVar3 & 0xffff) * 6 + 2] & 0x3fff) == uVar4) goto LAB_0025cc78;
    }
...
LAB_0025cc78: (void)0;
  ...
  do {
    ...
    puVar1 = (u16 *)fn_80129280(0,0xc);
    for (uVar3 = 0; (uVar3 & 0xffff) < (u32)*puVar1; uVar3 = uVar3 + 1) {
      if ((puVar1[(uVar3 & 0xffff) * 6 + 2] & 0x3fff) == uVar4) goto LAB_0025cd10;
    }
    puVar1[(u32)*puVar1 * 6 + 2] = uVar4 | 0x8000;
    uVar2 = fn_800E0C04(0xffffffff);
    *(u32 *)(puVar1 + (u32)*puVar1 * 6 + 6) = uVar2;
...

{
  ...
  fn_801C41C8((double)*(float *)(lbl_8047E6C0),3);
  fn_801C40F0(1);
  ...
  fn_801C41C8((double)*(float *)(lbl_8047E6C0),2);
  fn_801C40F0(1);
  ...
  if ((r4 < 0) || (4 < r4)) {
    ...
    while (!bVar2) {
      ...
      if ((r6 & 10) != 0) {
        ...
        fn_801C41C8((double)*(float *)(lbl_8047E6C0),uVar6);
        r6 = r6 & 0xfffffff5;
      }
  ...
  if (iVar1 == 0) {
    ...
    if (sVar5 == 0) {
      ...
      if ((int)uVar3 < 0) {
        ...
        uVar2 = fn_801F76B8(0,uVar4,2,uVar3 & 0xffff);
      }
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (sVar4 == 0) {
      ...
      if ((int)uVar2 < 0) {
        ...
        uVar6 = fn_801F76B8(0,uVar3,2,uVar2 & 0xffff);
      }
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (sVar4 == 0) {
      ...
      if ((int)uVar2 < 0) {
        ...
        uVar5 = fn_801F76B8(0,uVar3,2,uVar2 & 0xffff);
      }
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (sVar5 == 0) {
      ...
      if ((int)uVar3 < 0) {
        ...
        uVar2 = fn_801F76B8(0,uVar4,3,uVar3 & 0xffff);
      }
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (sVar4 == 0) {
      ...
      if ((int)uVar2 < 0) {
        ...
        uVar6 = fn_801F76B8(0,uVar3,3,uVar2 & 0xffff);
      }
    }
  }
  cVar5 = fn_80102620(uVar6);
    ...
    if (iVar3 == 0) {
      ...
      if (sVar6 == 0) {
        ...
        if ((int)uVar4 < 0) {
          ...
          uVar11 = fn_801F76B8(0,uVar5,3,uVar4 & 0xffff);
        }
      }
    }
    ...
    if (iVar2 == 0) {
      ...
      if (sVar5 == 0) {
        ...
        if ((int)uVar3 < 0) {
          ...
          local_34 = fn_801F76B8(0,uVar4,3,uVar3 & 0xffff);
        }
      }
    }
  }
    ...
    if (iVar2 == 0) {
      ...
      if (sVar5 == 0) {
        ...
        if ((int)uVar3 < 0) {
          ...
          local_2c = fn_801F76B8(0,uVar4,3,uVar3 & 0xffff);
        }
      }
    }
  }
      ...
      if (iVar2 == 0) {
        ...
        if (sVar5 == 0) {
          ...
          if ((int)uVar3 < 0) {
            ...
            local_24 = fn_801F76B8(0,uVar4,3,uVar3 & 0xffff);
          }
        }
      }
    }
...

{
  ...
  if (DAT_80478801 == '\x01') {
    return (double)*(float *)(lbl_8047E6E8);
  }
  if (_DAT_8047880c == 0) {
    return (double)*(float *)(lbl_8047E6D8);
  }
  return (double)(_DAT_80478808 - _DAT_80478804 / *(float *)(lbl_8047E6DC));
}
...

{
  ...
  return (double)(_DAT_80478818 - _DAT_80478814 / *(float *)(lbl_8047E6DC));
}
...

{
  ...
  fn_801DDD28(uVar3,*(u16 *)(lbl_8047E6F8),4,0);
  fn_801DA4E8(uVar3,1);
  uVar1 = *(u16 *)(lbl_8047E6F8);
  fn_801DA9E8(uVar3,uVar1,4);
  fn_801C41C8((double)*(float *)(lbl_8047E6FC),2);
  ...
  fn_801065B8(1);
  fn_801C41C8((double)*(float *)(lbl_8047E6FC),3);
  while (cVar9 = fn_801C40F0(0), cVar9 != '\0') {
    fn_801DB088();
    cVar9 = fn_801DA94C(uVar3,uVar1,4);
    if (cVar9 == '\0') {
...

{
  ...
  if (iVar3 == 1) {
    fn_801C41C8((double)*(float *)(lbl_8047E680),2);
...

{
    ...
    extern short fn_8011EDF8();
    extern u32 fn_8011EE10();
    extern short fn_8011EE58();
    extern short fn_8011F228();
  ...
  if (cVar7 == '\x01') {
    ...
    fn_801EECD8(uVar2,1);
    cVar7 = fn_80121ADC(uVar1,0x3e);
    if (cVar7 != '\0') {
      fn_80121B4C(uVar1,0x3e);
    }
    fn_8011FBCC((double)*(float *)(lbl_8047E688),uVar1);
    ...
    fn_801065B8(1);
    sVar5 = fn_8011EE58(uVar1);
    sVar6 = fn_8011EDF8(uVar1);
    fn_8011D904(uVar1,sVar5 + sVar6 + 0x46);
    fn_8011DE68(uVar1,0);
...

{
  ...
  do {
    do {
      ...
      uVar4 = uVar4 & 0xffff;
    } while (((uVar4 == 0) || (**(u32 **)(lbl_80478DF8) <= uVar4)) || (uVar4 == 0x165));
    *(u8 *)(lbl_8047B678) = 0;
    iVar5 = fn_8022B2CC(r4,uVar4,r5,0x8026503c,1,0,0xffffffff);
    cVar9 = fn_801F18DC(0);
  } while ((((cVar9 == '\x01') && (*(char *)(lbl_8047B678) == '\0')) &&
...

{
  ...
  dVar4 = (double)(float)((double)*(float *)(lbl_8047E664) * r3);
  dVar5 = *(double *)(lbl_8047E668);
  fVar1 = *(float *)(lbl_8047E660);
...

{
  ...
  do {
    if (0x239 < uVar12) {
LAB_0025db60:
      fn_801C41C8((double)*(float *)(lbl_8047E6C0),5);
      ...
      dVar15 = *(double *)(lbl_8047E6B8);
      dVar14 = (double)*(float *)(lbl_8047E6B4);
      fVar1 = *(float *)(lbl_8047E6B0);
      ...
      if (bVar4) {
        ...
        fn_801065B8(1);
        dVar14 = *(double *)(lbl_8047E6B8);
        dVar15 = (double)*(float *)(lbl_8047E6C4);
        fVar1 = *(float *)(lbl_8047E6B0);
...

{
  ...
  if (iVar1 != 0) {
    ...
    dVar11 = *(double *)(lbl_8047E6D0);
    dVar12 = (double)*(float *)(lbl_8047E6CC);
LAB_0026160c:
      ...
      if (iVar1 == 0) {
        ...
        if (sVar4 == 0) {
          ...
          if ((int)uVar10 < 0) {
            ...
            uVar2 = fn_801F76B8(0,uVar5,3,uVar10 & 0xffff);
          }
        }
      }
      fn_80011D9C(uVar2,1);
...

{
  ...
  dVar2 = *(double *)(lbl_8047E6E0);
  *(u32 *)(r3 + 4) = *(u32 *)(lbl_8047E6D8);
  dVar3 = (double)*(float *)(lbl_8047E6DC);
